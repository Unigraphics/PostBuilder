...
#=======================================================================
proc PB_fmt_CreateZeroFormat { FMT_OBJ_LIST ZERO_FORMAT } {
  upvar $FMT_OBJ_LIST fmt_obj_list
  upvar $ZERO_FORMAT zero_format
  set zero_fmt_name "Zero"
  PB_com_RetObjFrmName zero_fmt_name fmt_obj_list ret_code
  if { $ret_code == 0 } \
  {
   set obj_attr(0) $zero_fmt_name
   ...
   set no_fmts [llength $fmt_obj_list]
   set zero_format [lindex $fmt_obj_list [expr $no_fmts - 1]]
  } else \
  {
