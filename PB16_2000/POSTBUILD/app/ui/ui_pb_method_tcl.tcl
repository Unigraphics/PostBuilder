...
proc UI_PB_mthd_CreateFloatControl {val1 val2 inp_frm ext label} {
  ...
  pack $inp_frm.4_$ext -side left
  pack $inp_frm.3_$ext $inp_frm.2_$ext $inp_frm.1_$ext -side right
 }
...
proc UI_PB_mthd_CreateLblEntry { data_type var inp_frm ext label args } {
  ...
  pack $inp_frm.$ext -side left -padx 3 -pady 7
  pack $inp_frm.1_$ext -side right -padx 3 -pady 7
  if { $data_type == "a" } \
  {
...
proc UI_PB_mthd_CreateButton { inp_frm ext label} {
  set text [format "%-20s" $label]
  button $inp_frm.$ext -text "$label"
  grid $inp_frm.$ext -padx 40 -pady 3
 }
...
proc UI_PB_mthd_CreateEntry { var inp_frm ext } {
  ...
  pack $inp_frm.1_$ext -side left -padx 3 -pady 3 -fill x
 }
...
proc UI_PB_mthd_CreateOptionalMenu { var inp_frm ext option_list \
  ...
  pack $inp_frm.$ext -padx 3 -pady 3 -fill x
 }
...
proc UI_PB_mthd_CreateFmtCombBox { var fmt_frm ext } {
  ...
  pack $fmt_frm.but_$ext -side left -padx 10 -pady 5
  ...
  pack $fmt_frm.cb_$ext -side right -padx 10 -pady 5
  [$fmt_sel subwidget entry] config -bg lightBlue -cursor ""
  set lbx [$fmt_sel subwidget listbox]
  $lbx delete 0 end
...
proc UI_PB_mthd_CreateScrollWindow { widget_id ext WINDOW } {
  ...
  -width $paOption(trough_wd)
  pack $src_win -side top -expand yes -fill both
...
proc UI_PB_mthd_CreateAddTrashinCanvas {this} {
  ...
  "_mthd_FocusTrashBin $this ENTER"
  $top_canvas bind evt_trash <Leave> \
  "_mthd_FocusTrashBin $this LEAVE"
...
#=======================================================================
proc _mthd_FocusTrashBin { page sw } {
  global paOption
  global gPB
