...
proc UI_PB_prv_CreateSecPaneElems { PAGE_OBJ } {
  ...
  set lla [label $p1_frame.la -text "$gPB(output,new_code,Label)" \
  -bg darkSeaGreen3 -fg lightYellow -bd 2 -relief raised -anchor c]
  ...
  set rla [label $p2_frame.la -text "$gPB(output,old_code,Label)" \
  -bg darkSeaGreen3 -fg lightYellow -bd 2 -relief raised -anchor c]
