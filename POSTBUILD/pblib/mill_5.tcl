     ...
     if {$mom_sys_rotary_error != 0 && $mom_motion_event == "linear_move"} { 
        ...
        #
            ...
            set mom_warning_info "Retraction geometry is defined inside of the current point. \
                                  \nNo retraction will be output.  Set the retraction distance\
                                  to a greater value."
            MOM_catch_warning
            set retract "no"
         }
...
#
           ...
           #
            if [info exists mom_kin_4th_axis_direction] {
               set mom_out_angle_pos(0) [ROTSET $mom_prev_pos(3) $mom_out_angle_pos(0) \
            ...
            if [info exists mom_kin_5th_axis_direction] {
               set mom_out_angle_pos(1) [ROTSET $mom_prev_pos(4) $mom_out_angle_pos(1) \
...
# 
            ...
            if {$res == 1} {
                set mom_out_angle_pos(0) [ROTSET $mom_prev_alt_pos(3) $mom_prev_rot_ang_4th \
                                                 $mom_kin_4th_axis_direction \
                                                 $mom_kin_4th_axis_leader \
                                                  mom_sys_leader(fourth_axis) \
                                                 $mom_kin_4th_axis_min_limit \
            ...
            if {$res == 1} {
                set mom_out_angle_pos(1) [ROTSET $mom_prev_alt_pos(4) $mom_prev_rot_ang_5th \
                                                 $mom_kin_5th_axis_direction \
                                                 $mom_kin_5th_axis_leader \
                                                  mom_sys_leader(fifth_axis) \
                                                 $mom_kin_5th_axis_min_limit \
	     ...
	     #        
            ...
            set mom_out_angle_pos(0) [ROTSET $mom_pos(3) $mom_out_angle_pos(0) \
                                             $mom_kin_4th_axis_direction \
                                             $mom_kin_4th_axis_leader \
                                              mom_sys_leader(fourth_axis) \
                                             $mom_kin_4th_axis_min_limit \
                                             $mom_kin_4th_axis_max_limit]
            set mom_out_angle_pos(1) [ROTSET $mom_pos(4) $mom_out_angle_pos(1) \
                                             $mom_kin_5th_axis_direction \
                                             $mom_kin_5th_axis_leader \
                                              mom_sys_leader(fifth_axis) \
                                             $mom_kin_5th_axis_min_limit \
...
#
  ...
  if {$mom_sys_lock_status == "ON"} {  
      ...
      if { $mom_kin_linearization_flag == "0" && $mom_motion_type != "RAPID" && $mom_motion_type != "RETRACT"} { 
         ...
         if {[info exists mom_kin_5th_axis_direction]} {
           set mom_out_angle_pos(1) \
           [ROTSET $mom_pos(4) $mom_prev_rot_ang_5th $mom_kin_5th_axis_direction \
               $mom_kin_5th_axis_leader mom_sys_leader(fifth_axis) $mom_kin_5th_axis_min_limit $mom_kin_5th_axis_max_limit]
         }
      }
  }
}
