...
#   ==> These commands only come into a post during creation.
#   ==> Only New commands will be populated during upgrade;
#       no override to existing commands regardless of types!
#
#   ==> Commands to be enforced or replaced during upgrade of posts
#       should be defined in pb_base.tcl.
#
##############################################################################
