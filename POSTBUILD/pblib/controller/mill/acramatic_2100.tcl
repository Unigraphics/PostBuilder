########################## TCL Event Handlers ##########################
#
#  acramatic_2100.tcl - 5_axis_dual_table
#
#    
#
#  Created by Postino @ Tuesday, January 31, 2017 12:34:27 PM Pacific Standard Time
...
#
  ...
  set mom_sys_alt_unit_post_name                "acramatic_2100__MM.pui"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_feed G_motion G_mode X Y Z M_coolant}
   set rapid_spindle_x_blk {G_feed G_motion G_mode X M_coolant}
   set rapid_spindle_y_blk {G_feed G_motion G_mode Y M_coolant}
   set rapid_spindle_z_blk {G_feed G_motion G_mode Z M_coolant}
...
#=============================================================
   ...
   PB_CMD_start_of_alignment_characte
...
#=============================================================
proc PB_CMD_cycle_drag_offset { } {
#=============================================================
global cycle_angle cycle_offset
set cycle_angle 90
set cycle_offset(1) 0.0
}


#=============================================================
proc PB_CMD_cycle_drill_brkchp { } {
#=============================================================
global cycle_deep_type
set cycle_deep_type 1
}


#=============================================================
proc PB_CMD_cycle_drill_deep { } {
#=============================================================
global cycle_deep_type
set cycle_deep_type 3
}


#=============================================================
proc PB_CMD_cycle_nodrag_offset { } {
#=============================================================
global cycle_angle cycle_offset
set cycle_angle 90
set cycle_offset(1) -.02
}
...
#=============================================================
  MOM_force once G_adjust H cycle_R cycle_V cycle_J cycle_W
}
