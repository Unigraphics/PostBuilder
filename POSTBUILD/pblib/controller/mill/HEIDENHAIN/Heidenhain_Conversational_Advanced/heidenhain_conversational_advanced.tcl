...
#
#  Created by Postino @ Fri Mar  9 12:21:15 2018 -0800
...
# 09-15-2015 shuai - PB_CMD_helix_move_xyz is added into helix move handler
...
# 26-Oct-2015 ljt - Get rid of M_spindle from linear_move and rapid_move block and add spindle_on block to Initial Move and First Move, remove PB_CMD_disable_spindle
# 12-22-2015 szl - Add PB_CMD_spindle_off and PB_CMD__check_block_spindle_on to enhance back counter sinking and deep hole drilling.
...
# 06-06-2016 szl - Get rid of spindle_rpm block in MOM_spindle_rpm.
# 04-Jul-2016 Shuai - Fix the blocks used in UDE "DWELL".
...
# 08-29-2016 szl - PR7740419 fix: check if 4th or 5th axis are unlimited in PB_CMD_before_motion, if yes, the value of rotary axes will be outputted in 360 range.
# 12-23-2016 szl - Update address dwell and fix the blocks for "Dwell" UDE.
# 02-14-2017 szl - 5-axis ncm for drilling operation.
#                  Add proc DPP_GE_GET_NCM_WORK_PLANE_CHANGE_MODE and PB_CMD_coord_rotation_in_operation, update PB_CMD_before_motion, PB_CMD_init_cycle,
#                  PB_CMD_customize_output_mode, PB_CMD_reset_output_mode, PB_CMD_cycle_coord_rotation and PB_CMD_check_plane_change_in_rapid_move.
...
# 21-Jan-2019 gsl - Call PB_CMD__convert_point in place of MOM_convert_point
#
}
...
#=============================================================
   ...
   MOM_do_template cycle_def_9_0

   MOM_do_template cycle_def_9_1
}
...
# 1. set spidle direction for Back Countersinking and Deep Hole Drilling
#
...
# 08-29-16 szl - Check if 4th axis or 5th axis are unlimited, if yes, output the value of rotary axes in 360 range.
   ...
   # 10-18-2013 Jason - Commented following code to avoid wrong mom_out_angle_pos
   # 08-29-2016 szl - Uncommented following code and refine it.
   if {[expr $mom_kin_4th_axis_max_limit - $mom_kin_4th_axis_min_limit] > 720.0} {
         set mom_out_angle_pos(0) [LIMIT_ANGLE $mom_out_angle_pos(0)]
   }

   if {[expr $mom_kin_5th_axis_max_limit - $mom_kin_5th_axis_min_limit] > 720.0} {
...
# 06-18-2013 Jason - Initial version
  ...
  global plane_positioning
  set plane_positioning "TURN FMAX"
...
#-----------
# 2015-04-09 Jintao - Initial implementation
# 2015-10-26 Jintao - remove disable M_spindle
