########################## TCL Event Handlers ##########################
#
#  heidenhain_conversational.tcl - 5_axis_head_table
#
#    This is a 5-Axis Milling Machine With
#     Rotary Head and Table.
#
#  Created by Postino @ Thursday, February 16, 2017 2:12:07 PM Pacific Standard Time
...
# 26-Oct-2015 ljt - Get rid of M_spindle from linear_move and rapid_move block and add spindle_on block to Initial Move and First Move
# 06-Jun-2016 szl - Get rid of spindle_rpm block in MOM_spindle_rpm.
# 04-Jul-2016 Shuai - Fix the blocks used in UDE "DWELL".
# 07-26-2016 szl - Updated PB_CMD_MOM_rotate: reset mom_prev_pos using the variable mom_out_angle_pos to fix PR7730336.
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   PB_CMD_before_rapid
   set rapid_spindle_blk {G_motion X Y Z FMAX G_cutcom}
   set rapid_spindle_x_blk {G_motion X FMAX G_cutcom}
   set rapid_spindle_y_blk {G_motion Y FMAX G_cutcom}
   set rapid_spindle_z_blk {G_motion Z FMAX G_cutcom}
   set rapid_traverse_blk {G_motion X Y Z FMAX G_cutcom}
   set rapid_traverse_xy_blk {G_motion X Y FMAX G_cutcom}
   set rapid_traverse_yz_blk {G_motion Y Z FMAX G_cutcom}
   set rapid_traverse_xz_blk {G_motion X Z FMAX G_cutcom}
...
#=============================================================
   ...
   set mom_pb_macro_arr(CYCL_209) \
       [list {{CYCL DEF 209} { } { } {} 1 =} \
        {{{$mom_cycle_rapid_to} 1 4 4 1 1 8 4 Q200} \
         {{$mom_cycle_feed_to} 1 4 4 1 1 8 4 Q201} \
         {{$dpp_TNC_cycle_thread_pitch} 1 4 4 1 1 8 4 Q239} \
         {{$mom_pos(2)} 1 4 4 1 1 8 4 Q203} \
         {{$js_return_pos} 1 4 4 1 1 8 4 Q204} \
