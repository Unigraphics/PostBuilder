...
#  haas_VF.tcl -
#
#  Created by ling  @  Wednesday, July 25, 2012 2:38:56 PM Pacific Daylight Time
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "haas_VF__MM.pui"
...
#=============================================================
  ...
  # Accumulated time should be in minutes.
   ...
   MOM_force Once G_adjust Z M_coolant
   MOM_do_template end_of_path_2
   MOM_force Once Z
   MOM_do_template return_motion_6
