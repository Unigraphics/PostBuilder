...
#
#  Created by ling  @  Fri Dec 08 18:48:49 2006 Pacific Daylight Time
...
# Debug mode enables ISV QC messages output.
set mom_sim_post_builder_debug  0
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_cycle_start_code                  "G79"
  set mom_sys_cycle_off                         "G80"
...
#***********
  ...
  if { [info exists mom_sim_output_extended_nc] && $mom_sim_output_extended_nc == 1 } {
   ...
   # Only do this in non-simulation mode
    if { $sim_mtd_initialized == 0 } {

      global mom_sim_vnc_msg_only
      set mom_sim_vnc_msg_only  1
...
# options for full path name, file name only , uppercase
  ...
  MOM_output_literal ";  (A single ; will cause problem in ISV.)"
}
