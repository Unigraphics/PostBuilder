########################## TCL Event Handlers ##########################
#
#  fanuc_30i.tcl - 5_axis_head_table
#
...
# 12-Dec-2018 gsl - Brought PB_CMD__choose_preferred_solution, LINEARIZE_LOCK_OUTPUT & ROTSET up-to-date.
#                 - Added PB_CMD__convert_point
# 11-Sep-2019 zhx - Add PB_CMD__check_block_check_retract_setting in MOM_drill and MOM_bore
#
}
  ...
  set mom_sys_alt_unit_post_name                "fanuc_30i__MM.pui"
...
#=============================================================
  ...
  # Pass tool name to VNC for simulation.
   ...
   PB_CMD_init_before_first_tool

   MOM_do_template tool_select
   PB_CMD_init_after_first_tool
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_spindle_blk {G_plane G_mode G_motion G_adjust X Y Z H S M_spindle}
   set rapid_spindle_x_blk {G_plane G_mode G_motion G_adjust X H S M_spindle}
   set rapid_spindle_y_blk {G_plane G_mode G_motion G_adjust Y H S M_spindle}
   set rapid_spindle_z_blk {G_plane G_mode G_motion G_adjust Z H S M_spindle}
   set rapid_traverse_blk {G_mode G_motion X Y Z fourth_axis fifth_axis}
   set rapid_traverse_xy_blk {G_mode G_motion X Y fourth_axis fifth_axis}
   set rapid_traverse_yz_blk {G_mode G_motion Y Z fourth_axis fifth_axis}
   set rapid_traverse_xz_blk {G_mode G_motion X Z fourth_axis fifth_axis}
