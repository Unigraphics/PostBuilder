...
#=============================================================
# This proc is used to detect if operation is 3+2 operation without Local CSYS rotation coordinate system. And calculate the
# parameters for G68.
#
# Output:
...
#=============================================================
# This proc is used to calculate the parameters for G68 under local csys condition.
#
# Output:
#   first_vec - first vector for G68.
#   second_vec - second vector for G68.
...
#=============================================================
# This proc is used to detect if operation has coordinate rotation, and calculate the parameters for G68.
