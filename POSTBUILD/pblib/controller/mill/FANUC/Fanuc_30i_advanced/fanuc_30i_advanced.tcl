...
#
#  Created by Siemens/PLM @ Friday, August 02 2019, 16:28:06 -0700
...
#=============================================================
   PB_CMD__interop_end_subop_path
}
...
#=============================================================
   PB_CMD__interop_end_transition_path

  # Issue G69 to cancel G68.x instruction, when needed.
   MOM_do_template end_of_transition_path
}
...
#=============================================================
   PB_CMD__interop_machine_axis_move
...
#=============================================================
   PB_CMD__interop_start_subop_path
}
...
#=============================================================
   PB_CMD__interop_start_transition_path
}
...
#=============================================================
   PB_CMD__interop_transition_rapid_move

   MOM_do_template transition_rapid_move
}
