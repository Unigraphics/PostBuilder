########################## TCL Event Handlers ##########################
#
#  fadal.tcl - 5_axis_dual_table
#
#    
#
#  Created by Postino @ Tuesday, January 31, 2017 12:34:36 PM Pacific Standard Time
...
#
  ...
  set mom_sys_alt_unit_post_name                "fadal__MM.pui"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_cycle_bore_dwell_code             "88"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_mode G_motion G_feed H X Y Z M_coolant}
   set rapid_spindle_x_blk {G_mode G_motion G_feed H X M_coolant}
   set rapid_spindle_y_blk {G_mode G_motion G_feed H Y M_coolant}
   set rapid_spindle_z_blk {G_mode G_motion G_feed H Z M_coolant}
   set rapid_traverse_blk {G_mode G_motion G_feed X Y Z fourth_axis fifth_axis S M_spindle}
   set rapid_traverse_xy_blk {G_mode G_motion G_feed X Y fourth_axis fifth_axis S M_spindle}
   set rapid_traverse_yz_blk {G_mode G_motion G_feed Y Z fourth_axis fifth_axis S M_spindle}
   set rapid_traverse_xz_blk {G_mode G_motion G_feed X Z fourth_axis fifth_axis S M_spindle}
...
#=============================================================
   ...
   MOM_force Once G_mode G_cutcom G_plane
