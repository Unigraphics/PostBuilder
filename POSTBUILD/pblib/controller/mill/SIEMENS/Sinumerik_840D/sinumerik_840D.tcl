########################## TCL Event Handlers ##########################
#
#  sinumerik_840D.tcl - 5_axis_dual_head
#
#    This is a 5-Axis Milling Machine With
#     Dual Rotary Heads.
#
#  Created by Postino @ Fri Mar  9 12:21:40 2018 -0800
...
# 30-Apr-2015 ljt   - Add PB_CMD_spindle_orient and PB_CMD__check_block_cycle_retract. Fix PR7162261 and PR7281995.
...
#                     Enhance the warning message when users set wrong pitch and wrong spindle speed. Fix PR7463004.
...
#                     3. Add the new command PB_CMD_check_settings_for_cycle832, PB_CMD_detect_5axis_tool_path and PB_CMD_detect_hole_cutting_operation.
...
# 17-Jan-2017 shuai - Replace "MOM_abort" with "MOM_abort_program" to make the error message not display in NX.
# 31-Aug-2017 Toon VanderKooi PR8958320 add Generic Feature Operation (PB_CMD_detect_hole_cutting_operation)
# 30-Oct-2017 cj    - Fix PR9001883: Add tool tip in calculation of mom_pos in function PB_CMD_auto_3D_rotation.
# 03-Apr-2018 Jintao- PR9080157, take account of rotary axis direction in auto_3d
...
#
  ...
  set mom_sys_alt_unit_post_name                "sinumerik_840D__IN.pui"
...
return
   ...
   puts $tmp_file "      fifth_axis\[\$mom_out_angle_pos(1)\]"
   puts $tmp_file "      fourth_axis\[\$mom_out_angle_pos(0)\]"
   puts $tmp_file "      A5\[\$mom_contact_normal(0)\]\\opt"
   puts $tmp_file "      B5\[\$mom_contact_normal(1)\]\\opt"
   puts $tmp_file "      C5\[\$mom_contact_normal(2)\]\\opt"
...
# 03-Apr-2018 Jintao - Add rot_dir_5th and rot_dir_4th
...
return
 ...
 # Reolad kinematics to dual-table machine
  ...
  VECTOR_ROTATE mom_kin_4th_axis_vector [expr $rot_dir_4th*$rot0] v mom_pos
  ...
  if {[info exists mom_tool_z_offset] && [info exists mom_spindle_axis]} {
     ...
     VEC3_sub mom_pos tool_tip mom_pos
  }
...
#                     mom_cycle_tool_axis_change = 1 means tool axis is changed, mom_cycle_tool_axis_change = 0 menas no tool axis change.
...
# always redefine drill cycle when clearance plane change
  set cycle_init_flag TRUE
