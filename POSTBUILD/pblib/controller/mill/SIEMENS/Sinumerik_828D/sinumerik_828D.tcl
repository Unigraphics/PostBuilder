...
#  sinumerik_828D.tcl -
#
#  Created by ling  @  Wednesday, March 02, 2011 6:21:34 PM Pacific Standard Time
...
return
  ...
  if {[info exists mom_siemens_coord_rotation] && $mom_siemens_coord_rotation != 0 && [string compare "SWIVELING" $mom_siemens_5axis_mode]} {
