...
#
#  Created by Postino @ Friday, March 09 2018, 19:17:10 -0800
...
# Aug-01-2017 gsl - Apply new version of CONVERT_BACK from v12.0
# Oct-25-2018 gsl - Brought in latest LINEARIZE_MOTION
#
}
   ...
   while { $loop == 0 } {
     ...
     # Check deviation with tool path (in part space)
      ...
      if { $count > 20 } {
        ...
        #<10/25/2018 gsl> Check delta_angle against output resolution of rotary axis
