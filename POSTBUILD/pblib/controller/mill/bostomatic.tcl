...
#  bostomatic.tcl -
#
#  Created by ling  @  Wednesday, March 02, 2011 6:15:14 PM Pacific Standard Time
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "bostomatic__MM.pui"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_adjust_code_minus                 "48" 
  ...
  set mom_sys_feed_rate_mode_code(IPM)          "122"
  set mom_sys_feed_rate_mode_code(IPR)          "95" 
  set mom_sys_feed_rate_mode_code(FRN)          "123"
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  set mom_kin_4th_axis_ang_offset               "90.0"
  ...
  set mom_kin_5th_axis_max_limit                "3600"
  set mom_kin_5th_axis_min_incr                 "0.001"
  set mom_kin_5th_axis_min_limit                "-3600"
...
#=============================================================
   ...
   MOM_do_template cycle_fedto
   MOM_do_template cycle_rapto
...
#=============================================================
  ...
  # First tool only gets handled once
   ...
   PB_CMD_info_tool_name
   PB_CMD_info_tool_type
   MOM_force Once T M
   MOM_do_template tool_change
   MOM_do_template tool_length_adjust
   PB_CMD_info_spindle_rpm
   MOM_do_template auto_tool_change_spindle
   PB_CMD_bostomatic_opmsg_tool
}
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_adjust G_feed G_motion G_mode X Y Z M_coolant rapid_non_modal}
   set rapid_spindle_x_blk {G_adjust G_feed G_motion G_mode X M_coolant rapid_non_modal}
   set rapid_spindle_y_blk {G_adjust G_feed G_motion G_mode Y M_coolant rapid_non_modal}
   set rapid_spindle_z_blk {G_adjust G_feed G_motion G_mode Z M_coolant rapid_non_modal}
   set rapid_traverse_blk {G_feed G_motion G_mode X Y Z fourth_axis fifth_axis S M_spindle rapid_non_modal}
   set rapid_traverse_xy_blk {G_feed G_motion G_mode X Y fourth_axis fifth_axis S M_spindle rapid_non_modal}
   set rapid_traverse_yz_blk {G_feed G_motion G_mode Y Z fourth_axis fifth_axis S M_spindle rapid_non_modal}
   set rapid_traverse_xz_blk {G_feed G_motion G_mode X Z fourth_axis fifth_axis S M_spindle rapid_non_modal}
...
#=============================================================
   ...
   MOM_set_seq_off
   PB_CMD_machine_time_initialize
   MOM_do_template rewind_stop_code
   PB_CMD_info_header
   MOM_force Once G_plane G_feed G_mode
   MOM_do_template initial_block
   PB_CMD_set_maxrpm
...
#=============================================================
proc PB_CMD_bostomatic_opmsg_tool { } {
#=============================================================
# Bostomatic operator message
# W31 will display the text on the screen
# Tool name, Tool dia, Spindle RPM

  global mom_tool_name
  global mom_tool_type
  global mom_tool_subtype
  global mom_tool_diameter
  global mom_tool_corner1_radius
  global mom_spindle_rpm

  MOM_output_literal "W31 $mom_tool_name - [format \"%.4f\" $mom_tool_diameter] dia - [format \"%.0f\" $mom_spindle_rpm] RPM"
}
...
#=============================================================
proc PB_CMD_info_feed { } {
#=============================================================
# Information to be output
# Current cut feedrate
  ...
  MOM_output_literal "$co Feed : [format \"%5.3f\" $mom_feed_cut_value] $ci"
}


#=============================================================
proc PB_CMD_info_header { } {
#=============================================================
 # Information to be put in to the start of the program
  ...
  MOM_output_literal "$co $mom_part_name $ci"
  MOM_output_literal "$co ---------------------------------------------------------- $ci"
  MOM_output_literal "$co Part File           : $mom_part_name $ci"
  MOM_output_literal "$co Created By          : $mom_logname $ci"
  MOM_output_literal "$co Creation Date       : $mom_date $ci"
  MOM_output_literal "$co Post Processor      : $mom_machine_name $ci"
  MOM_output_literal "$co UGPost Tcl file     : $mom_event_handler_file_name $ci"
  if { [string compare "" $ptp_file_name] } {
    MOM_output_literal "$co Machine ptp file    : $ptp_file_name $ci"
  }
  MOM_output_literal "$co ---------------------------------------------------------- $ci"
}
...
#=============================================================
proc PB_CMD_info_machine_time { } {
#=============================================================
# Information to be output
# Current elapssed machine time in minutes
#
# Add PB_CMD_Machine_time_initialize to the start of the program
# to initialize the variables.
  ...
  #set time_delta $mom_machine_time-$time_so_far

  #MOM_output_literal "$co Time for this path : [format \"%.2f\" $time_delta] min $ci"

  MOM_output_literal "$co Total time so far : [format \"%.2f\" $mom_machine_time] min $ci"

  #set time_so_far $mom_machine_time
}


#=============================================================
proc PB_CMD_info_oper_name { } {
#=============================================================
# Information to be output
# Operation Name
  ...
  MOM_output_literal "$co Operation : $mom_path_name $ci"
}


#=============================================================
proc PB_CMD_info_spindle_rpm { } {
#=============================================================
# Information to be output
# Spindle RPM
  ...
  MOM_output_literal "$co Spindle RPM : [format \"%5.0f\" $mom_spindle_rpm] $ci"
}


#=============================================================
proc PB_CMD_info_tool_dia { } {
#=============================================================
# Information to be output
# Milling tool diameter and corner radius
  ...
  MOM_output_literal "$co Tool Dia : [format \"%.4f\" $mom_tool_diameter] $ci"
  #MOM_output_literal "$co Corner Rad: [format \"%.4f\" $mom_tool_corner1_radius] $ci"
}


#=============================================================
proc PB_CMD_info_tool_name { } {
#=============================================================
# Information to be output
# Tool name
  ...
  MOM_output_literal "$co ----- TOOL CHANGE ----- $ci"
  MOM_output_literal "$co Tool Name: $mom_tool_name $ci"
  MOM_output_literal "$co ---------------------- $ci"
}


#=============================================================
proc PB_CMD_info_tool_type { } {
#=============================================================
# Information to be output
# Tool type
  ...
  MOM_output_literal "$co Tool Type : $mom_tool_type $ci"
}
...
#=============================================================
proc PB_CMD_machine_time_initialize { } {
#=============================================================
# Initialize the machine time for delta output
# Current elapssed machine time in minutes
...
#=============================================================
proc PB_CMD_set_maxrpm { } {
#=============================================================
# The S code that is output is a percentage of the maximum RPM.
# This will set the max value.
#
# MOM_output_literal "in PB_CM_Set_max_RPM"

  global mom_spindle_maximum_rpm

  set mom_spindle_maximum_rpm 7000
}
...
#=============================================================
  MOM_force once M_spindle S X Y Z F R fourth_axis fifth_axis cycle_rapid_to cycle_feed_to cycle_feedrate
}
...
set ugii_version [string trimleft [MOM_ask_env_var UGII_VERSION] v]
   ...
   if { $ugii_version >= 5 } {
      if { [file exists "[file dirname [info script]]/bosto_5axis_in_user.tcl"] } {
        # From directory relative to that of current post
         source "[file dirname [info script]]/bosto_5axis_in_user.tcl"
      } elseif { [file exists "${cam_post_dir}bosto_5axis_in_user.tcl"] } {
        # From directory relative to UGII_CAM_POST_DIR
         source "${cam_post_dir}bosto_5axis_in_user.tcl"
      } elseif { [file exists "bosto_5axis_in_user.tcl"] } {
        # From the specified directory
         source "bosto_5axis_in_user.tcl"
      } else {
         CATCH_WARNING "User's Tcl: bosto_5axis_in_user.tcl not found!"
      }
   } else {
      if { [file exists "${cam_post_dir}bosto_5axis_in_user.tcl"] } {
         source "${cam_post_dir}bosto_5axis_in_user.tcl"
      } else {
         CATCH_WARNING "User's Tcl: ${cam_post_dir}bosto_5axis_in_user.tcl not found!"
      }
   }
}
