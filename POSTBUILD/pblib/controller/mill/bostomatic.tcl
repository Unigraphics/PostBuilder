...
#=============================================================
  global cycle_init_flag
   ...
   MOM_force Once cycle_feed_to
   MOM_do_template cycle_fedto
   MOM_force Once cycle_rapid_to
   MOM_do_template cycle_rapto
   MOM_force Once cycle_feedrate
...
set co $mom_sys_control_out
         ...
         if {$ptp_file_name != "" } {MOM_output_literal "$co Machine ptp file    : $ptp_file_name $ci"}
         MOM_output_literal "$co ---------------------------------------------------------- $ci"
}
