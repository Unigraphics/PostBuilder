...
#
##############################################################################
#         P B _ C M D _ F E E D S _ S P E E D S _ U T I L S . T C L
##############################################################################
#
# DESCRIPTION
#
#   This file contains utility functions for handling feeds & speeds.
#
##############################################################################

#=============================================================
proc PB_CMD_overload_kin_feedrate_set { } {
#=============================================================
# This command can be called @ Start-of-Program event marker
# to overload the default PB_CMD_kin_feedrate_set command.
#
# 12-17-2014 gsl - 6919619 FRN not output for non-rapid RETRACT moves
#
...
#
  ...
  #<12-16-2014 gsl> This is the problem, since feed type is b/o mom_motion_type of which RETRACT will get RAPID.
...
#MOM_output_literal "feed_mode: $feed_mode"
