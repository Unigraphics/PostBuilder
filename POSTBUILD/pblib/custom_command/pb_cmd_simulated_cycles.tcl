...
#=============================================================
# - Imported from pb_cmd_simulated_cycles.tcl
#
...
#=============================================================
proc SIM_CYCLE_TOOL_AXIS { } {
#=============================================================
# - Imported from pb_cmd_simulated_cycles.tcl
#
#<04-23-2014 gsl> Renamed from CYCLE_TOOL_AXIS
...
#
  ...
  #<07-16-2014 gsl> (pb903) Under lock-axis situation, the duplicate position still needs to be output,
  #                 since table may be rotating to the next position. ==> Comapre all 5 dof?
  global mom_out_angle_pos
  if { [VEC3_is_zero v1] } {
     if { ![EQ_is_zero $mom_out_angle_pos(0)] || ![EQ_is_zero $mom_out_angle_pos(1)] } {
        SIM_RAPID p
     }
     return
  }
...
#
  ...
  if { [EQ_is_gt [VEC3_dot v1 mom_sys_spindle_axis] 0.0] } {
...
# - Imported from pb_cmd_simulated_cycles.tcl
#
# Dummy out command of ugpost_base
}
