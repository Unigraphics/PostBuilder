...
#=============================================================
  ...
  global mom_cycle_rapid_to mom_cycle_feed_tos mom_cycle_rapid_to mom_cycle_feed_to mom_cycle_retract_to
  global mom_kin_4th_axis_type mom_kin_5th_axis_type mom_kin_4th_axis_plane
  global top_of_hole mom_tool_axis mom_sys_spindle_axis mom_motion_type mom_kin_spindle_axis

  PB_CMD_initialize_spindle_axis

  set mom_motion_type "SIMULATED_CYCLES"

  for {set i 0} {$i < 3} {incr i} {
    set top_of_hole($i) [expr $mom_cycle_rapid_to_pos($i) - $mom_cycle_rapid_to*$mom_tool_axis($i)] 
  }
...
#=============================================================
proc PB_CMD_initialize_spindle_axis {} {
#=============================================================
