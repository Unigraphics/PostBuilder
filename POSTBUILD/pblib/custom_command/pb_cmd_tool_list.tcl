...
#     - This command wil be executed automatically, when present in the post,
#       in PB_CMD_create_tool_list command.
#
...
# v900
#======
# 01-11-13 gsl - ir2209290 Add Tap case in MAP_TOOL_TYPE proc (PB_CMD_init_tool_list)
#                to list tapping tool of hole-making operation
# 04-30-13 gsl - Added HEADER BLOCK
##############################################################################
