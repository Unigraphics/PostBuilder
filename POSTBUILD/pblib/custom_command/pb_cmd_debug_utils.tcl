...
# - Comment out next variable to disable the runtime debug service -
#  |||||||||||||||||||||
#  VVVVVVVVVVVVVVVVVVVVV
   set PB_POST__DEBUG  1

   if { [info exists PB_POST__DEBUG] && $PB_POST__DEBUG } {
...
# to list the result of debug messages to the posted output.
  ...
  # Grab final clock
   ...
   OPERATOR_MSG "+++++++++++++++++++++++++++++++++++++++++++++++++++"
   OPERATOR_MSG "Program end clock: $time_string"
   OPERATOR_MSG "+++++++++++++++++++++++++++++++++++++++++++++++++++"
  ...
  # Start clock will be set @ Start of Program when debug mode is on.
   if { [info exists ::PB_POST_program_start_clock] && [info exists ::PB_POST_program_end_clock] } {
      OPERATOR_MSG "Total program time (clicks):   [expr $::PB_POST_program_end_clock - $::PB_POST_program_start_clock]"
      OPERATOR_MSG "++++++++++++++++++++++++++++++"
   }
...
if { [llength [info commands OPERATOR_MSG]] == 0 } {
#=============================================================
