...
return
   ...
   if { [info exists ::mom_kin_is_turbo_output] && $::mom_kin_is_turbo_output } {
      set msg "Turbo mode  : $program_elapsed_seconds (seconds)\n"
   } elseif { [info exists ::mom_sys_advanced_turbo_output] && $::mom_sys_advanced_turbo_output } {
      set msg "Advanced Turbo mode  : $program_elapsed_seconds (seconds)\n"
   } else {
      set msg "Standard mode : $program_elapsed_seconds (seconds)\n"
   }
