...
#
  ...
  if { [string compare "LOCAL" $mom_kin_coordinate_system_type] } {
return
  }
...
return
  ...
  } elseif {[EQ_is_equal $m0 1.0] && ![string compare "YZ" $mom_kin_4th_axis_plane] } {
  ...
  } elseif {[EQ_is_equal $m4 1.0] && ![string compare "ZX" $mom_kin_4th_axis_plane] } {
  ...
  } elseif {[EQ_is_equal $m8 1.0] && ![string compare "XY" $mom_kin_4th_axis_plane] } {
