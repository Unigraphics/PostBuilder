...
# DESCRIPTION
#
#   This file contains common utilities for all posts.
#
#   - Any commands that need to be forced into every post for upgrade
#     can be defined here.
#
##############################################################################
...
if 0 {
#=============================================================
proc DEBUG_info { args } {
#=============================================================
# This command will output the command name with the NC codes for debug purpose.
# Optional string can also be supplied with the call to be output.
#
   global mom_sys_debug_mode mom_debug_file_all

   if { [string match "ON" $mom_sys_debug_mode] } {
      puts $mom_debug_file_all "DEBUG - \"[info level -1]\" [join $args]"
   }
}
}
...
if 0 {
#=============================================================
proc CALL_CMD { cmd_string {out_warn 0} args } {
#=============================================================
# This command first detects the existence of a command then
# executes it.
#
# - cmd_string may contain the command and its arguments
...
#
#  Syntax:
#    set result [CALL_CMD "cmd_string"]
#  or
#    set result [CALL_CMD "cmd_string" 1]  ;# To output warning
#
#
# Revisions:
#-----------
# 04-15-11 gsl - Initial implementation
#
