...
# pb10.03
#=============================================================================
set gPB(msg,filename_with_spec_char)              "File name containing special characters not supported!"
set gPB(msg,not_post_comp_file)                   "Post's own component may not be selected for this inclusion!"
set gPB(listing,output,warning,warn_file)         "Warning File"
set gPB(listing,output,warning,nc_output)         "NC Output"

#=============================================================================
# pb10.02
#=============================================================================
set gPB(machine,resolution,check,Label)           "Suppress Checking for Current Post"
set gPB(main,options,debug,Label)                 "Embed Post Debug Messages"
set gPB(encrypt,suppress,Label)                   "Disable License Change for Current Post"
set gPB(main,title,license_control)               "License Control"


#=============================================================================
# pb902
#=============================================================================
set gPB(other,ude_include_def,Label)              "Include Other CDL or DEF File"
#-----------------------------------------------------------------------------
# Labels for new tapping cycles
#-----------------------------------------------------------------------------
set gPB(event,cycle,tap_deep,name)                "Tap Deep"
set gPB(event,cycle,tap_break_chip,name)          "Tap Break Chip"
set gPB(g_code,tap_float,name)                    "Tap Float"
set gPB(g_code,tap_deep,name)                     "Tap Deep"
set gPB(g_code,tap_break_chip,name)               "Tap Break Chip"
#-----------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------
set gPB(event,cycle,plane_change,axis,label)      "Detect Tool Axis Change Between Holes"
set gPB(event,feedrates,mode,rapid)               "Rapid"
set gPB(event,feedrates,mode,cutting)             "Cutting"
