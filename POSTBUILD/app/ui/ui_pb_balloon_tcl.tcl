...
#=======================================================================
proc PB_create_balloon { text x y } {
  if [catch { create_balloon $text $x $y }] {
   set text [PB_output_EscapeSpecialControlChar $text]
   create_balloon $text $x $y
  }
 }
