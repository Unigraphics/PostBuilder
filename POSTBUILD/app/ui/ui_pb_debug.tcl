...
#<02-25-05 gsl> Register this var in memory
...
update
  ...
  global tixOption paOption
   ...
   UI_PB_com_CreateTransientWindow $win "Post Builder Pause" "+$xc+$yc" "" "" \
   ...
   $ltext config  -bg skyBlue -fg black -font $tixOption(fixed_font) -wrap word -bd 0
