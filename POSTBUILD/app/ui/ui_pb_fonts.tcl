...
if { [string match "windows" $tcl_platform(platform)] } {
   ...
   if {$gPB(LANG) == "pb_msg_english"} {
   ...
   } elseif {$gPB(LANG) == "pb_msg_simple_chinese"} {
      ...
      set gPB(fixed_font)          {{courier new} 10}
      set gPB(fixed_font_sm)       {courier 7}
   } elseif {$gPB(LANG) == "pb_msg_italian"} {
      set gPB(font)                {ansi 9}
      set gPB(font_sm)             {ansi 8}
      set gPB(bold_font)           {ansi 9 bold}
      set gPB(bold_font_lg)        {ansi 11 bold}
      ...
      set gPB(fixed_font)          {{courier new} 10}
      set gPB(fixed_font_sm)       {courier 7}
   } elseif {$gPB(LANG) == "pb_msg_japanese"} {
      set gPB(font)                {ansi 9}
      set gPB(font_sm)             {ansi 8}
      set gPB(bold_font)           {ansi 9 bold}
      set gPB(bold_font_lg)        {ansi 11 bold}
      ...
      set gPB(fixed_font)          {{courier new} 10}
      set gPB(fixed_font_sm)       {courier 7}
   } elseif {$gPB(LANG) == "pb_msg_russian"} {
      set gPB(font)                {ansi 9}
      set gPB(font_sm)             {ansi 8}
      set gPB(bold_font)           {ansi 9 bold}
      set gPB(bold_font_lg)        {ansi 11 bold}
      ...
      set gPB(fixed_font)          {{courier new} 10}
      set gPB(fixed_font_sm)       {courier 7}
   } elseif {$gPB(LANG) == "pb_msg_spanish"} {
      set gPB(font)                {ansi 9}
      set gPB(font_sm)             {ansi 8}
      set gPB(bold_font)           {ansi 9 bold}
      set gPB(bold_font_lg)        {ansi 11 bold}
      ...
      set gPB(fixed_font)          {{courier new} 10}
      set gPB(fixed_font_sm)       {courier 7}
   } elseif {$gPB(LANG) == "pb_msg_traditional_chinese"} {
      set gPB(font)                {simsun 10}
      set gPB(font_sm)             {ansi 8}
      set gPB(bold_font)           {simsun 10 bold}
      set gPB(bold_font_lg)        {simsun 10 bold}
