...
#=======================================================================
proc UI_PB_formatMcodeData { MCODE_DESC page_obj count ADD_NAME VAR args } {
...
#=======================================================================
proc UI_PB_mcd_RestoreMcodeData { page_obj args } {
  global mom_sys_arr
  ...
  for {set count 0} {$count < $no_mcodes} {incr count} \
  {
   ...
   array set mcode_desc $Post::($post_object,m_codes_desc)
   if { [info exists no_format] && $no_format } {
    UI_PB_formatMcodeData mcode_desc $page_obj $count add_name var $no_format
    } else {
    UI_PB_formatMcodeData mcode_desc $page_obj $count add_name var
   }
