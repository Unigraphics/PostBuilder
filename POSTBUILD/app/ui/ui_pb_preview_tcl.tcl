...
set event_name [__prv_TransEventName $event_name]
$h add 0.$t.$evt_indx -itemtype imagetext -text $event_name \
-style $style1
$tree setstatus 0.$t.$evt_indx $gPB(check_box_status)
incr evt_indx
...
proc __prv_TransEventName {event_name {type 0}} {
global gPB
if {$type == 0} {
...
PB_output_GetEventProcData event_name evt_blks blk_mod_arr event_output $udc_name_list
} else {
