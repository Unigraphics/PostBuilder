...
proc __prv_AddEvtHList { tree t evt_obj_list } {
  ...
  foreach evt_obj $evt_obj_list \
  {
   ...
   set event_name [__prv_TransEventName $event_name $event_label]
   $h add 0.$t.$evt_indx -itemtype imagetext -text $event_name \
   -style $style1
   $tree setstatus 0.$t.$evt_indx $gPB(check_box_status)
   incr evt_indx
...
#=======================================================================
proc __prv_TransEventName { event_name event_label {type 0} } {
  global gPB
  if { $type == 0 } {
  ...
  if {[info exists mom_sys_arr(Inherit_UDE)] && $mom_sys_arr(Inherit_UDE) == 1} {
   foreach inh_cdl $ads_cdl_arr($ads_cdl_arr(type_inherit),cdl_list) {
    ...
    if [string match $folder ""] {
     ...
     set include_str "$include_str $folder$cdl_fn $folder$def_fn"
    }
   }
  }
        ...
        foreach paramobj $param_obj_list {
         ...
         switch -exact $type {
          param::integer {
           ...
           set param_type "i"
           set param_defv $param::integer::($paramobj,def_value)
          ...
          param::double  {
           ...
           set param_type "d"
           set param_defv $param::double::($paramobj,def_value)
          ...
          param::option  {
           ...
           set param_type "o"
           set param_defv $param::option::($paramobj,def_value)
          ...
          param::boolean {
           ...
           set param_type "b"
           set param_defv $param::boolean::($paramobj,def_value)
          ...
          param::string  {
           ...
           set param_type "s"
           set param_defv $param::string::($paramobj,def_value)
          ...
          param::bitmap  {
           ...
           set param_type "l"
           set param_defv $param::bitmap::($paramobj,def_value)
           lappend new_code "        PARAM $param_name"
           lappend new_code "        \{"
            lappend new_code "           TYPE $param_type"
            if ![string match $param_defv ""] {
          ...
          param::group   {
           ...
           set param_type "g"
           set param_defv $param::group::($paramobj,def_value)
        ...
        foreach def_paramobj $def_param_obj_list {
         ...
         switch -exact $type {
          param::integer {
           ...
           set param_type "i"
           set param_defv $param::integer::($def_paramobj,def_def_value)
          ...
          param::double  {
           ...
           set param_type "d"
           set param_defv $param::double::($def_paramobj,def_def_value)
          ...
          param::option  {
           ...
           set param_type "o"
           set param_defv $param::option::($def_paramobj,def_def_value)
          ...
          param::boolean {
           ...
           set param_type "b"
           set param_defv $param::boolean::($def_paramobj,def_def_value)
          ...
          param::string  {
           ...
           set param_type "s"
           set param_defv $param::string::($def_paramobj,def_def_value)
          ...
          param::bitmap   {
           ...
           set param_type "l"
           set param_defv $param::bitmap::($def_paramobj,def_def_value)
           lappend old_code "        PARAM $param_name"
           lappend old_code "        \{"
            lappend old_code "           TYPE $param_type"
            if ![string match $param_defv ""] {
          ...
          param::group   {
           ...
           set param_type "g"
           set param_defv $param::group::($def_paramobj,def_def_value)
