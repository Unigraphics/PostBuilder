...
{
if { [UI_PB_addr_AddrItemSelec $page_obj $cursor_entry] == 0 } {
return
}
}
...
set idx [string range $ent 2 [string length $ent]]
...
grid $f.blk            -
grid $f.lea     -row 1 -col 0 -padx 11 -pady 3 -sticky w ;#<09-24-02 gsl> -padx was 5
grid $f.lea_val -row 1 -col 1 -padx 5 -pady 3 -sticky nse
grid $f.fmt            -      -padx 1 -pady 3 -sticky ew
grid $f.tra     -row 3 -col 0 -padx 11 -pady 3 -sticky w ;#<09-24-02 gsl> -padx was 5
