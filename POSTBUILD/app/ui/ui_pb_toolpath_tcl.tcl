...
{
set expr_i "(\$mom_pos_arc_center(0) - \$mom_prev_pos(0)) * \$mom_sys_lathe_x_factor * \$mom_sys_lathe_i_double"
set expr_k "(\$mom_pos_arc_center(2) - \$mom_prev_pos(2)) * \$mom_sys_lathe_z_factor"
}
"Vector-Center to Arc Start" -
"Vector - Arc Center to Start" \
{
set expr_i "(\$mom_prev_pos(0) - \$mom_pos_arc_center(0)) * \$mom_sys_lathe_x_factor * \$mom_sys_lathe_i_double"
set expr_k "(\$mom_prev_pos(2) - \$mom_pos_arc_center(2)) * \$mom_sys_lathe_z_factor"
}
"Unsigned Vector - Arc Start to Center" \
{
set expr_i "abs(\$mom_pos_arc_center(0) - \$mom_prev_pos(0)) * \$mom_sys_lathe_i_double"
set expr_k "abs(\$mom_pos_arc_center(2) - \$mom_prev_pos(2))"
}
"Vector - Absolute Arc Center"
{
set expr_i "\$mom_pos_arc_center(0) * \$mom_sys_lathe_x_factor * \$mom_sys_lathe_i_double"
set expr_k "\$mom_pos_arc_center(2) * \$mom_sys_lathe_z_factor"
}
default {
return 0
}
...
if [expr {$block_element::($focus_blk_elem,force)==1}] {
