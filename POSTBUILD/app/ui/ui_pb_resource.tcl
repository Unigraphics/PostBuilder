...
##############################################################################
# Description                                                                #
#    This file defines User Interface resources for the NX/Post Builder.     #
#                                                                            #
##############################################################################
...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Current Post Builder version number & RTM date
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
set gPB(Postbuilder_Release_Version)  "1899"
set gPB(Postbuilder_Release_Date)     "12/13/2019"
...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Control of allowing variables being used to configure the leaders of
# X/Y/Z/4th/5th/N addresses.
#   0 - To disallow (Default)
#   1 - To restore old behavior
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
if { [info exists env(PB_ALLOW_VAR_SYS_LEADER)] && [string trim $env(PB_ALLOW_VAR_SYS_LEADER)] != "" } {
   set gPB(ALLOW_VAR_SYS_LEADER) $env(PB_ALLOW_VAR_SYS_LEADER)
}


#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Control of disabling composite blocks
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Define marker to be output with a IF condition
# "" or undefined would suppress the marker.
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# set gPB(END_IF_MARKER) "END-IF"
...
#  gPB(animation_control)  1 : Allow animation to be disabled for
#                              whole block or event deletion
#=============================================================================
set gPB(animation)         1
set gPB(animation_delay)   20
set gPB(animation_control) 1
