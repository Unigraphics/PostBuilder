...
set gPB(release_notes)          "$env(UGII_UGDOC_BASE)/tdoc/nx/10/release_notes/#uid:index"
...
#  may not be attached to any event (attach_flag = 0), not be renamed
...
set gPB(special_cmd_state_list) \
       [list "PB_CMD_MOM_clamp 0 0 0" \
             ...
             "PB_CMD__define_debug_msg 1 0 1" \
             "PB_CMD__log_revisions 0 0 1" \
             "PB_CMD___log_revisions 0 0 0" \
