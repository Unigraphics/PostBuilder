...
proc UI_PB_evt_CreateMenuOptions {PAGE_OBJ SEQ_OBJ} {
  ...
  $comb_widget insert end $::gPB(seq,combo,macro,Label)
  set word "Command"
...
set cmd_proc [lindex $cmd_proc_list $count]
 if { [string match "PB_CMD_before_motion" $cmd_proc] || \
  ...
  [string match "$gPB(condition_cmd_prefix)*" $cmd_proc] } { continue }
 if { [lsearch $special_cmd_list $cmd_proc] >= 0 } { continue }
...
foreach func_obj $Post::($post_object,function_blk_list) {
 ...
 $comb_widget insert end $disp_text
 unset disp_text
}
  ...
  foreach param_obj $param_obj_list {
   ...
   switch -exact $ClassName {
    ...
    param::bitmap   {
     ...
     set temp_value   $param::bitmap::($param_obj,def_value)
    }
    param::group    {
     set temp_name    $param::group::($param_obj,name)
     set temp_type    $param::group::($param_obj,type)
     set temp_value   $param::group::($param_obj,def_value)
   ...
   switch -exact $ClassName {
    ...
    param::bitmap   {
     ...
     set  param::bitmap::($param_obj,def_value)  \
     $param::bitmap::($param_obj,def_def_value)
    }
    param::group    {
     ...
     set  param::group::($param_obj,def_value)  \
     $param::group::($param_obj,def_def_value)
   ...
   switch -exact $ClassName {
    ...
    param::bitmap   {
     ...
     set  param::bitmap::($param_obj,def_value)  $temp_value
    }
    param::group   {
     set  param::group::($param_obj,name)        $temp_name
     set  param::group::($param_obj,type)        $temp_type
     set  param::group::($param_obj,def_value)   $temp_value
  ...
  for {set idx 0} {$idx < $nums} {incr idx} {
   ...
   switch -exact $classname {
    ...
    udeEditor::uiBitmap  {
     ...
     set param::bitmap::($pobj,def_value) \
    ...
    udeEditor::uiGroup   {
     ...
     set param::group::($pobj,def_value) \
...
proc UI_PB_ude_CreateBitmapItem {w param_obj isPtc} {
  ...
  $param::bitmap::($param_obj,def_value)
...
proc UI_PB_ude_CreateGroupItem {w param_obj isPtc} {
  ...
  $param::group::($param_obj,def_value)
...
proc UI_PB_ude_ParamDlgOK {w type {arg_w ""}} {
   ...
   switch -exact $type {
    ...
    Bitmap  {
     ...
     set param::bitmap::($param_obj,def_value) $udeEditor::($OBJ,l_dvalue)
    }
    Group   {
     set TYPE g
     set param_obj [param::CreateObject TYPE]
     ...
     set param::group::($param_obj,def_value) $udeEditor::($OBJ,g_dvalue)
     ...
     set param::group::($end_param_obj,def_value) "end"
