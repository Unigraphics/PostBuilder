...
$comb_widget insert end $::gPB(seq,combo,new,Label)
$comb_widget insert end $::gPB(seq,combo,comment,Label)
set comb_elem_list ""
$comb_widget insert end $::gPB(seq,combo,custom,Label)
set word "Command"
...
[string match "PB_CMD_kin*" $cmd_proc] } { continue }
...
append code $dash
set code [string range $code 0 16]
} else {
append code "--"
}
...
-justify left -state readonly  -cursor ""
}
4.1 {
[$comb_widget subwidget entry] config -bg $paOption(entry_disabled_bg) \
-justify left -state disabled  -cursor ""
}
}
$comb_widget pick 0
}
...
if {$::env(PB_UDE_ENABLED) == 1} {
if {[string length $event_label] >= 20} {
set temp_string [string range $event_label 0 20]
set temp_string "[string range $temp_string 0 16]..."
set event_label $temp_string
}
}
...
$paOption(tree_bg) black $rect_gap "nc_code"]
...
UI_PB_mthd_CreateDDBlock $X $Y eventblock_up $t_shift $icon_name $elem_text
}
...
if { [info exists current_blk_obj]  &&  $block::($current_blk_obj,blk_type) != "normal" } {
set in_line_flag 0
}
...
set temp_value   $param::integer::($param_obj,def_value)
...
set temp_value   $param::double::($param_obj,def_value)
...
set temp_value   $param::option::($param_obj,def_value)
...
set temp_value   $param::boolean::($param_obj,def_value)
...
set temp_value   $param::string::($param_obj,def_value)
}
param::point    {
...
set  param::integer::($param_obj,def_value) \
$param::integer::($param_obj,def_def_value)
...
set  param::double::($param_obj,def_value)  \
$param::double::($param_obj,def_def_value)
...
set  param::option::($param_obj,def_value)  \
$param::option::($param_obj,def_def_value)
...
set  param::boolean::($param_obj,def_value) \
$param::boolean::($param_obj,def_def_value)
...
set  param::string::($param_obj,def_value)  \
$param::string::($param_obj,def_def_value)
}
param::point    {
...
set  param::integer::($param_obj,def_value) $temp_value
...
set  param::double::($param_obj,def_value)  $temp_value
...
set  param::option::($param_obj,def_value)  $temp_value
...
set  param::boolean::($param_obj,def_value) $temp_value
...
set  param::string::($param_obj,def_value)  $temp_value
}
param::point    {
...
set param::integer::($pobj,def_value) \
...
set param::double::($pobj,def_value) \
...
set param::string::($pobj,def_value) \
...
if {$toggle_v == 1} {
set param::boolean::($pobj,def_value) TRUE
} else {
set param::boolean::($pobj,def_value) FALSE
}
...
set param::option::($pobj,def_value) \
...
if {[string length $event_label] >= 20} {
set temp_string "[string range $event_label 0 16]..."
set event_label $temp_string
}
if {$is_non_mc_evt == 1} {
...
set type_list [list Integer Real Text Boolean Option Point]
...
return $event::($event_obj,cyc_evt_obj)
}
}
...
$param::integer::($param_obj,def_value)
...
set OBJ $udeEditor::(obj)
set ic [checkbutton $w.c -bd $udeEditor::($OBJ,bd_value) -highlightt 0 -height 2 \
-variable udeEditor::uiInteger::($obj,toggle_v) \
-command "UI_PB_ude_ShiftBuddyState $obj" ]
set il [label $w.l -textvariable udeEditor::uiInteger::($obj,ui_label) \
-height 2 -fg $udeEditor::($OBJ,item_fg)]
set ie [entry $w.e -width 6 -textvariable udeEditor::uiInteger::($obj,value)]
if {$isPtc == 1} {
...
bind $il <Button-1>  {event generate [winfo parent %W] <Button-1> \
-rootx %X -rooty %Y}
bind $il <B1-Motion> {event generate [winfo parent %W] <B1-Motion> \
-rootx %X -rooty %Y}
bind $il <ButtonRelease-1> {event generate [winfo parent %W] <ButtonRelease-1>}
bind $il <Button-3> {event generate [winfo parent %W] <Button-3> \
-rootx %X -rooty %Y}
if {$udeEditor::uiInteger::($obj,toggle_v) != -1} {
pack $ic -side left -padx 3
}
if ![string compare $::tix_version 8.4] {
pack $il -side left -padx 0
} else {
pack $il -side left -padx 0 -pady 3
}
pack $ie -side right -padx 5
}
...
$param::double::($param_obj,def_value)
...
set OBJ $udeEditor::(obj)
set rc [checkbutton $w.c -bd $udeEditor::($OBJ,bd_value) -highlightt 0 -height 2 \
-variable udeEditor::uiReal::($obj,toggle_v) \
-command "UI_PB_ude_ShiftBuddyState $obj"]
set rl [label $w.l -textvariable udeEditor::uiReal::($obj,ui_label) \
-height 2 -fg $udeEditor::($OBJ,item_fg)]
set re [entry $w.e -width 6 -textvariable udeEditor::uiReal::($obj,value)]
...
bind $rl <Button-1>  {event generate [winfo parent %W] <Button-1> \
-rootx %X -rooty %Y}
bind $rl <B1-Motion> {event generate [winfo parent %W] <B1-Motion> \
-rootx %X -rooty %Y}
bind $rl <ButtonRelease-1> {event generate [winfo parent %W] <ButtonRelease-1>}
bind $rl <Button-3> {event generate [winfo parent %W] <Button-3> \
-rootx %X -rooty %Y}
if {$udeEditor::uiReal::($obj,toggle_v) != -1} {
pack $rc -side left -padx 3
}
if ![string compare $::tix_version 8.4] {
pack $rl -side left -padx 0
} else {
pack $rl -side left -padx 0 -pady 3
}
pack $re -side right -padx 5
}
...
$param::string::($param_obj,def_value)
...
set OBJ $udeEditor::(obj)
set tf [frame $w.tf]
set tc [checkbutton $tf.c -bd $udeEditor::($OBJ,bd_value) -highlightt 0 -height 1 \
-variable udeEditor::uiText::($obj,toggle_v) \
-command "UI_PB_ude_ShiftBuddyState $obj"]
set tl [label $tf.l -textvariable udeEditor::uiText::($obj,ui_label) \
-height 1 -fg $udeEditor::($OBJ,item_fg)]
set te [entry $w.e -width 6 -textvariable udeEditor::uiText::($obj,value)]
if {$isPtc == 1} {
$tf config -bg $udeEditor::($OBJ,bg_for_mce)
$tc config -bg $udeEditor::($OBJ,bg_for_mce) \
-activebackground $udeEditor::($OBJ,bg_for_mce)
$tl config -bg $udeEditor::($OBJ,bg_for_mce)
} else {
$tf config -bg $udeEditor::($OBJ,bg_for_non_mce)
...
pack $tc -side left -padx 3
}
if ![string compare $::tix_version 8.4] {
pack $tl -side left -padx 0
} else {
pack $tl -side left -padx 0 -pady 3
}
pack $tf -side top -anchor w
pack $te -padx 5 -pady 5 -fill x
}
...
set OBJ $udeEditor::(obj)
set tf [frame $w.tf]
set pc [checkbutton $tf.c -bd $udeEditor::($OBJ,bd_value) -highlightt 0 -height 1 \
-variable udeEditor::uiPoint::($obj,toggle_v) \
-command "UI_PB_ude_ShiftBuddyState $obj"]
set pl [label $tf.l -textvariable udeEditor::uiPoint::($obj,ui_label) \
-height 1 -fg $udeEditor::($OBJ,item_fg)]
set bf [frame $w.bf]
set sb [label $bf.sb -text $gPB(ude,editor,pnt,sel,Label) -takefocus 0 \
-width 10 -relief raised -height 1 -font $gPB(bold_font) \
-bd 2 -anchor center\
...
<Button-3> -rootx %X -rooty %Y}
bind $bf <Button-1> {event generate [winfo parent %W] <Button-1> \
-rootx %X -rooty %Y}
bind $bf <B1-Motion> {event generate [winfo parent %W] <B1-Motion> \
-rootx %X -rooty %Y}
bind $bf <ButtonRelease-1> {event generate [winfo parent %W] <ButtonRelease-1>}
bind $bf <Button-3> {event generate [winfo parent %W] <Button-3> \
-rootx %X -rooty %Y}
if {$udeEditor::uiPoint::($obj,toggle_v) != -1} {
pack $pc -side left -padx 3
}
if ![string compare $::tix_version 8.4] {
pack $pl -side left -padx 0
} else {
pack $pl -side left -padx 0 -pady 3
}
pack $tf -side top -anchor w
pack $sb -side left -padx 5
pack $db -side right -padx 5
pack $bf -fill x -pady 4
}
...
if ![string compare $param::boolean::($param_obj,def_value) TRUE] {
...
$param::option::($param_obj,def_value)
...
set OBJ $udeEditor::(obj)
set tf [frame $w.tf -bg $udeEditor::($OBJ,ddblock_bg_edit)]
set tc [checkbutton $tf.c -bd $udeEditor::($OBJ,bd_value) -highlightt 0 -height 1 \
-bg $udeEditor::($OBJ,ddblock_bg_edit) \
-variable udeEditor::uiText::($obj,toggle_v)]
set tl [label $tf.l -textvariable udeEditor::uiText::($obj,ui_label) \
...
-bg $udeEditor::($OBJ,ddblock_bg_edit) \
-fg $udeEditor::($OBJ,item_fg)]
set bf [frame $w.bf -bg $udeEditor::($OBJ,ddblock_bg_edit)]
set sb [label $bf.sb -text $gPB(ude,editor,pnt,sel,Label) -takefocus 0 \
...
set db [label $bf.db -text $gPB(ude,editor,pnt,dsp,Label) -takefocus 0 \
-width 10 -font $gPB(bold_font)  -relief raised -height 1 \
-bg $udeEditor::($OBJ,ddblock_bg_edit) \
-fg $udeEditor::($OBJ,item_fg) -bd 2 -anchor center]
if {$udeEditor::uiPoint::($obj,toggle_v) == 0} {
if ![string compare $::tix_version 8.4] {
...
pack $sb -side left -padx 5
if ![string compare $::tix_version 8.4] {
pack $db -side right -padx [list 9 5]
} else {
pack $db -side right -padx 6
}
pack $bf -fill x -pady 4
}
...
bind $name_e <KeyRelease> {%W config -state normal}
...
bind $pname_e <KeyPress> "UI_PB_com_DisableSpecialChars %W %K"
...
pack $f1 $f1_f $f2 $f2_f $f3 $f3_f -side top -fill x -pady 2 -padx 5
...
set toggleFrame [frame .ddBlock.tf -bd 3 \
...
set entryFrame [frame .ddBlock.ef -bd 2 -width 70 \
...
Text    {
wm geom .ddBlock 180x56+[expr {$X - 90}]+[expr {$Y - 28}]
set topframe [frame .ddBlock.topf \
-bg $udeEditor::($OBJ,ddblock_bg_new)]
set toggleFrame [frame $topframe.tf -bd 3 -width 13 \
-height 13 -relief sunken \
-bg $udeEditor::($OBJ,ckb_bg)]
set typelabel [label $topframe.l \
-text $gPB(ude,editor,txt,Label) \
-fg $udeEditor::($OBJ,ddblock_fg_new) \
-bg $udeEditor::($OBJ,ddblock_bg_new)]
set entryFrame [frame .ddBlock.ef -bd 2 -width 60 \
-height 20 -relief sunken \
-bg $udeEditor::($OBJ,type_widget_bg)]
pack $toggleFrame $typelabel -side left -padx 5
pack $topframe -side top -pady 2 -anchor w
...
Point   {
wm geom .ddBlock 180x65+[expr {$X - 90}]+[expr {$Y - 28}]
set topframe [frame .ddBlock.topf \
-bg $udeEditor::($OBJ,ddblock_bg_new)]
set toggleFrame [frame $topframe.tf -bd 3 -width 13 \
-height 13 -relief sunken \
...
-fg $udeEditor::($OBJ,ddblock_fg_new) \
-bg $udeEditor::($OBJ,ddblock_bg_new)]
set botframe [frame .ddBlock.botf \
-bg $udeEditor::($OBJ,ddblock_bg_new)]
...
pack $botframe -fill x -expand yes -padx 5 -pady 2
}
}
...
set param::integer::($param_obj,def_value) $udeEditor::($OBJ,i_dvalue)
...
set param::double::($param_obj,def_value) $udeEditor::($OBJ,r_dvalue)
...
set param::string::($param_obj,def_value) $udeEditor::($OBJ,t_dvalue)
...
set param::option::($param_obj,toggle) $udeEditor::($OBJ,o_toggle)
...
set param::boolean::($param_obj,def_value) $udeEditor::($OBJ,b_dvalue)
...
bind $de <KeyPress> "UI_PB_com_ValidateDataOfEntry %W %K i 1"
...
set gPB(c_help,$de) "ude,editor,paramdlg,DF"
set gPB(c_help,$sub4.m) "ude,editor,paramdlg,TG,B"
bind $de <KeyPress> "UI_PB_com_ValidateDataOfEntry %W %K f 1"
bind $de <KeyRelease> {%W config -state normal ;set ::gPB(prev_key) ""}
pack $pl -side top -anchor w
pack $pe -fill x -pady 10 -padx 5
pack $vn -side top -anchor w
...
-command "UI_PB_ude_AddOption $lb" -takefocus 0]
...
bind $sub4.m <Button-1> "+ UI_PB_ude_OptFocusIn"
...
pack $btn_add $btn_cut $btn_pst -padx 6 -side left
} else {
pack $lf_f -expand yes -fill both -pady 5 -side top
pack $btn_add $btn_cut $btn_pst -padx 3 -side left
}
...
set cw ${path_name}.tf.c
set lw ${path_name}.tf.l
set ew ${path_name}.e
...
set cw ${path_name}.tf.c
set lw ${path_name}.tf.l
set dw ${path_name}.bf.db
set sw ${path_name}.bf.sb
...
switch -exact $type {
Integer {
set ic [checkbutton $top_f.c -bd $udeEditor::($OBJ,bd_value) -highlightt 0 -height 2 \
-variable udeEditor::($OBJ,i_toggle) \
-bg $udeEditor::($OBJ,sunken_bg) \
-activebackground $udeEditor::($OBJ,sunken_bg) \
-offvalue "Off" -onvalue "On"]
set il [label $top_f.l -textvariable udeEditor::($OBJ,i_label) \
-height 2 -fg $udeEditor::($OBJ,item_fg) \
-bg $udeEditor::($OBJ,sunken_bg)]
set ie [entry $top_f.e -textvariable udeEditor::($OBJ,i_dvalue) \
-width 6]
UI_PB_ude_TraceVariable udeEditor::($OBJ,i_toggle) w \
...
Real    {
set rc [checkbutton $top_f.c -bd $udeEditor::($OBJ,bd_value) -highlightt 0 -height 2 \
-variable udeEditor::($OBJ,r_toggle) \
-bg $udeEditor::($OBJ,sunken_bg) \
-activebackground $udeEditor::($OBJ,sunken_bg) \
-offvalue "Off" -onvalue "On"]
set rl [label $top_f.l -textvariable udeEditor::($OBJ,r_label) \
-height 2 -fg $udeEditor::($OBJ,item_fg) \
-bg $udeEditor::($OBJ,sunken_bg)]
set re [entry $top_f.e -textvariable udeEditor::($OBJ,r_dvalue) \
-width 6]
UI_PB_ude_TraceVariable udeEditor::($OBJ,r_toggle) w \
...
Text    {
set tf [frame $top_f.tf -bg $udeEditor::($OBJ,sunken_bg)]
set tc [checkbutton $tf.c -bd $udeEditor::($OBJ,bd_value) -highlightt 0 -height 1 \
-variable udeEditor::($OBJ,t_toggle) \
-bg $udeEditor::($OBJ,sunken_bg) \
-activebackground $udeEditor::($OBJ,sunken_bg) \
-offvalue "Off" -onvalue "On"]
set tl [label $tf.l -textvariable udeEditor::($OBJ,t_label) \
-height 1 -fg $udeEditor::($OBJ,item_fg) \
-bg $udeEditor::($OBJ,sunken_bg)]
set te [entry $top_f.e -textvariable udeEditor::($OBJ,t_dvalue) \
-width 6]
UI_PB_ude_TraceVariable udeEditor::($OBJ,t_toggle) w \
...
Point   {
set tf [frame $top_f.tf -bg $udeEditor::($OBJ,sunken_bg)]
set bf [frame $top_f.bf -bg $udeEditor::($OBJ,sunken_bg)]
set pc [checkbutton $tf.c -bd $udeEditor::($OBJ,bd_value) -highlightt 0 -height 1 \
-variable udeEditor::($OBJ,p_toggle) \
-bg $udeEditor::($OBJ,sunken_bg) \
-activebackground $udeEditor::($OBJ,sunken_bg) \
-offvalue "Off" -onvalue "On"]
set pl [label $tf.l -textvariable udeEditor::($OBJ,p_label) \
-height 1 -fg $udeEditor::($OBJ,item_fg) \
-bg $udeEditor::($OBJ,sunken_bg)]
set sb [label $bf.sb -text $gPB(ude,editor,pnt,sel,Label) -takefocus 0 \
...
if ![string compare $::tix_version 8.4] {
pack $bottomframe -side bottom  -fill x -pady 2 -padx 2
pack $f1 $f1_f $f2 -fill x -expand no \
-padx 5
} else {
pack $bottomframe -side bottom  -fill x -pady 3 -padx 2
pack $f1 $f1_f $f2 -fill x -expand no \
