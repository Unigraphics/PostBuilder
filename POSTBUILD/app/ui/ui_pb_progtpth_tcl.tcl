...
set seq_obj [lindex $seq_obj_list 7]
...
$page_id.master config -command "__lnk_TogglePostList $page_obj"
}
...
proc __lnk_TogglePostList { page_obj args } {
global mom_sys_arr
...
label  $frm.head_lbl -text "Head " -justify left -font $tixOption(bold_font)
...
label  $frm.post_lbl -text "Post " -justify left -font $tixOption(bold_font)
...
bind $frm.head_ent <KeyRelease> {%W config -state normal}
