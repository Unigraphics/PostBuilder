...
proc UI_PB_mach_LatheGeneralParams { PAGE_OBJ gen_frm axis_param } {
  ...
  set gPB(c_help,$fmult.dpg)     "machine,gen,axis_multi,dia"
  set gPB(c_help,$fmult.xmirr)   "machine,gen,axis_multi,x"
  set gPB(c_help,$fmult.zmirr)   "machine,gen,axis_multi,z"
