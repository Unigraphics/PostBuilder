...
proc __IsLanguageDefined { msg_file_name } {
 ...
 if { 0 && [info exists ::env(UGII_MAJOR_VERSION)] } {
 ...
 set gPB(Postbuilder_Release_Version)  "1847"
 set gPB(Postbuilder_Release_Version)  "1872"
     ...
     if { $gPB(localize_lan_menu_item) == 0 } {
      switch $fn {
       ...
       pb_msg_brazilian_portuguese {
        set lbl "Portugu\u00EAs (Brasil)" ;#"Portugu???s (Brasil)" ;#"Portugueses Brasileiros"
       }
       pb_msg_english {
        set lbl English
       }
...
proc UI_PB_DisplayPostProperty { } {
  ...
  UI_PB_com_CreateTransientWindow $win "$gPB(main,file,properties,Label)" "800x750+120+140" \
