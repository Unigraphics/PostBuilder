...
proc __IsLanguageDefined { msg_file_name } {
 ...
 set gPB(Postbuilder_Version)       "2010.0.1"
 set release_date                   "01/27/2017"
 set phase                          ".1"
 set gPB(Postbuilder_PUI_Version)   "2010.0.0.1"
...
proc __DisplayDebugOptionTip { args } {
  if { $::gPB(PB_POST_DEBUG) != "" } {
   ...
   "Special statements will be embedded throughout the post to display the information of commands\
   being executed, as operator messages, during a NX/Post run.\
   This option should be disabled upon the release of the post to production.\
   \n\nYou may also import custom command PB_CMD__define_debug_msg from\
   \"postbuild/pblib/custom_command/pb_cmd_debug_utils.tcl\" to enahnce\
   the messages with more information for debugging purpose.\
   \n\nOnce you have saved the post with debug option enabled, Do Not edit the post's files manually!\
   \n\nThis option is turned off automatically, when post is open again in Post Builder."
...
proc __DisplayAboutPostBuilder {} {
  ...
  $gPB(Postbuilder_Release_Version)$gPB(Postbuilder_Version_Phase)\
