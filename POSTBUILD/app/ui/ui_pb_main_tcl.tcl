...
proc __IsLanguageDefined { msg_file_name } {
 ...
 set gPB(Postbuilder_Version)       "2009.0.3"
 set release_date                   "11/17/2015"
 set phase                          ".0"
 set gPB(Postbuilder_PUI_Version)   "2008.1.1.0"
...
proc __main_AddOptionsMenu { } {
  ...
  if { ![info exists gPB(PB_POST_DEBUG_exclude)] } {
   ...
   "PB_CMD__list_debug_info" "PB_CMD_pause"]
  }
  if { [info exist gPB(PB_POST_DEBUG)] && [string length [string trim $gPB(PB_POST_DEBUG)]] > 0 } {
