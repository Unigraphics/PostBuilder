...
proc __IsLanguageDefined { msg_file_name } {
 ...
 set gPB(Postbuilder_Version)       "2007.5.3"
 set release_date                   "10/10/2013"
 set phase                          ".0"
 set gPB(Postbuilder_PUI_Version)   "2007.0.3.0"
...
proc UI_PB_DisplayPostProperty { } {
  ...
  UI_PB_com_CreateTransientWindow $win "$gPB(main,file,properties,Label)" "800x600+120+140" "" "UI_PB_PostPropertyDisableWidgets" "UI_PB_PostPropertyClose $win" "UI_PB_PostPropertyActivateWidgets $win_index"
