...
proc __IsLanguageDefined { msg_file_name } {
 ...
 set gPB(Postbuilder_Version)       "2011.0.0"
 set release_date                   "10/31/2017" ;#"08/18/2017" ;#"06/30/2017"
 set phase                          ".0"
...
proc UI_PB_main { w } {
  ...
  wm geometry  $w $gPB(TOP_WIN_WI)x$gPB(TOP_WIN_HI)+$xc+$yc
...
proc UI_PB_DisplayPostProperty { } {
  ...
  UI_PB_com_CreateTransientWindow $win "$gPB(main,file,properties,Label)" "800x600+120+140" \
