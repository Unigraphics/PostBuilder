...
set mom_sys_arr(UDE_File_Name) $Post::($post_object,UDE_File_Name)
...
if 0 {
set dir  [file dirname $controller]
set tail [file tail $controller]
set root [file rootname $tail]
set vnc  [file join $dir vnc_$root.tcl]
}
set vnc  [file rootname $controller]_vnc.tcl
if [file exists $vnc] {
...
set version $gPB(Old_PUI_Version)
if { [string compare $gPB(Postbuilder_PUI_Version) $version] > 0 } {
set vnc_tcl_file "$env(PB_HOME)/pblib/vnc_common_v321.tcl"
if [file exists $vnc_tcl_file] {
PB_pps_CreateTclFileObjs post_object $vnc_tcl_file 0
}
if 0 {
set ver [join [lreplace [split $version .] 3 3] .]
if [string match "2002.2.1" $ver] {  ;#<09-24-04 gsl> "2002.2.1" was "3.2.1".
set version $gPB(Postbuilder_PUI_Version)
} else {
set version 2002.2.1.0
}
}
}
if { [string compare $gPB(Postbuilder_PUI_Version) $version] > 0 } {
set vnc_tcl_file "$env(PB_HOME)/pblib/vnc_common_v330.tcl"
if [file exists $vnc_tcl_file] {
PB_pps_CreateTclFileObjs post_object $vnc_tcl_file 0
}
if 0 {
set ver [join [lreplace [split $version .] 3 3] .]
if [string match "2002.3.0" $ver] {  ;#<09-24-04 gsl> "2002.3.0" was "3.3.0".
set version $gPB(Postbuilder_PUI_Version)
} else {
set version 2002.3.0.0
}
}
}
set vnc_tcl_file ""
...
if { ![string match "" $vnc_tcl_file] && \
[file exists $vnc_tcl_file] } {
PB_pps_CreateTclFileObjs post_object $vnc_tcl_file 0
}
if 0 {
Post::GetObjList $post_object command cmd_blk_list
set cmd_obj 0
set cmd_name "PB_CMD_vnc__set_nc_definitions"
PB_com_RetObjFrmName cmd_name cmd_blk_list cmd_obj
if { $cmd_obj <= 0 } {
set cmd_obj_attr(0) "PB_CMD_vnc__set_nc_definitions"
set cmd_obj_attr(1) [list]
lappend cmd_obj_attr(1) "   PB_CMD_vnc____set_nc_definitions"
lappend cmd_obj_attr(1) ""
lappend cmd_obj_attr(1) "  #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
lappend cmd_obj_attr(1) "  # Define more codes to be processed for a subordinate VNC."
lappend cmd_obj_attr(1) "  #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
PB_pps_CreateCommand cmd_obj_attr cmd_obj
}
set cmd_obj 0
set cmd_name "PB_CMD_vnc__sim_other_devices"
PB_com_RetObjFrmName cmd_name cmd_blk_list cmd_obj
if { $cmd_obj <= 0 } {
set cmd_obj_attr(0) "PB_CMD_vnc__sim_other_devices"
set cmd_obj_attr(1) [list]
lappend cmd_obj_attr(1) "   PB_CMD_vnc____sim_other_devices"
lappend cmd_obj_attr(1) ""
lappend cmd_obj_attr(1) "  #++++++++++++++++++++++++++++++++++++++++++++++++++++++"
lappend cmd_obj_attr(1) "  # Simulate more devices specific for a subordinate VNC."
lappend cmd_obj_attr(1) "  #++++++++++++++++++++++++++++++++++++++++++++++++++++++"
PB_pps_CreateCommand cmd_obj_attr cmd_obj
}
}
...
[llength $($post_object,unk_fmt_list)] } {
...
if [PB_is_v $gPB(VNC_release)] {
set vnc_bck_file [file rootname $tcl_bck_file]_vnc.tcl
}
...
if { ![string match "$pui_bck_file" "$pui_file"] } {
if [file exists $def_file] {
file copy -force -- $def_file $def_bck_file
}
if [file exists $tcl_file] {
...
set gPB(backup_method) "NO_BACKUP"
set gPB(backup_one_done) 0
if [file exists $pui_bck_file] {
file delete -force $pui_bck_file
}
if [file exists $tcl_bck_file] {
file delete -force $tcl_bck_file
}
if [file exists $def_bck_file] {
file delete -force $def_bck_file
}
if [file exists $vnc_bck_file] {
file delete -force $vnc_bck_file
}
}
}
