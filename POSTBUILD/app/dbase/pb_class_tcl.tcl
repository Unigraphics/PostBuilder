...
proc SetObjListasAttr { this OBJ_LIST } {
  ...
  if { ![string compare "ude_event"   $ClassName] || \
   ...
   set ude_obj [lindex $Post::($this,ude_obj) 0]
  }
  switch $ClassName\
  {
...
proc GetObjList { this class OBJ_LIST } {
  ...
  switch $class\
  {
   ...
   function    { set obj_list $Post::($this,function_blk_list)   }
...
proc infoObj { this } {
  if $::gPB(DEBUG) {
   ...
   UI_PB_debug_ForceMsg_no_trace "  Parent Block          : $block_element::($this,parent_name)"
   UI_PB_debug_ForceMsg_no_trace "  Owner Event           : $block_element::($this,owner)"
  }
 }
...
#=======================================================================
UI_PB_debug_ForceMsg_no_trace "  1  proc         : $command::($this,proc)"
...
proc diffObj { this {_external 0} } {
  ...
  if { $status == 0 || $_external } {
   foreach evt_elem $event::($this,evt_elem_list) {
    event_element::infoObj $evt_elem
    if [event_element::diffObj $evt_elem $_external] {
     if { $::gPB(DEBUG) } {
      set status 1
      } else {
      return 1
...
proc ListingFile { this } {
  ...
  set def_values {0 listfile.lpt 0 0 0 0 0 0 0 0 40 \
  30 0 0 0 0 0 0 0 0 lpt 0 0 0 ptp 0 pb_user.tcl 0 1 ""}
  set arr_names { listfile fname x y z 4axis 5axis feed \
   speed head lines column warn oper tool start_path \
   tool_chng end_path oper_time setup_time lpt_ext \
   verbose review group ncfile_ext usertcl_check usertcl_name link_var \
  use_default_unit_fragment alt_unit_post_name }
  set ind 0
...
proc function { this } {
  ...
  lappend function::($this,description)        "Custom"
