...
proc setvalue {this OBJ_ATTR} {
  ...
  set param::bitmap::($this,def_value) $obj_attr(2)
 }
...
proc setdefvalue {this OBJ_ATTR} {
  ...
  set param::bitmap::($this,def_def_value) $obj_attr(2)
 }
}
class group {
...
proc setvalue {this OBJ_ATTR} {
  ...
  set param::group::($this,def_value) $obj_attr(2)
...
proc setdefvalue {this OBJ_ATTR} {
  ...
  set param::group::($this,def_def_value) $obj_attr(2)
...
proc DeleteFromBlkElemList {this BLK_ELEM_OBJ} {
  ...
  {
   set index [lsearch $function::($this,blk_elem_list) \
   $blk_elem_obj]
   if {$index != -1} \
   {
