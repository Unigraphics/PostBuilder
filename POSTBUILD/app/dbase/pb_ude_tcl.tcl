      ...
      foreach paramobj $param_obj_list {
       ...
       switch -exact $type {
        param::integer {
         ...
         set type   "i"
         set def_v  $param::integer::($paramobj,def_value)
        ...
        param::double  {
         ...
         set type   "d"
         set def_v  $param::double::($paramobj,def_value)
        ...
        param::option  {
         ...
         set type   "o"
         set def_v  $param::option::($paramobj,def_value)
        ...
        param::boolean {
         ...
         set type   "b"
         set def_v  $param::boolean::($paramobj,def_value)
        ...
        param::string  {
         ...
         set type   "s"
         set def_v  $param::string::($paramobj,def_value)
        ...
        param::bitmap  {
         ...
         set type   "l"
         set def_v  $param::bitmap::($paramobj,def_value)
         puts $fid "   PARAM $name"
         puts $fid "   \{"
          puts $fid "      TYPE $type"
          puts $fid "      DEFVAL \"$def_v\""
        ...
        param::group  {
         ...
         set type   "g"
         set def_v  $param::group::($paramobj,def_value)
...
proc PB_ude_SetGlobalVars {} {
  ...
  {Tap_Float} {Thread} {Lathe Roughing}]
