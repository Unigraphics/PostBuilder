   ...
   switch $line\
   {
    ...
    "## MASTER SEQUENCE END"         {
     ...
     if [info exists new_msq_add_name] {
      ...
      new_msq_word_param
      update idletasks
      if [info exists new_msq_word_param(cycle_R)] {
       UI_PB_debug_ForceMsg "cycle_R 0 == $new_msq_word_param(cycle_R)"
      }
     ...
     if [info exists msq_add_name] \
     {
      ...
      msq_word_param
      update idletasks
      if [info exists msq_word_param(cycle_R)] {
       UI_PB_debug_ForceMsg "cycle_R 1 == $msq_word_param(cycle_R)"
      }
      unset msq_add_name
      unset msq_word_param
     }
