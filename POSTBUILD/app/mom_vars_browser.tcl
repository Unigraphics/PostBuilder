...
#=======================================================================
proc MR_textLoadFile {wlist wclass wdes file namePat} {
    global __hello_var_names  __hello_class_names  __hello_des_names  __hello_value_names;
    global __hello_type_names  __hello_def_names env MR_file MR_curr;
    global PB_HOME gPB_mom_var_values;
    if {[info exists PB_HOME]} {
       set f [open $gPB_mom_var_values];
...
proc MR_fileDialog {wlist wclass wdes} {
   ...
   if {[string compare $file ""] != 0} {
     set MR_file $file;
     MR_textLoadFile $wlist $wclass $wdes $file $MR_file;
   }
} ;
...
proc _mom_chm_reader { w } {
    ...
    if { $mom_vars_csv_found } {
       ...
       MR_textLoadFile $wlist $wclass $wdes $mom_vars_browser $namePat;
     } else {
