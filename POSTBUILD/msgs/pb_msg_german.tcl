...
::msgcat::mcset pb_msg_german "MC(main,file,close,Balloon)"            "PP in Bearbeitung speichern."
...
::msgcat::mcset pb_msg_german "MC(msg,no_file)"                        "Verschlüsselte Datei für dieses lizenzierte PP fehlt."
::msgcat::mcset pb_msg_german "MC(msg,no_license)"                     "Sie besitzen keine gültige Lizenz für die Ausführung dieser Funktion."
::msgcat::mcset pb_msg_german "MC(msg,no_license_title)"               "UG/Postprozessor - Nicht lizenzierte Verwendung"
::msgcat::mcset pb_msg_german "MC(msg,no_license_dialog)"              "Es ist zulässig, dass Sie den UG/Postprozessor\n ohne gültige Lizenz verwenden.  Jedoch werden Sie\n Ihre Arbeit nicht speichern können."
...
::msgcat::mcset pb_msg_german "MC(new,machine,Label)"                  "Maschinenwerkzeug"
::msgcat::mcset pb_msg_german "MC(new,machine,Context)"                "Maschinenwerkzeug-Typ, für den der Postprozessor erzeugt werden soll."
...
#Axis Type
::msgcat::mcset pb_msg_german "MC(new,mach_axis,Label)"                "Maschinen-Werkzeugachse"
::msgcat::mcset pb_msg_german "MC(new,mach_axis,Context)"              "Maschinen-Werkzeugachse auswählen"
...
::msgcat::mcset pb_msg_german "MC(show_mt,title,Label)"                "Maschinenwerkzeug"
...
::msgcat::mcset pb_msg_german "MC(inposts,title,Label)"                "PPs installieren"
...
# Machine Tool
#++++++++++++++
::msgcat::mcset pb_msg_german "MC(machine,tab,Label)"                  "Maschinenwerkzeug"
::msgcat::mcset pb_msg_german "MC(machine,Status)"                     "Maschinen-Kinematik-Parameter festlegen."

::msgcat::mcset pb_msg_german "MC(msg,no_display)"                     "Ein Bild für diese Maschinen-Werkzeugkonfiguration ist nicht verfügbar."
...
## Display
##
::msgcat::mcset pb_msg_german "MC(machine,display,Label)"              "Maschinenwerkzeug anzeigen"
::msgcat::mcset pb_msg_german "MC(machine,display,Context)"            "Diese Option zeigt das Maschinenwerkzeug an"
::msgcat::mcset pb_msg_german "MC(machine,display_trans,title,Label)"  "Maschinenwerkzeug"
...
::msgcat::mcset pb_msg_german "MC(machine,gen,lathe_post,select_name,Context)" "Wählen Sie den Namen eines Drehpostens, der in einem einfachen Fräs-/ Drehposten verwendet werden soll. Vermutlich kann dieser Posten im \\\$ Verzeichnis \"UGII_CAM_POST_DIR\" in der UG/Posten-Laufzeit gefunden werden; anderenfalls wird ein Posten mit demselben Namen in dem Verzeichnis verwendet, in dem der Fräsposten enthalten ist."
...
::msgcat::mcset pb_msg_german "MC(link_post,head,Context)"             "Ein komplexes Maschinenwerkzeug kann seine Bearbeitungsoperationen mit Hilfe verschiedener Kinematiksätze in unterschiedlichen Bearbeitungsverfahren.  Jeder Kinematiksatz wird als unabhängiger Kopf in UG/Posten behandelt. Bearbeitungsoperationen, die mit einem speziellen Kopf ausgeführt werden müssen, werden in einer Gruppe im Maschinenwerkzeug oder der Bearbeitungsmethodenansicht platziert. Ein UDE \\\"Kopf\\\" wird dann der Gruppe zugewiesen, um den Kopfnamen zu bestimmen."

::msgcat::mcset pb_msg_german "MC(link_post,post,Label)"               "PP"
...
::msgcat::mcset pb_msg_german "MC(link_post,select_name,Context)"      "Wählen Sie den Namen eines Postens, der dem Kopf zugewiesen werden soll. Vermutlich kann dieser Posten in dem Verzeichnis gefunden werden, in dem sich der Hauptposten bei der UG/Posten-Laufzeit befindet; anderenfalls wird ein Posten mit identischem Namen im Verzeichnis \\\$UGII_CAM_POST_DIR verwendet."
...
::msgcat::mcset pb_msg_german "MC(link_post,dlg,post,Label)"           "PP"
...
::msgcat::mcset pb_msg_german "MC(definition,include,Label)"           "EINSCHLIESSEN"
...
::msgcat::mcset pb_msg_german "MC(event,cycle,customize,Context)"      "Mit diesem Schalter kann ein Zyklus angepasst werden. \n\nStandardmäßig wird die Basiskonstruktion jedes Zyklus von den Einstellungen der gemeinsamen Parameter definiert. Diese gemeinsamen Elemente in jedem Zyklus dürfen nicht geändert werden. \n\nMit der Aktivierung dieses Schalters erhalten Sie vollständige Kontrolle über die Konfiguration eines Zyklus.  Vorgenommene Änderungen an den gemeinsamen Parametern beeinträchtigen den angepassten Zyklus nicht mehr."
...
::msgcat::mcset pb_msg_german "MC(event,cycle,com_param,name)"         "Gemeinsame Parameter"
...
::msgcat::mcset pb_msg_german "MC(ude,editor,eventdlg,EC_WEDM,Label)"      "Drahterod."
...
::msgcat::mcset pb_msg_german "MC(ude,editor,popup,MSG_SameHandler)"   "Ereignis-Behandlungsroutine existiert. \nBitte ändern Sie nach der Prüfung den Ereignis - bzw. PP-Namen."
...
::msgcat::mcset pb_msg_german "MC(ude,import,ihr_pst,Label)"           "PP"
...
::msgcat::mcset pb_msg_german "MC(udc,editor,popup,MSG_SameHandler)"   "Ereignis-Behandlungsroutine ist bereits vorhanden.\n Bitte den Zyklus-Ereignisnamen ändern."
...
::msgcat::mcset pb_msg_german "MC(isv,setup,machine,Label)"            "Maschinenwerkzeug"
...
::msgcat::mcset pb_msg_german "MC(isv,setup,axis_name,Label)"          "An Maschinenwerkzeug festgelegt Achse"
::msgcat::mcset pb_msg_german "MC(isv,setup,axis_name,Context)"        "Legen Sie die Achsennamen fest, die mit der Kinematikkonfiguration des Maschinenwerkzeugs übereinstimmt"
...
::msgcat::mcset pb_msg_german "MC(isv,setup,initial_motion,Context)"   "Ausgangsbewegung des Maschinenwerkzeugs festlegen"
...
::msgcat::mcset pb_msg_german "MC(isv,incr_a,Label)"                   "4. Achse "
...
# WCS Definition
################
::msgcat::mcset pb_msg_german "MC(isv,machine_zero,offset,Label)"      "Nullbearbeitungs-Offset von\nMaschinenwerkzeug-Nullbefestigung"
