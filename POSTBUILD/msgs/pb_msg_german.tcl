...
::msgcat::mcset pb_msg_german "MC(event,cycle,plane_change,label)"   "Arbeitsebenen-Änderung auf untere erkennen"
...
### Program End
::msgcat::mcset pb_msg_german "MC(event,end_prog,name)"                "rogrammende"
...
::msgcat::mcset pb_msg_german "MC(udc,drill,simulate,INFO)"            "Dies ist ein simuliertes CYCLE-Ereignis"
...
::msgcat::mcset pb_msg_german "MC(isv,g_code,return_home,Label)"       "Zur Startseite zurückkehren"
