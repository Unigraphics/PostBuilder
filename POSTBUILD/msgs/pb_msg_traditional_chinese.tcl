...
# pb800
#=============================================================================
::msgcat::mcset pb_msg_traditional_chinese "MC(event,misc,subop_start,name)"      "子工序刀軌開始"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,misc,subop_end,name)"        "子工序刀軌結束"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,misc,contour_start,name)"    "輪廓起點"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,misc,contour_end,name)"      "輪廓終點"
::msgcat::mcset pb_msg_traditional_chinese "MC(prog,tree,misc,Label)"             "其他"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,cycle,lathe_rough,name)"     "車削粗加工"
::msgcat::mcset pb_msg_traditional_chinese "MC(main,file,properties,Label)"       "後處理屬性"

::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,popup,MSG_CATEGORY)"    "銑床或車床後處理 UDE 可能無法僅通過\"線切割\"類別指定！"

::msgcat::mcset pb_msg_traditional_chinese "MC(event,cycle,plane_change,label)"   "偵測下部的工作平面變更"
::msgcat::mcset pb_msg_traditional_chinese "MC(format,check_1,error,msg)"         "格式不適合運算式的值"

::msgcat::mcset pb_msg_traditional_chinese "MC(format,check_4,error,msg)"         "在離開或儲存此後處理之前變更相關地址的格式！"
::msgcat::mcset pb_msg_traditional_chinese "MC(format,check_5,error,msg)"         "在離開此頁或儲存此後處理之前修改格式！"
::msgcat::mcset pb_msg_traditional_chinese "MC(format,check_6,error,msg)"         "在進入此頁之前變更相關地址的格式！"

::msgcat::mcset pb_msg_traditional_chinese "MC(msg,old_block,maximum_length)"     "以下塊的名稱超出長度限制："
::msgcat::mcset pb_msg_traditional_chinese "MC(msg,old_address,maximum_length)"   "以下字的名稱超出長度限制："
::msgcat::mcset pb_msg_traditional_chinese "MC(msg,block_address,check,title)"    "正在檢查塊和字名稱"
::msgcat::mcset pb_msg_traditional_chinese "MC(msg,block_address,maximum_length)" "一些塊或字名稱超出長度限制。"

::msgcat::mcset pb_msg_traditional_chinese "MC(address,maximum_name_msg)"         "字串長度超出限制。"

::msgcat::mcset pb_msg_traditional_chinese "MC(ude,import,oth_list,Label)"        "包括其他 CDL 檔案"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,import,oth_list,Context)"      "右鍵點擊滑鼠，從快顯功能表中選取\\\"新建\\\"選項以在此後處理中包含其他 CDL 檔案。"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,import,ihr_list,Label)"        "從後處理繼承 UDE"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,import,ihr_list,Context)"      "右鍵點擊滑鼠，從快顯功能表中選取\\\"新建\\\"選項以從後處理繼承 UDE 定義和相關處理常式。"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,import,up,Label)"              "向上"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,import,down,Label)"            "向下"
::msgcat::mcset pb_msg_traditional_chinese "MC(msg,exist_cdl_file)"               "指定的 CDL 檔案已經包含在內！"

::msgcat::mcset pb_msg_traditional_chinese "MC(listing,link_var,check,Label)"     "將 Tcl 變數連結至 C 變數"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,link_var,check,Context)"   "可將一組經常變更的 Tcl 變數（例如 \\\"mom_pos\\\"）直接連結至內部 C 變數以提高後處理效能。但是，應遵循某些限制以避免 NC 輸出中可能出現的錯誤和差異。"

::msgcat::mcset pb_msg_traditional_chinese "MC(msg,check_resolution,title)"       "檢查線性/旋轉運動解析度"
::msgcat::mcset pb_msg_traditional_chinese "MC(msg,check_resolution,linear)"      "格式設定可能不適合\"線性運動解析度\"的輸出。"
::msgcat::mcset pb_msg_traditional_chinese "MC(msg,check_resolution,rotary)"      "格式設定可能不適合\"旋轉運動解析度\"的輸出。"

::msgcat::mcset pb_msg_traditional_chinese "MC(cmd,export,desc,label)"            "已匯出自訂指令的輸入敘述"
::msgcat::mcset pb_msg_traditional_chinese "MC(cmd,desc_dlg,title)"               "敘述"
::msgcat::mcset pb_msg_traditional_chinese "MC(block,delete_row,Label)"           "刪除此列中所有使用中單元"
::msgcat::mcset pb_msg_traditional_chinese "MC(block,exec_cond,set,Label)"        "輸出條件"
::msgcat::mcset pb_msg_traditional_chinese "MC(block,exec_cond,new,Label)"        "新建..."
::msgcat::mcset pb_msg_traditional_chinese "MC(block,exec_cond,edit,Label)"       "編輯..."
::msgcat::mcset pb_msg_traditional_chinese "MC(block,exec_cond,remove,Label)"     "移除..."

::msgcat::mcset pb_msg_traditional_chinese "MC(cust_cmd,name_msg_for_cond)"       "指定其他名稱。\n輸出條件指令的字首應為"

::msgcat::mcset pb_msg_traditional_chinese "MC(machine,linearization,Label)"         "線性插值"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,linearization,angle,Label)"   "旋轉角度"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,linearization,angle,Context)" "將根據旋轉軸起始角度和終止角度的分佈來計算插值點。"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,linearization,axis,Label)"    "刀軸"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,linearization,axis,Context)"  "將根據刀軸起始向量和終止向量的分佈來計算插值點。"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,resolution,continue,Label)"   "繼續"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,resolution,abort,Label)"      "登出"

::msgcat::mcset pb_msg_traditional_chinese "MC(machine,axis,def_lintol,Label)"       "預設公差"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,axis,def_lintol,Context)"     "預設線性化公差"
::msgcat::mcset pb_msg_traditional_chinese "MC(sub_post,inch,Lable)"                 " IN"
::msgcat::mcset pb_msg_traditional_chinese "MC(sub_post,metric,Lable)"               "MM"
::msgcat::mcset pb_msg_traditional_chinese "MC(new_sub,title,Label)"                 "新建副處理器"
::msgcat::mcset pb_msg_traditional_chinese "MC(new,sub_post,toggle,label)"           "副處理"
::msgcat::mcset pb_msg_traditional_chinese "MC(new,sub_post,toggle,tmp_label)"       "僅單位副處理"
::msgcat::mcset pb_msg_traditional_chinese "MC(new,unit_post,filename,msg)"          "新建的備選輸出單位副處理的具名方式為：\n在主後處理名稱後面新增 \"__MM\" 或 \"__IN\" 後置字元。"
::msgcat::mcset pb_msg_traditional_chinese "MC(new,alter_unit,toggle,label)"         "備選輸出單位"
::msgcat::mcset pb_msg_traditional_chinese "MC(new,main_post,label)"                 "主後處理"
::msgcat::mcset pb_msg_traditional_chinese "MC(new,main_post,warning_1,msg)"         "只可使用完整的主後處理來新建副處理！"
::msgcat::mcset pb_msg_traditional_chinese "MC(new,main_post,warning_2,msg)"         "必須在後處理建構器 8.0 或\n更新版本中建立或儲存主後處理。"
::msgcat::mcset pb_msg_traditional_chinese "MC(new,main_post,specify_err,msg)"       "建立副處理時必須指定主後處理！"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,alter_unit,Label)"        "副處理輸出單位："
::msgcat::mcset pb_msg_traditional_chinese "MC(unit_related_param,tab,Label)"        "單位參數"
::msgcat::mcset pb_msg_traditional_chinese "MC(unit_related_param,feed_rate,Label)"  "進給率"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,alt_unit,frame,Label)"        "選用的備選單位副處理"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,alt_unit,default,Label)"      "預設值"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,alt_unit,default,Context)"    "備選單位副處理的預設名稱將是 <後處理名稱>__MM 或 <後處理名稱>__IN"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,alt_unit,specify,Label)"      "指定"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,alt_unit,specify,Context)"    "指定備選單位副處理的名稱"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,alt_unit,select_name,Label)"  "選取名稱"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,alt_unit,warning_1,msg)"      "僅可選取備選單位副處理！"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,alt_unit,warning_2,msg)"      "所選的副處理不支援此後處理的備選輸出單位！"

::msgcat::mcset pb_msg_traditional_chinese "MC(listing,alt_unit,post_name,Label)"    "備選單位副處理"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,alt_unit,post_name,Context)"  "如果提供了單位副處理，NX 後處理將用它們處理此後處理的備選輸出單位。"


##--------------------
## New string in v7.5
##
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,axis,violation,user,evt_title)"  "針對軸限制違例的使用者定義動作"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,helix,name)"                       "螺旋移動"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,circular,ijk_param,prefix,msg)"    "地址中使用的運算式"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,circular,ijk_param,postfix,msg)"   "不會受此選項變更的影響！"
::msgcat::mcset pb_msg_traditional_chinese "MC(isv,spec_codelist,default,msg)"          "此動作會將特殊 NC 程式碼及其處理常式\n的清單還原到開啟或建立此後處理檔案時的狀態。\n\n要繼續嗎？"
::msgcat::mcset pb_msg_traditional_chinese "MC(isv,spec_codelist,restore,msg)"          "此動作會將特殊 NC 程式碼及其處理常式\n的清單還原到上次訪問此頁面時的狀態。\n\n要繼續嗎？"
::msgcat::mcset pb_msg_traditional_chinese "MC(msg,block_format_command,paste_err)"     "物件名存在...貼上無效！"
::msgcat::mcset pb_msg_traditional_chinese "MC(main,file,open,choose_cntl_type)"        "選取控制器家族"
::msgcat::mcset pb_msg_traditional_chinese "MC(cust_cmd,import,no_vnc_cmd,msg)"         "此檔案中沒有包含新的或不同的 VNC 指令！"
::msgcat::mcset pb_msg_traditional_chinese "MC(cust_cmd,import,no_cmd,msg)"             "此檔案中沒有包含新的或不同的自訂指令！"
::msgcat::mcset pb_msg_traditional_chinese "MC(isv,tool_info,name_same_err,Msg)"        "工具名稱不能相同！"
::msgcat::mcset pb_msg_traditional_chinese "MC(msg,limit_to_change_license)"            "您不是此後處理檔案的建立者。\n您無權對其重新命名或變更其授權。"
::msgcat::mcset pb_msg_traditional_chinese "MC(output,other_opts,validation,msg)"       "使用者 tcl 檔案的名稱應指定。"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,empty_entry_err,msg)"            "此參數頁面上有空條目。"
::msgcat::mcset pb_msg_traditional_chinese "MC(msg,control_v_limit)"                    "您嘗試貼上的字串可能超出\n了長度限制或者包含了多列或\n無效字元。"
::msgcat::mcset pb_msg_traditional_chinese "MC(block,capital_name_msg)"                 "塊名稱的開頭字母不能為大寫！\n指定其他名稱。"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,axis,violation,user,Label)"      "使用者定義"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,axis,violation,user,Handler)"    "處理常式"
::msgcat::mcset pb_msg_traditional_chinese "MC(new,user,file,NOT_EXIST)"                "此使用者檔案不存在！"
::msgcat::mcset pb_msg_traditional_chinese "MC(new,include_vnc,Label)"                  "包含虛擬 NC 控制器"
::msgcat::mcset pb_msg_traditional_chinese "MC(other,opt_equal,Label)"                  "等號 (=)"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,nurbs,name)"                       "NURBS 移動"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,cycle,tap_float,name)"             "淺攻絲"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,cycle,thread,name)"                "螺紋"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,group,MSG_NESTED_GROUP)"      "不支援巢狀分組！"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,bmp,Label)"                   "點陣圖"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,bmp,Context)"                 "新增點陣圖參數，方法是將它拖到右側清單中。"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,group,Label)"                 "分組"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,group,Context)"               "新增分組參數，方法是將它拖到右側清單中。"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,eventdlg,DESC,Label)"         "敘述"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,eventdlg,DESC,Context)"       "指定事件資訊"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,eventdlg,URL,Label)"          "URL"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,eventdlg,URL,Context)"        "指定事件敘述的 URL"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,param,MSG_WRONG_IMAGE_FILE)"  "影像檔案必須採用 BMP 格式！"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,param,MSG_WRONG_IMAGE_FOLDER)" "點陣圖檔名不應包含目錄路徑！"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,param,MSG_WRONG_VAR_NAME)"    "變數名稱必須以字母開頭。"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,param,MSG_WRONG_KEYWORD)"     "變數名稱不應使用關鍵字： "
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,status_label)"                "狀態"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,vector,Label)"                "向量"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,vector,Context)"              "新增向量參數，方法是將它拖到右側清單中。"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,popup,MSG_URL_FORMAT)"        "URL 必須採用 \"http://*\" 或 \"file://*\" 格式，且不使用反斜線。"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,popup,MSG_BLANK_HELP_INFO)"   "敘述和 URL 必須指定！"
::msgcat::mcset pb_msg_traditional_chinese "MC(new,MSG_NO_AXIS)"                        "必須為車床選定軸組態。"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,info,controller_type,Label)"     "控制器家族"
::msgcat::mcset pb_msg_traditional_chinese "MC(block,func_combo,Label)"                 "巨集"
::msgcat::mcset pb_msg_traditional_chinese "MC(block,prefix_popup,add,Label)"           "新增字首文字"
::msgcat::mcset pb_msg_traditional_chinese "MC(block,prefix_popup,edit,Label)"          "編輯字首文字"
::msgcat::mcset pb_msg_traditional_chinese "MC(block,prefix,Label)"                     "字首"
::msgcat::mcset pb_msg_traditional_chinese "MC(block,suppress_popup,Label)"             "抑制序號"
::msgcat::mcset pb_msg_traditional_chinese "MC(block,custom_func,Label)"                "自訂巨集"
::msgcat::mcset pb_msg_traditional_chinese "MC(seq,combo,macro,Label)"                  "自訂巨集"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,tab,Label)"                         "巨集"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,exp,msg)"                           "巨集參數的運算式不應為空。"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,edit,name,Label)"                   "巨集名稱"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,disp_name,Label)"                   "輸出名稱"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,param_list,Label)"                  "參數清單"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,separator,Label)"                   "分隔符號"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,start,Label)"                       "開始字元"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,end,Label)"                         "結束字元"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,output,name,Label)"                 "輸出屬性"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,output,check,Label)"                "輸出參數的名稱"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,output,link,Label)"                 "連結字元"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,col_param,Label)"                   "參數"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,col_exp,Label)"                     "運算式"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,popup,insert,Label)"                "新建"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,name,err_msg)"                      "巨集名稱不應包含空格！"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,name,blank_err)"                    "巨集名稱不應為空！"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,name,contain_err)"                  "巨集名稱應只包含字母、數字和底線字元！"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,tree_node,start_err)"               "節點名稱必須以大寫字母開頭！"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,tree_node,contain_err)"             "節點名稱應只接受字母、數字或底線字元！"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,help,Label)"                        "資訊"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,help,Context)"                      "顯示物件的資訊。"
::msgcat::mcset pb_msg_traditional_chinese "MC(func,help,MSG_NO_INFO)"                  "沒有為此巨集提供任何資訊。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(main,options,advisor,Context)"       "啟用/停用後處理顧問。"
...
## Utilities
##
::msgcat::mcset pb_msg_traditional_chinese "MC(main,utils,Label)"                   "公用程式"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(main,help,bal,Label)"                "符號標註提示"
::msgcat::mcset pb_msg_traditional_chinese "MC(main,help,bal,Balloon)"              "圖示上的符號標註提示"
::msgcat::mcset pb_msg_traditional_chinese "MC(main,help,bal,Context)"              "啟用/停用圖示上的符號標註工具提示顯示。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(main,help,what,Label)"               "執行什麼動作？"
::msgcat::mcset pb_msg_traditional_chinese "MC(main,help,what,Balloon)"             "此處您能執行什麼動作？"
::msgcat::mcset pb_msg_traditional_chinese "MC(main,help,what,Context)"             "此處您能執行什麼動作？"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(tool,bal,Label)"                     "符號標註提示"
::msgcat::mcset pb_msg_traditional_chinese "MC(tool,bal,Context)"                   "啟用/停用圖示上的符號標註工具提示顯示。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(tool,what,Label)"                    "執行什麼動作？"
::msgcat::mcset pb_msg_traditional_chinese "MC(tool,what,Context)"                  "此處您能執行什麼動作？"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(msg,no_license_title)"               "NX/後處理建構器無授權使用"
::msgcat::mcset pb_msg_traditional_chinese "MC(msg,no_license_dialog)"              "您被允許在不具備適當授權的\n情況下使用 NX/後處理建構器。\n但您不能儲存隨後的作業。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(msg,dir_perm)"                       "您不具備此目錄的寫許可權："
...
::msgcat::mcset pb_msg_traditional_chinese "MC(msg,cdl_info)"                       "選定後處理的 CDL 和定義檔案將在該後處理的定義檔案中被參考（包含）。\n 選定後處理的 Tcl 檔案還將在執行階段被事件處理常式檔案參考。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(nav_button,apply,Context)"           "此按鈕允許您儲存變更而不取消目前對話方塊。此作業還會重新建立目前對話方塊的初始狀態。\n \n（如果需要初始狀態，請參考「還原)"
::msgcat::mcset pb_msg_traditional_chinese "MC(nav_button,filter,Label)"            "篩選器"
::msgcat::mcset pb_msg_traditional_chinese "MC(nav_button,filter,Context)"          "此按鈕將套用目錄篩選器並列出滿足條件的檔案。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(nav_button,refresh,Label)"           "重新整理"
::msgcat::mcset pb_msg_traditional_chinese "MC(nav_button,refresh,Context)"         "此按鈕將根據物件的存在情況重新整理清單。"

::msgcat::mcset pb_msg_traditional_chinese "MC(nav_button,cut,Label)"               "剪下"
::msgcat::mcset pb_msg_traditional_chinese "MC(nav_button,cut,Context)"             "此按鈕將從清單中剪下選定的物件。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(nav_button,paste,Label)"             "貼上"
::msgcat::mcset pb_msg_traditional_chinese "MC(nav_button,paste,Context)"           "此按鈕將緩衝區的物件貼上回清單。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(new,punch,desc,Label)"               "這是沖壓機床。"

::msgcat::mcset pb_msg_traditional_chinese "MC(new,post_unit,Label)"                "後處理輸出單位"

::msgcat::mcset pb_msg_traditional_chinese "MC(new,inch,Label)"                     "英寸"
::msgcat::mcset pb_msg_traditional_chinese "MC(new,inch,Context)"                   "後處理器輸出單位英寸"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(new,punch,Label)"                    "沖壓"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(inposts,title,Label)"                "編輯 template_post.dat"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(tree,cut,Label)"                     "剪下"
::msgcat::mcset pb_msg_traditional_chinese "MC(tree,cut,Context)"                   "剪下元件。"
::msgcat::mcset pb_msg_traditional_chinese "MC(tree,paste,Label)"                   "貼上"
::msgcat::mcset pb_msg_traditional_chinese "MC(tree,paste,Context)"                 "貼上元件。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,step_size,Label)"            "線性運動解析度"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,step_size,min,Label)"        "最小值"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,step_size,min,Context)"      "最小解析度"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,circle_record,Label)"        "輸出迴圈記錄"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,circle_record,yes,Label)"    "是"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,circle_record,yes,Context)"  "輸出迴圈記錄。"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,circle_record,no,Label)"     "否"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,circle_record,no,Context)"   "輸出線性記錄。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,axis_multi,2i,Context)"      "此開關允許您在使用直徑程式設計時將迴圈記錄的 I 值翻倍。"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,axis_multi,2j,Label)"        "2J"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,axis_multi,2j,Context)"      "此開關允許您在使用直徑程式設計時將迴圈記錄的 J 值翻倍。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,axis_multi,i,Context)"       "此開關允許您使 N/C 輸出中的迴圈記錄 I 值為負。"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,axis_multi,j,Label)"         "-J"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,axis_multi,j,Context)"       "此開關允許您使 N/C 輸出中的迴圈記錄 J 值為負。"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,axis_multi,k,Label)"         "-K"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,axis_multi,k,Context)"       "此開關允許您使 N/C 輸出中的迴圈記錄 K 值為負。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,lathe_post,select_name,Context)" "選取要用於簡單車銑後處理的車後處理的名稱。很可能會在 NX/Post 執行階段的 \\\$UGII_CAM_POST_DIR 目錄中找到此後處理，否則將使用在銑後處理所在目錄中同名的後處理。"

::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,coord_mode,Label)"               "預設座標模式"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,coord_mode,Context)"             "此選項將座標輸出模式的初始設定定義為極座標 (XZC) 或笛卡爾座標 (XYZ)。此模式可以通過作業由 \\\"SET/POLAR,ON\\\" UDE 的程式變更。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,coord_mode,cart,Label)"          "笛卡爾座標系"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,coord_mode,cart,Context)"        "XYZ 中的座標輸出。"

::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,xzc_arc_mode,Label)"             "迴圈記錄模式"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,xzc_arc_mode,Context)"           "此選項定義將採用極座標 (XCR) 或笛卡爾座標 (XYIJ) 模式。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,gen,xzc_arc_mode,cart,Label)"        "笛卡爾座標系"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,axis,con_motion,combine,Context)"    "此開關允許您啟用/停用線性化。它將啟用/停用公差選項。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,axis,rotary_res,Label)"          "旋轉運動解析度（度）"
::msgcat::mcset pb_msg_traditional_chinese "MC(machine,axis,rotary_res,Context)"        "指定旋轉運動解析度（度）。"
...
## Program
##
::msgcat::mcset pb_msg_traditional_chinese "MC(prog,tab,Label)"                     "編程"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(prog,tree,Context)"                  "N/C 程式被分為五個部分：四 (4) 個序列和刀軌本體：\n \n * 程式起始序列\n * 工序起始序列\n * 刀軌\n * 工序結束序列\n * 程式結束序列\n  \n每個序列包含一係列的標記。每個標記代表可以程式設計且可能在 N/C 程式某個特定階段出現的事件。您可以附加每個帶特定 N/C 代碼的標記為後處理該程式時的輸出。\n \n 刀軌由大量事件組成，分為三 (3) 個群組：\n \n * 機床控制\n * 運動\n * 迴圈 \n"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(prog,tree,oper_strt,Label)"          "工序起始序列"
::msgcat::mcset pb_msg_traditional_chinese "MC(prog,tree,oper_end,Label)"           "工序結束序列"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(prog,tree,tool_path,cycle,Label)"    "現成迴圈"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(prog,add,Context)"                   "您可以通過按下此按鈕並將其拖曳到所需的標記，新增塊到序列中。還可以將塊附加到現有塊的旁邊、上邊或下邊。"

::msgcat::mcset pb_msg_traditional_chinese "MC(prog,trash,Label)"                   "序列 -- 垃圾桶"
::msgcat::mcset pb_msg_traditional_chinese "MC(prog,trash,Context)"                 "您可以通過將其拖曳到垃圾桶，處理序列中不想要的塊。"

::msgcat::mcset pb_msg_traditional_chinese "MC(prog,block,Label)"                   "序列 -- 塊"
::msgcat::mcset pb_msg_traditional_chinese "MC(prog,block,Context)"                 "您可以通過將其拖曳到垃圾桶，刪除序列中不想要的塊。\n \n您還可以通過按下滑鼠右鍵啟動彈出式功能表。該功能表上有幾項服務可用：\n \n * 編輯\n * 強制輸出\n * 剪下\n * 複製為\n * 貼上\n * 刪除 \n"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(seq,cut_popup,Label)"                "剪下"
::msgcat::mcset pb_msg_traditional_chinese "MC(seq,copy_popup,Label)"               "複製為"
::msgcat::mcset pb_msg_traditional_chinese "MC(seq,copy_popup,ref,Label)"           "參考的塊"
::msgcat::mcset pb_msg_traditional_chinese "MC(seq,copy_popup,new,Label)"           "新塊"
::msgcat::mcset pb_msg_traditional_chinese "MC(seq,paste_popup,Label)"              "貼上"
...
##
::msgcat::mcset pb_msg_traditional_chinese "MC(event,feed,IPM_mode)"                "IPM（英寸/分）模式"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(cust_cmd,name,Context)"              "您在此處輸入的名稱將被加上字首 PB_CMD_ 以成為實際的指令名。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(cust_cmd,import,tree,Context)"       "此清單包含您指定匯入的檔案中存在的自訂指令步驟和 Tcl 步驟。您可以通過點擊滑鼠左鍵選取清單上的項，以預覽各步驟中的內容。已經存在於進行中的後處理的步驟標有 <exists> 指示符。在某一項上雙擊滑鼠左鍵將切換該項旁邊的核取方塊。此作業允許您選取或取消選取要匯入的步驟。預設情況下，所有步驟都被選中匯入。您可以取消選取某一項以避免覆寫現有的步驟。"

::msgcat::mcset pb_msg_traditional_chinese "MC(cust_cmd,export,tree,Label)"         "匯出自訂指令"
::msgcat::mcset pb_msg_traditional_chinese "MC(cust_cmd,export,tree,Context)"       "此清單包含存在於進行中的後處理的自訂指令步驟和 Tcl 步驟。您可以通過點擊滑鼠左鍵選取清單上的項，以預覽各步驟中的內容。在某一項上雙擊滑鼠左鍵將切換該項旁邊的核取方塊。此作業僅允許您選取要匯出的步驟。"

::msgcat::mcset pb_msg_traditional_chinese "MC(cust_cmd,error,title)"               "自訂指令錯誤"
::msgcat::mcset pb_msg_traditional_chinese "MC(cust_cmd,error,msg)"                 "通過設定主功能表項\"選項 -> 驗證自訂指令\"的下拉開關，可以啟用或停用自訂指令的驗證。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(cust_cmd,referenced,msg)"            "在自訂指令中參考 "
...
::msgcat::mcset pb_msg_traditional_chinese "MC(link_post,head,Context)"             "複雜機床可以多種加工模式使用多組運動學執行加工作業。每組運動學可以作為 NX/Post 的獨立機頭。需要用特定機頭執行的加工作業將作為一個群組放在機床或加工方法視圖中。\\\"機頭\\\" UDE 隨後將被指派到該群組，以指定此機頭的名稱。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(link_post,select_name,Context)"      "選取要指派給機頭的後處理名稱。很可能會在 NX/Post 執行階段在主後處理所在的目錄中找到該後處理，否則將使用 \\\$UGII_CAM_POST_DIR 目錄中同名的後處理。"

::msgcat::mcset pb_msg_traditional_chinese "MC(link_post,start_of_head,Label)"      "機頭開始"
::msgcat::mcset pb_msg_traditional_chinese "MC(link_post,start_of_head,Context)"    "指定機頭開始要執行的 N/C 代碼或動作。"

::msgcat::mcset pb_msg_traditional_chinese "MC(link_post,end_of_head,Label)"        "機頭結束"
::msgcat::mcset pb_msg_traditional_chinese "MC(link_post,end_of_head,Context)"      "指定機頭結束要執行的 N/C 代碼或動作。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(block,add,Context)"                  "您可以通過按下此按鈕並將其拖曳到以下視窗顯示的塊中，新增文字到塊中。即將建立的文字類型從該按鈕右側的清單方塊中選取。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(block,trash,Context)"                "您可以通過將其拖曳到垃圾桶，處理不想要的文字。"

::msgcat::mcset pb_msg_traditional_chinese "MC(block,word,Label)"                   "塊 -- 文字"
::msgcat::mcset pb_msg_traditional_chinese "MC(block,word,Context)"                 "您可以通過將其拖曳到垃圾桶，刪除不想要的文字。\n \n您還可以通過按下滑鼠右鍵啟動彈出式功能表。該功能表上有幾項服務可用：\n \n * 編輯\n * 變更單元 ->\n * 可選\n * 無文字分隔符號\n * 強制輸出\n * 刪除 \n"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(block,text,word_desc,Label)"         "文字字串"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(address,rapid1,desc)"                "沿縱向軸快速定位"
::msgcat::mcset pb_msg_traditional_chinese "MC(address,rapid2,desc)"                "沿橫向軸快速定位"
::msgcat::mcset pb_msg_traditional_chinese "MC(address,rapid3,desc)"                "沿主軸快速定位"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(format,data,num,lead,Label)"         "輸出前置零"
::msgcat::mcset pb_msg_traditional_chinese "MC(format,data,num,lead,Context)"       "此選項啟用附加到 N/C 代碼數字中的前置零。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(format,data,text,Context)"           "此選項將格式的資料類型定義為文字字串。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(format,data,dec_zero,msg)"           "必須至少選中一個小數點、前置零或後置零選項。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(other,seq_num,Context)"              "此開關允許您啟用/停用 N/C 代碼中的序列號輸出。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(other,g_codes,Context)"              "此開關允許您啟用/停用每個 N/C 輸出塊的 G 代碼數控制。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(other,m_codes,Context)"              "此開關允許您啟用/停用每個 N/C 輸出塊的 M 代碼數控制。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(other,opt_text,Label)"               "文字字串"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(other,ude_file,Context)"             "要在此後處理的定義檔案中參考（包括）的 CDL 檔案的路徑和檔名。路徑名必須以 UG 環境變數 (\\\$UGII) 開始，或者無路徑。如果未指定路徑，則由 UG/NX 在執行階段使用 UGII_CAM_FILE_SEARCH_PATH 定位檔案。"
::msgcat::mcset pb_msg_traditional_chinese "MC(other,ude_select,Label)"             "選取名稱"
::msgcat::mcset pb_msg_traditional_chinese "MC(other,ude_select,Context)"           "要在此後處理的定義檔案中參考（包括）的 CDL 檔案。預設情況下，選中的檔名字首為 \\\$UGII_CAM_USER_DEF_EVENT_DIR/。您可以在選中後根據需要編輯路徑名。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(output,vnc,mode,sub,Label)"          "從屬"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(output,vnc,main,Context)"            "從屬 VNC 參考的主 VNC 名稱。假設在 ISV 執行階段，此後處理將存在於從屬 VNC 所在的目錄，否則將使用 \\\$UGII_CAM_POST_DIR 目錄中名稱相同的後處理。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(output,vnc,main,select_name,Context)"     "選取從屬 VNC 參考的 VNC 名稱。假設在 ISV 執行階段，此後處理將存在於從屬 VNC 所在的目錄，否則將使用 \\\$UGII_CAM_POST_DIR 目錄中名稱相同的後處理。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(output,vnc,mode,sub,Context)"             "從屬 VNC 在很大程度上依賴主 VNC。它將在 ISV 執行階段參考主 VNC。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,gen,Context)"                "此開關允許您啟用/停用清單檔案的輸出。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,parms,x,Context)"            "此開關允許您啟用/停用 X 座標到清單檔案的輸出。"

::msgcat::mcset pb_msg_traditional_chinese "MC(listing,parms,y,Label)"              "Y 座標"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,parms,y,Context)"            "此開關允許您啟用/停用 Y 座標到清單檔案的輸出。"

::msgcat::mcset pb_msg_traditional_chinese "MC(listing,parms,z,Label)"              "Z 座標"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,parms,z,Context)"            "此開關允許您啟用/停用 Z 座標到清單檔案的輸出。"

::msgcat::mcset pb_msg_traditional_chinese "MC(listing,parms,4,Label)"              "第 4 軸角度"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,parms,4,Context)"            "此開關允許您啟用/停用第 4 軸角度到清單檔案的輸出。"

::msgcat::mcset pb_msg_traditional_chinese "MC(listing,parms,5,Label)"              "第 5 軸角度"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,parms,5,Context)"            "此開關允許您啟用/停用第 5 軸角度到清單檔案的輸出。"

::msgcat::mcset pb_msg_traditional_chinese "MC(listing,parms,feed,Label)"           "進給"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,parms,feed,Context)"         "此開關允許您啟用/停用進給率到清單檔案的輸出。"

::msgcat::mcset pb_msg_traditional_chinese "MC(listing,parms,speed,Label)"          "速度"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,parms,speed,Context)"        "此開關允許您啟用/停用主軸速度到清單檔案的輸出。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,format,print_header,Label)"      "列印頁首"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,format,print_header,Context)"    "此開關允許您啟用/停用頁首到清單檔案的輸出。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,output,warning,Context)"     "此開關允許您在後處理過程中啟用/停用警告訊息的輸出。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,output,group,Context)"       "此開關允許您在後處理過程中啟用/停用群組輸出的控制。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,user_tcl,check,Context)"     "此開關允許您參考自己的 Tcl 檔案"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,user_tcl,name,Label)"        "檔名"
::msgcat::mcset pb_msg_traditional_chinese "MC(listing,user_tcl,name,Context)"      "指定您想要為該後處理參考的 Tcl 檔名"
...
# Balloon
#+++++++++++++
::msgcat::mcset pb_msg_traditional_chinese "MC(msg,odd)"                            "可選引數的奇數計數"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(event,length_compn,len_off)"         "長度補償寄存器"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(event,spindle_css,g_code,const)"     "恆定表面代碼"
...
### Inch Metric Mode
::msgcat::mcset pb_msg_traditional_chinese "MC(event,inch_metric_mode,name)"            "英寸公制模式"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,inch_metric_mode,g_code)"          "G 代碼"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,inch_metric_mode,g_code,english)"  "英制（英寸）"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(event,feedrates,cycle_mode)"         "迴圈進給率模式"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,feedrates,cycle)"              "迴圈"
...
### Option Stop
::msgcat::mcset pb_msg_traditional_chinese "MC(event,opstop,name)"                  "選擇性停刀"
...
### Stop
::msgcat::mcset pb_msg_traditional_chinese "MC(event,stop,name)"                    "停刀"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(event,linear,assume)"                "最大移刀速度時設為快速模式"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(event,circular,record)"              "迴圈記錄"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(event,lathe,cons)"                   "恆定"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(event,cycle,customize,Context)"      "此開關允許您自訂一個迴圈。\n\n預設情況下，每個迴圈的基本建構由「公共參數」的設定定義。每個迴圈中的這些常用單元修改受限。\n\n開啟此開關允許您獲得對迴圈組態的完全控制。對「公共參數」所作的變更將不再影響自訂的迴圈。"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,cycle,start,Label)"            "迴圈開始"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,cycle,start,Context)"          "可以開啟此選項，用於在定義迴圈 (G81...) 之後使用迴圈開始塊 (G79...) 執行迴圈的機床。"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,cycle,start,text)"             "使用迴圈開始塊執行迴圈"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,cycle,rapid_to)"               "快速- 至"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,cycle,retract_to)"             "退刀 - 至"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,cycle,plane_control)"          "迴圈平面控制"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,cycle,com_param,name)"         "公共參數"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,cycle,cycle_off,name)"         "迴圈關閉"
::msgcat::mcset pb_msg_traditional_chinese "MC(event,cycle,plane_chng,name)"        "迴圈平面變更"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(g_code,cycle_start,name)"            "迴圈開始代碼"
::msgcat::mcset pb_msg_traditional_chinese "MC(g_code,cycle_off,name)"              "迴圈關閉"
::msgcat::mcset pb_msg_traditional_chinese "MC(g_code,cycle_drill,name)"            "迴圈鑽"
::msgcat::mcset pb_msg_traditional_chinese "MC(g_code,cycle_drill_dwell,name)"      "迴圈鑽延時"
::msgcat::mcset pb_msg_traditional_chinese "MC(g_code,cycle_drill_deep,name)"       "迴圈深鑽"
::msgcat::mcset pb_msg_traditional_chinese "MC(g_code,cycle_drill_bc,name)"         "迴圈鑽斷屑"
::msgcat::mcset pb_msg_traditional_chinese "MC(g_code,tap,name)"                    "迴圈攻絲"
::msgcat::mcset pb_msg_traditional_chinese "MC(g_code,bore,name)"                   "迴圈鏜"
::msgcat::mcset pb_msg_traditional_chinese "MC(g_code,bore_drag,name)"              "迴圈鏜，快退"
::msgcat::mcset pb_msg_traditional_chinese "MC(g_code,bore_no_drag,name)"           "迴圈鏜，橫向偏置後快退"
::msgcat::mcset pb_msg_traditional_chinese "MC(g_code,bore_dwell,name)"             "迴圈鏜延時"
::msgcat::mcset pb_msg_traditional_chinese "MC(g_code,bore_manual,name)"            "迴圈手動鏜"
::msgcat::mcset pb_msg_traditional_chinese "MC(g_code,bore_back,name)"              "迴圈背鏜"
::msgcat::mcset pb_msg_traditional_chinese "MC(g_code,bore_manual_dwell,name)"      "迴圈手動鏜延時"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(g_code,cycle_retract_auto,name)"     "迴圈退刀（自動）"
::msgcat::mcset pb_msg_traditional_chinese "MC(g_code,cycle_retract_manual,name)"   "迴圈退刀（手動）"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(g_code,cons_thread,name)"            "恆定螺紋"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(m_code,opt_stop,name)"               "選擇性停刀"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(m_code,lathe_thread,type1)"          "恆定螺紋"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,TITLE)"                   "使用者定義事件"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,int,Context)"             "通過將其拖曳到右側清單以新增整數參數。"

::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,real,Label)"              "實數"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,real,Context)"            "通過將其拖曳到右側清單以新增實數參數。"

::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,txt,Label)"               "文字"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,txt,Context)"             "通過將其拖曳到右側清單以新增字串參數。"

::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,bln,Label)"               "布林"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,bln,Context)"             "通過將其拖曳到右側清單以新增布林參數。"

::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,opt,Label)"               "選項"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,opt,Context)"             "通過將其拖曳到右側清單以新增選項參數。"

::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,pnt,Label)"               "點"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,pnt,Context)"             "通過將其拖曳到右側清單以新增點參數。"

::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,trash,Label)"             "編輯器 -- 垃圾桶"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,trash,Context)"           "您可以通過將其拖曳到垃圾桶，處理右側清單中不想要的參數。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,paramdlg,CUT,Label)"      "剪下"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,paramdlg,PASTE,Label)"    "貼上"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,paramdlg,ADD,Context)"    "新增項"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,paramdlg,CUT,Context)"    "剪下項"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,paramdlg,PASTE,Context)"  "貼上項"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,prev,udc,Label)"                 "使用者定義迴圈"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,prev,sys,Label)"                 "系統迴圈"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,prev,nsys,Label)"                "非系統迴圈"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,editor,opt,MSG_PST_SAME)"        "您貼上的選項已經存在！"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,import,sel,Context)"             "選取所需後處理的 PUI 檔案。建議將所有與正在繼承的後處理相關的檔案（PUI、Def、Tcl 和 CDL）放置在相同的目錄（資料夾）中，供執行階段使用。"

::msgcat::mcset pb_msg_traditional_chinese "MC(ude,import,name_cdl,Label)"          "CDL 檔名"

::msgcat::mcset pb_msg_traditional_chinese "MC(ude,import,name_cdl,Context)"        "要在此後處理的定義檔案中參考（包括）的與選定後處理相關的 CDL 檔案的路徑和檔名。路徑名必須以 UG 環境變數 (\\\$UGII) 開始，或者無路徑。如果未指定路徑，則由 UG/NX 在執行階段使用 UGII_CAM_FILE_SEARCH_PATH 定位檔案。"

::msgcat::mcset pb_msg_traditional_chinese "MC(ude,import,name_def,Label)"          "Def 檔名"
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,import,name_def,Context)"        "要在此後處理的定義檔案中參考（包括）的選定後處理的定義檔案路徑和檔名。路徑名必須以 UG 環境變數 (\\\$UGII) 開始，或者無路徑。如果未指定路徑，則由 UG/NX 在執行階段使用 UGII_CAM_FILE_SEARCH_PATH 定位檔案。"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(ude,import,own_ent,Context)"         "要在此後處理的定義檔案中參考（包括）的與該後處理相關的 CDL 檔案的路徑和檔名。實際檔名將在儲存此後處理時決定。路徑名必須以 UG 環境變數 (\\\$UGII) 開始，或者無路徑。如果未指定路徑，則由 UG/NX 在執行階段使用 UGII_CAM_FILE_SEARCH_PATH 定位檔案。"
...
## UDC
##
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,TITLE)"                   "使用者定義迴圈"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,CREATE)"                  "建立使用者定義的迴圈"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,TYPE)"                    "迴圈類型"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,type,UDC)"                "使用者定義"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,type,SYSUDC)"             "系統定義的"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,CYCLBL,Label)"            "迴圈標籤"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,CYCNAME,Label)"           "迴圈名稱"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,CYCLBL,Context)"          "指定迴圈標籤"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,CYCNAME,Context)"         "指定迴圈名稱"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,CYCLBL,C,Label)"          "迴圈標籤"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,CYCLBL,C,Context)"        "此開關允許您設定迴圈標籤"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,popup,EDIT)"              "編輯使用者定義參數..."
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,popup,MSG_BLANK)"         "迴圈名稱不能為空！"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,popup,MSG_SAMENAME)"      "迴圈名稱已經存在！"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,popup,MSG_SameHandler)"   "事件處理常式已經存在！\n  請修改迴圈事件名稱！"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,popup,MSG_ISSYSCYC)"      "迴圈名稱屬於系統迴圈類型！"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,popup,MSG_SYSCYC_EXIST)"  "此類系統迴圈已經存在！"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,EDIT)"                    "編輯迴圈事件"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,popup,CREATE)"            "新建使用者定義的迴圈..."
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,editor,popup,IMPORT)"            "匯入使用者定義的迴圈..."
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,drill,csink,INFO)"               "此事件與鑽共用處理常式！"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,drill,simulate,INFO)"            "這是一個模擬的迴圈事件。"
::msgcat::mcset pb_msg_traditional_chinese "MC(udc,drill,dwell,INFO)"               "此事件與以下選項共用使用者定義的迴圈： "
...
::msgcat::mcset pb_msg_traditional_chinese "MC(isv,setup,cycle,Label)"              "迴圈"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(isv,vnc_message,Context)"            "如果選中此選項，則模擬過程中將在作業訊息視窗顯示所有 VNC 排錯訊息。"

::msgcat::mcset pb_msg_traditional_chinese "MC(isv,vnc_mes,prefix,Label)"           "訊息字首"
::msgcat::mcset pb_msg_traditional_chinese "MC(isv,spec_desc,Label)"                "敘述"
::msgcat::mcset pb_msg_traditional_chinese "MC(isv,spec_codelist,Label)"            "程式碼清單"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(isv,tool_info,cutcom_reg,Label)"     "     刀具補償     "
...
::msgcat::mcset pb_msg_traditional_chinese "MC(isv,tool_info,add_tool,Context)"     "新增刀具，指定其參數"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(isv,g_code,frame,Context)"           "指定模擬中使用的特殊 G 代碼"
::msgcat::mcset pb_msg_traditional_chinese "MC(isv,g_code,from_home,Label)"         "自零"
::msgcat::mcset pb_msg_traditional_chinese "MC(isv,g_code,return_home,Label)"       "回零 Pn"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(isv,spec_command,add_sim,Label)"     "在游標處新增 SIM 指令"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(pb_msg_english)"                     "英文"
::msgcat::mcset pb_msg_traditional_chinese "MC(pb_msg_french)"                      "法文"
::msgcat::mcset pb_msg_traditional_chinese "MC(pb_msg_german)"                      "德文"
::msgcat::mcset pb_msg_traditional_chinese "MC(pb_msg_italian)"                     "義大利文"
::msgcat::mcset pb_msg_traditional_chinese "MC(pb_msg_japanese)"                    "日文"
::msgcat::mcset pb_msg_traditional_chinese "MC(pb_msg_korean)"                      "韓文"
::msgcat::mcset pb_msg_traditional_chinese "MC(pb_msg_russian)"                     "俄文"
::msgcat::mcset pb_msg_traditional_chinese "MC(pb_msg_simple_chinese)"              "中文（簡體）"
::msgcat::mcset pb_msg_traditional_chinese "MC(pb_msg_spanish)"                     "西班牙文"
...
::msgcat::mcset pb_msg_traditional_chinese "MC(optionMenu,item,Rapid)"       "快速"
::msgcat::mcset pb_msg_traditional_chinese "MC(optionMenu,item,RS)"          "快速主軸"
::msgcat::mcset pb_msg_traditional_chinese "MC(optionMenu,item,C_off_RS)"    "「迴圈關」，然後「快速主軸」"
