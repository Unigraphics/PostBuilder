...
::msgcat::mcset pb_msg_japanese "MC(event,cycle,plane_change,label)"   "作業平面が下位になったときにこのイベントをトリガ"
...
::msgcat::mcset pb_msg_japanese "MC(new,mill_5HH,desc,Label)"            "デュアル回転テーブルのある\n5軸ミル加工機械です。"
