...
::msgcat::mcset pb_msg_japanese "MC(main,options,cmd_check,Label)"       "カスタムコマンドを検証"
::msgcat::mcset pb_msg_japanese "MC(main,options,cmd_check,Balloon)"     "カスタムコマンドを検証"
...
::msgcat::mcset pb_msg_japanese "MC(main,options,backup,Label)"          "ポストをバックアップ"
...
::msgcat::mcset pb_msg_japanese "MC(main,utils,etpdf,Label)"             "テンプレートポストデータファイルを編集"

::msgcat::mcset pb_msg_japanese "MC(main,utils,bmv,Label)"               "MOM変数をブラウズ"
...
::msgcat::mcset pb_msg_japanese "MC(main,help,Balloon)"                  "ヘルプオプション"
...
::msgcat::mcset pb_msg_japanese "MC(main,help,chelp,Label)"              "コンテキスト識別ヘルプ"
::msgcat::mcset pb_msg_japanese "MC(main,help,chelp,Balloon)"            "ダイアログアイテムのコンテキスト識別ヘルプ"
::msgcat::mcset pb_msg_japanese "MC(main,help,chelp,Context)"            "ダイアログアイテムのコンテキスト識別ヘルプ"

::msgcat::mcset pb_msg_japanese "MC(main,help,what,Label)"               "作業内容"
::msgcat::mcset pb_msg_japanese "MC(main,help,what,Balloon)"             "ここで実行可能な内容"
...
::msgcat::mcset pb_msg_japanese "MC(main,help,dialog,Balloon)"           "このダイアログのヘルプ"
::msgcat::mcset pb_msg_japanese "MC(main,help,dialog,Context)"           "このダイアログのヘルプ"

::msgcat::mcset pb_msg_japanese "MC(main,help,manual,Label)"             "ユーザーズマニュアル"
::msgcat::mcset pb_msg_japanese "MC(main,help,manual,Balloon)"           "ユーザーズヘルプマニュアル"
...
::msgcat::mcset pb_msg_japanese "MC(main,help,tcl_man,Label)"            "Tcl/Tk 参照マニュアル"
::msgcat::mcset pb_msg_japanese "MC(main,help,tcl_man,Balloon)"          "Tcl/Tk 参照マニュアル"
::msgcat::mcset pb_msg_japanese "MC(main,help,tcl_man,Context)"          "Tcl/Tk 参照マニュアル"
...
::msgcat::mcset pb_msg_japanese "MC(tool,chelp,Label)"                   "コンテキスト識別ヘルプ"
::msgcat::mcset pb_msg_japanese "MC(tool,chelp,Context)"                 "ダイアログアイテムのコンテキスト識別ヘルプ"
...
::msgcat::mcset pb_msg_japanese "MC(msg,no_license_title)"               "UG/Post Builderライセンスなしでの使用"
::msgcat::mcset pb_msg_japanese "MC(msg,no_license_dialog)"              "適切なライセンスなしでUG/Post Builderの使用\nを許可されています。しかしながら、後で作業を\n保存することはできません。"
...
::msgcat::mcset pb_msg_japanese "MC(msg,set_ext_editor)"                 "環境変数EDITORを使用して、好きなテキストエディタをアクティブ化できます。"
...
::msgcat::mcset pb_msg_japanese "MC(msg,not_own_cdl_file)"               "自身のCDLファイルのみ許可されます!"
...
::msgcat::mcset pb_msg_japanese "MC(nav_button,yes,Label)"               "はい"
::msgcat::mcset pb_msg_japanese "MC(nav_button,yes,Context)"             "はい"
::msgcat::mcset pb_msg_japanese "MC(nav_button,no,Label)"                "いいえ"
::msgcat::mcset pb_msg_japanese "MC(nav_button,no,Context)"              "いいえ"
...
## New dialog
##
::msgcat::mcset pb_msg_japanese "MC(new,title,Label)"                    "新規ポストプロセッサを作成"
...
::msgcat::mcset pb_msg_japanese "MC(new,mill,desc,Label)"                "これはミル加工機械です。"
::msgcat::mcset pb_msg_japanese "MC(new,lathe,desc,Label)"               "これは旋盤機械です。"
::msgcat::mcset pb_msg_japanese "MC(new,wedm,desc,Label)"                "これはワイヤEDM機械です。"

::msgcat::mcset pb_msg_japanese "MC(new,wedm_2,desc,Label)"              "これは2軸ワイヤEDM機械です。"
::msgcat::mcset pb_msg_japanese "MC(new,wedm_4,desc,Label)"              "これは4軸ワイヤEDM機械です。"
::msgcat::mcset pb_msg_japanese "MC(new,lathe_2,desc,Label)"             "これは2軸横旋盤機械です。"
::msgcat::mcset pb_msg_japanese "MC(new,lathe_4,desc,Label)"             "これは4軸従属旋盤機械です。"
::msgcat::mcset pb_msg_japanese "MC(new,mill_3,desc,Label)"              "これは3軸ミル加工機械です。"
::msgcat::mcset pb_msg_japanese "MC(new,mill_3MT,desc,Label)"            "3軸ミルターン(XZC)"
::msgcat::mcset pb_msg_japanese "MC(new,mill_4H,desc,Label)"             "これは回転ヘッドのある4軸ミル加工\n機械です。"
::msgcat::mcset pb_msg_japanese "MC(new,mill_4T,desc,Label)"             "これは回転テーブルのある4軸ミル加工\n機械です。"
::msgcat::mcset pb_msg_japanese "MC(new,mill_5TT,desc,Label)"            "これはデュアル回転テーブルのある\n5軸ミル加工機械です。"
::msgcat::mcset pb_msg_japanese "MC(new,mill_5HH,desc,Label)"            "これはデュアル回転テーブルのある\n5軸ミル加工機械です。"
::msgcat::mcset pb_msg_japanese "MC(new,mill_5HT,desc,Label)"            "これは回転ヘッドおよびテーブルのある\n5軸ミル加工機械です。"
::msgcat::mcset pb_msg_japanese "MC(new,punch,desc,Label)"               "これはパンチ機械です。"
...
::msgcat::mcset pb_msg_japanese "MC(new,user,Label)"                     "ユーザーズ"
...
::msgcat::mcset pb_msg_japanese "MC(open,Status)"                        "開くPUIファイルを選択します。"
...
::msgcat::mcset pb_msg_japanese "MC(mvb,posv,Label)"                     "可能な値"
::msgcat::mcset pb_msg_japanese "MC(mvb,data,Label)"                     "データタイプ"
::msgcat::mcset pb_msg_japanese "MC(mvb,desc,Label)"                     "説明"

::msgcat::mcset pb_msg_japanese "MC(inposts,title,Label)"                "ポストをインストール"
::msgcat::mcset pb_msg_japanese "MC(tpdf,text,Label)"                    "テンプレートポストデータファイル"
::msgcat::mcset pb_msg_japanese "MC(inposts,edit,title,Label)"           "行を編集"
...
::msgcat::mcset pb_msg_japanese "MC(save_as,Status)"                     "新規ポストファイル名を入力します。"
...
::msgcat::mcset pb_msg_japanese "MC(msg,no_display)"                     "この工作機械構成のイメージは使用できません。"
...
::msgcat::mcset pb_msg_japanese "MC(machine,gen,out_unit,metric,Label)"      "メートル法"

::msgcat::mcset pb_msg_japanese "MC(machine,gen,travel_limit,Label)"         "直線軸移動制限"
::msgcat::mcset pb_msg_japanese "MC(machine,gen,travel_limit,Context)"       "直線軸移動制限"
...
::msgcat::mcset pb_msg_japanese "MC(machine,gen,step_size,Label)"            "直線モーションのレゾリューション"
...
::msgcat::mcset pb_msg_japanese "MC(machine,gen,circle_record,Label)"        "円形レコードを出力"
::msgcat::mcset pb_msg_japanese "MC(machine,gen,circle_record,yes,Label)"    "はい"
::msgcat::mcset pb_msg_japanese "MC(machine,gen,circle_record,yes,Context)"  "円形レコードを出力します。"
::msgcat::mcset pb_msg_japanese "MC(machine,gen,circle_record,no,Label)"     "いいえ"
::msgcat::mcset pb_msg_japanese "MC(machine,gen,circle_record,no,Context)"   "直線レコードを出力します。"
...
::msgcat::mcset pb_msg_japanese "MC(machine,gen,output,tool_tip,Label)"      "ツールチップ"
::msgcat::mcset pb_msg_japanese "MC(machine,gen,output,tool_tip,Context)"    "ツールチップに相対する出力"
...
::msgcat::mcset pb_msg_japanese "MC(machine,gen,lathe_post,select_name,Context)" "単純ミルターンポストで使用される旋盤ポストの名前を選択します。おそらく、このポストはUG/Postランタイムの\\\$UGII_CAM_POST_DIRディレクトリにあります。そうでない場合は、ミルポストがあるディレクトリにある同じ名前のポストが使用されます。"
...
::msgcat::mcset pb_msg_japanese "MC(machine,axis,con_motion,combine,Context)"    "このスイッチにより、直線化を使用可能/不可にできます。これは公差オプションを使用可能/不可にします。"
...
::msgcat::mcset pb_msg_japanese "MC(machine,axis,incr_text)"                 "この回転軸を増分にできます"
...
::msgcat::mcset pb_msg_japanese "MC(machine,axis,rotary_lintol,Label)"       "デフォルト直線化公差"
::msgcat::mcset pb_msg_japanese "MC(machine,axis,rotary_lintol,Context)"     "この値は、LINTOL/ONポストコマンドが現在または先行するオペレーションで指定されるときに、回転移動を直線化するためのデフォルト公差として使用されます。LINTOL/コマンドはまた、異なる直線化公差を指定できます。"
...
::msgcat::mcset pb_msg_japanese "MC(prog,Status)"                        "イベントの出力を定義"
...
::msgcat::mcset pb_msg_japanese "MC(prog,tree,linked_posts,Label)"       "リンクされたポストシーケンス"
...
::msgcat::mcset pb_msg_japanese "MC(addrsum,col_frac,Label)"             "分数"
...
## Linked Posts
##
::msgcat::mcset pb_msg_japanese "MC(link_post,tab,Label)"                "リンクされたポスト"
::msgcat::mcset pb_msg_japanese "MC(link_post,Status)"                   "リンクされたポストを定義"
...
::msgcat::mcset pb_msg_japanese "MC(link_post,head,Context)"             "複雑な工作機械は、様々な加工モードのキネマティクスの異なるセットを使用して加工オペレーションを実行できます。キネマティクスの各セットは、UG/Postの独立ヘッドとして扱われます。特定のヘッドで実行する必要がある加工オペレーションは、工作機械または加工方法ビューに、1つのグループとして一緒に配置されます。それから、\\\"ヘッド\\\"UDEがグループに割当てられ、このヘッドに対する名前を指定します。"
...
::msgcat::mcset pb_msg_japanese "MC(link_post,link,Label)"               "リンクされたポスト"
...
::msgcat::mcset pb_msg_japanese "MC(link_post,select_name,Context)"      "ヘッドに割当てるポストの名前を選択します。おそらく、このポストはUG/Postランタイムにおいてメインポストのあるディレクトリにあります。そうでない場合は、\\\$UGII_CAM_POST_DIRディレクトリにある同じ名前のポストが使用されます。"
...
::msgcat::mcset pb_msg_japanese "MC(link_post,dlg,title,Label)"          "リンクされたポスト"
...
::msgcat::mcset pb_msg_japanese "MC(block,Status)"                       "ブロックテンプレートを定義"
...
::msgcat::mcset pb_msg_japanese "MC(block,text,word_desc,Label)"         "テキストストリング"
...
::msgcat::mcset pb_msg_japanese "MC(format,data,num,integer,Context)"    "このオプションは、整 - 数の桁数または実数の整 - 数部分を指定します。"
::msgcat::mcset pb_msg_japanese "MC(format,data,num,fraction,Label)"     "フォーマット -- 分数の桁"
::msgcat::mcset pb_msg_japanese "MC(format,data,num,fraction,Context)"   "このオプションは、実数の分数部分に対する桁数を指定します。"
...
::msgcat::mcset pb_msg_japanese "MC(format,data,text,Context)"           "このオプションは、フォーマットのデータタイプをテキストストリングとして定義します。"
::msgcat::mcset pb_msg_japanese "MC(format,data,plus,Label)"             "先頭のプラス符号(+)を出力"
...
::msgcat::mcset pb_msg_japanese "MC(format,data,no_digit,msg)"           "整 - 数および分数に対する桁数は両方ともゼロではいけません。"
...
::msgcat::mcset pb_msg_japanese "MC(other,opt_text,Label)"               "テキストストリング"
...
::msgcat::mcset pb_msg_japanese "MC(listing,Status)"                     "リストファイルパラメータを指定"
...
::msgcat::mcset pb_msg_japanese "MC(listing,user_tcl,check,Context)"     "このスイッチにより、自身のTclファイルを提供できます"
...
::msgcat::mcset pb_msg_japanese "MC(event,opr_start,fst_lin_move,name)"  "最初の直線移動"
...
::msgcat::mcset pb_msg_japanese "MC(event,feedrates,mode,lin)"           "直線補間のみ"
::msgcat::mcset pb_msg_japanese "MC(event,feedrates,mode,rot)"           "回転のみ"
::msgcat::mcset pb_msg_japanese "MC(event,feedrates,mode,lin_rot)"       "直線および回転"
::msgcat::mcset pb_msg_japanese "MC(event,feedrates,mode,rap_lin)"       "早送り直線補間のみ"
::msgcat::mcset pb_msg_japanese "MC(event,feedrates,mode,rap_rot)"       "早送り回転のみ"
::msgcat::mcset pb_msg_japanese "MC(event,feedrates,mode,rap_lin_rot)"   "早送り直線および回転"
...
### Linear Move
::msgcat::mcset pb_msg_japanese "MC(event,linear,name)"                  "直線移動"
::msgcat::mcset pb_msg_japanese "MC(event,linear,g_code)"                "Gコード"
::msgcat::mcset pb_msg_japanese "MC(event,linear,motion)"                "直線モーション"
...
::msgcat::mcset pb_msg_japanese "MC(g_code,linear,name)"                 "モーション - 直線"
...
::msgcat::mcset pb_msg_japanese "MC(m_code,rewind,name)"                 "巻き戻し"
...
## UDE
##
::msgcat::mcset pb_msg_japanese "MC(ude,editor,enable,Label)"            "UDEエディタを使用可能にする"
::msgcat::mcset pb_msg_japanese "MC(ude,editor,enable,as_saved,Label)"   "保存パートと同じ"
...
::msgcat::mcset pb_msg_japanese "MC(ude,import,own,Label)"               "自身のCDLファイルを含む"

::msgcat::mcset pb_msg_japanese "MC(ude,import,own,Context)"             "このオプションは、このポストが定義ファイル内のそれ自身のCDLファイルへの参照を含むことを可能にします。"

::msgcat::mcset pb_msg_japanese "MC(ude,import,own_ent,Label)"           "自身のCDLファイル"
...
::msgcat::mcset pb_msg_japanese "MC(udc,drill,simulate,INFO)"            "このイベントは、シミュレーションサイクルの一種です!"
...
::msgcat::mcset pb_msg_japanese "MC(isv,setup,mac_zcs,Context)"          "ZCS参照ベースとしてコンポーネントを指定します。これは、パートが直接接続されているか、またはキネマティクスツリーで間接的に接続されている非回転コンポーネントである必要があります。。"
...
::msgcat::mcset pb_msg_japanese "MC(isv,setup,limiton,Label)"            "はい"
::msgcat::mcset pb_msg_japanese "MC(isv,setup,limitoff,Label)"           "いいえ"
...
::msgcat::mcset pb_msg_japanese "MC(isv,setup,output,Context)"           "プログラム定義をファイルに保存"
::msgcat::mcset pb_msg_japanese "MC(isv,setup,input,Label)"              "プログラム定義をインポート"
::msgcat::mcset pb_msg_japanese "MC(isv,setup,input,Context)"            "ファイルからプログラム定義を呼出し"
...
::msgcat::mcset pb_msg_japanese "MC(isv,setup,spindle_direction,Label)"  "方向"
...
::msgcat::mcset pb_msg_japanese "MC(isv,setup,dog_leg,yes)"              "はい"
::msgcat::mcset pb_msg_japanese "MC(isv,setup,dog_leg,no)"               "いいえ"
...
::msgcat::mcset pb_msg_japanese "MC(isv,tool_info,offset_usder,Label)"   "   チップオフセット   "
::msgcat::mcset pb_msg_japanese "MC(isv,tool_info,carrier_id,Label)"     " キャリヤID "
::msgcat::mcset pb_msg_japanese "MC(isv,tool_info,pocket_id,Label)"      " ポケットID "
::msgcat::mcset pb_msg_japanese "MC(isv,tool_info,cutcom_reg,Label)"     "     CUTCOM     "
...
::msgcat::mcset pb_msg_japanese "MC(isv,g_code,return_home,Label)"       "ホームへ戻る"
...
::msgcat::mcset pb_msg_japanese "MC(optionMenu,item,SDD)"         "符号により方向決定"
