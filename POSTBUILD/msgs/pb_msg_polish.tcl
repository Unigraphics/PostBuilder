...
::msgcat::mcset $gPB(LANG) "MC(nav_button,open,Label)"              "Otwarta"
...
::msgcat::mcset $gPB(LANG) "MC(machine,axis,rotation,norm,Label)"       "Normalna"
::msgcat::mcset $gPB(LANG) "MC(machine,axis,rotation,norm,Context)"     "Set Axis Rotation Direction to Normal."
::msgcat::mcset $gPB(LANG) "MC(machine,axis,rotation,rev,Label)"        "Odwrócone"
...
::msgcat::mcset $gPB(LANG) "MC(block,text_combo,Label)"             "Tekst"
...
::msgcat::mcset $gPB(LANG) "MC(definition,oper_txt,Label)"          "Komunikat dla operatora"
...
::msgcat::mcset $gPB(LANG) "MC(ude,import,sel,Label)"               "Wybierz słupek"
...
::msgcat::mcset $gPB(LANG) "MC(pb_msg_traditional_chinese)"         "tradycyjny chiński"
