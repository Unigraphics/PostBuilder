...
::msgcat::mcset pb_msg_korean "MC(main,options,properties,Context)"    "특성을 표시합니다."
...
::msgcat::mcset pb_msg_korean "MC(tool,what,Context)"                  "여기서 할 수 있는 작업"
...
::msgcat::mcset pb_msg_korean "MC(msg,no_license)"                     "이 함수를 수행할 라이센스가 없습니다."
::msgcat::mcset pb_msg_korean "MC(msg,no_license_title)"               "UG/Post Builder 라이센스 없이 사용"
::msgcat::mcset pb_msg_korean "MC(msg,no_license_dialog)"              "라이센스 없이 UG/Post Builder를 사용해도 좋습니다.\n하지만 라이센스 없이는 작업을 저장할 수 없습니다.\n"
...
::msgcat::mcset pb_msg_korean "MC(msg,empty_entry)"                    "엔티티는 비워둘 수 없습니다."
...
::msgcat::mcset pb_msg_korean "MC(inposts,title,Label)"                "포스트 설치"
...
::msgcat::mcset pb_msg_korean "MC(machine,gen,out_unit,inch,Label)"        "인치" 
...
::msgcat::mcset pb_msg_korean "MC(machine,gen,lathe_post,select_name,Context)" "단순 밀링-선삭 포스트에서 사용할 선반 포스트 이름을 선택합니다. 잠정적으로 선반 포스트는 UG/Post 런타임 시 \\\$UGII_CAM_POST_DIR에서 찾을 수 있습니다. 해당 디렉토리에서 포스트를 찾지 못하는 경우 밀링 포스트가 있는 디렉토리에서 이름이 같은 포스트를 찾아서 사용합니다."
...
::msgcat::mcset pb_msg_korean "MC(cust_cmd,export,tree,Context)"       "이 리스트는 현재 포스트에 존재하는 사용자 정의 명령 프로시저와 기타 TCL 프로시저를 열거합니다. 리스트에서 아이템을 클릭하면 각 프로시저 내용을 확인할 수 있습니다. 마우스를 두 번 클릭하면 왼쪽에 잇는 확인란이 선택되거나 해제되는데, 이 확인란을 선택하여 내보내기할 프로시저를 지정할 수 있습니다."
...
::msgcat::mcset pb_msg_korean "MC(link_post,head,Context)"             "복잡한 기계 공구는 다양한 가공 모드에서 다양한 운동학 세트를 사용하여 가공 오퍼레이션을 수행합니다. UG/Post에서는 각 운동학 세트를 독립적인 헤드로 취급합니다. 같은 헤드로 수행하는 가공 오퍼레이션은 기계 공구나 가공 방법 뷰에서 한 그룹으로 배치됩니다. 그런 다음 \\\"헤드\\\" UDE가 할당되어 그룹 이름을 지정하게 됩니다."
...
::msgcat::mcset pb_msg_korean "MC(link_post,select_name,Context)"      "헤드에 할당할 포스트 이름을 선택합니다. 잠정적으로 이 포스트는 UG/Post 런타임 시 메인 포스트와 같은 디렉토리에서 찾을 수 있습니다. 해당 디렉토리에서 포스트를 찾지 못하는 경우 \\\$UGII_CAM_POST_DIR 디렉토리에서 이름이 같은 포스트를 찾아서 사용합니다."
...
::msgcat::mcset pb_msg_korean "MC(event,spindle_off,dir_m_code,off)"   "정지"
...
::msgcat::mcset pb_msg_korean "MC(event,coolant_off,m_code,off)"       "중지"
...
::msgcat::mcset pb_msg_korean "MC(event,cutcom_off,off)"               "중지"
...
::msgcat::mcset pb_msg_korean "MC(ude,editor,paramdlg,ON,Label)"       "켜짐"
::msgcat::mcset pb_msg_korean "MC(ude,editor,paramdlg,OFF,Label)"      "꺼짐"
::msgcat::mcset pb_msg_korean "MC(ude,editor,paramdlg,ON,Context)"     "'켜짐'을 기본값으로 설정합니다."
::msgcat::mcset pb_msg_korean "MC(ude,editor,paramdlg,OFF,Context)"    "'꺼짐'을 기본값으로 설정합니다."
...
::msgcat::mcset pb_msg_korean "MC(isv,ex_editor,warning,Msg)"          "시스템에서 생성한 VNC 명령은 변경할 수 없습니다."
