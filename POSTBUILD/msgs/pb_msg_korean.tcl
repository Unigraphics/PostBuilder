...
::msgcat::mcset pb_msg_korean "MC(event,cycle,plane_change,label)"   "작업 평면 변경 하한 감지"
...
::msgcat::mcset pb_msg_korean "MC(ude,editor,param,MSG_WRONG_IMAGE_FOLDER)" "비트맵 파일 이름에 디렉터리 경로를 포함할 수 없습니다! "
...
::msgcat::mcset pb_msg_korean "MC(main,utils,blic,Label)"              "라이선스 찾아보기"
...
::msgcat::mcset pb_msg_korean "MC(msg,user_ctrl_limit)"                "작성자가 아니면 라이선스를 받은 포스트를 컨트롤러로\n 사용하여 새 포스트를 생성할 수 없습니다."
::msgcat::mcset pb_msg_korean "MC(msg,import_limit)"                   "이 라이선스를 받은 포스트의 작성자가 아닙니다.\n 사용자 정의 명령을 가져오기할 수 없습니다."
::msgcat::mcset pb_msg_korean "MC(msg,limit_msg)"                      "이 라이선스를 받은 포스트의 작성자가 아닙니다."
::msgcat::mcset pb_msg_korean "MC(msg,no_file)"                        "이 라이선스를 받은 포스트에 암호화된 파일이 없습니다."
::msgcat::mcset pb_msg_korean "MC(msg,no_license)"                     "이 기능을 수행할 라이선스가 없습니다."
::msgcat::mcset pb_msg_korean "MC(msg,no_license_title)"               "NX/Post Builder 라이선스 없이 사용"
::msgcat::mcset pb_msg_korean "MC(msg,no_license_dialog)"              "라이선스 없이 NX/Post Builder를 사용해도 좋습니다.\n하지만 라이선스 없이는 작업을 저장할 수 없습니다.\n"
...
::msgcat::mcset pb_msg_korean "MC(msg,invalid_dir)"                    "디렉터리가 존재하지 않습니다."
...
::msgcat::mcset pb_msg_korean "MC(msg,dir_perm)"                       "다음 디렉터리에 쓰기 권한이 없습니다:"
...
##
::msgcat::mcset pb_msg_korean "MC(nav_button,no_license,Message)"      "이 기능을 수행할 라이선스가 없습니다."
...
::msgcat::mcset pb_msg_korean "MC(tree,rename,Label)"                  "이름 바꾸기"

##------------------
## Encrypt dialogs
##
::msgcat::mcset pb_msg_korean "MC(encrypt,browser,Label)"              "라이선스 리스트"
::msgcat::mcset pb_msg_korean "MC(encrypt,title,Label)"                "라이선스 선택"
::msgcat::mcset pb_msg_korean "MC(encrypt,output,Label)"               "출력 암호화"
::msgcat::mcset pb_msg_korean "MC(encrypt,license,Label)"              "라이선스:  "
...
::msgcat::mcset pb_msg_korean "MC(machine,gen,lathe_post,select_name,Context)" "단순 밀링-선삭 포스트에서 사용할 선반 포스트 이름을 선택합니다. 잠정적으로 선반 포스트는 NX/Post 런타임 시 \\\$UGII_CAM_POST_DIR에서 찾을 수 있습니다. 해당 디렉터리에서 포스트를 찾지 못하는 경우 밀링 포스트가 있는 디렉터리에서 이름이 같은 포스트를 찾아서 사용합니다."
...
::msgcat::mcset pb_msg_korean "MC(seq,rename_popup,Label)"             "이름 바꾸기"
...
::msgcat::mcset pb_msg_korean "MC(addrsum,col_modal,Label)"            "모드 ?"
...
::msgcat::mcset pb_msg_korean "MC(link_post,select_name,Context)"      "헤드에 할당할 포스트 이름을 선택합니다. 잠정적으로 이 포스트는 NX/Post 런타임 시 메인 포스트와 같은 디렉터리에서 찾을 수 있습니다. 해당 디렉터리에서 포스트를 찾지 못하는 경우 \\\$UGII_CAM_POST_DIR 디렉터리에서 이름이 같은 포스트를 찾아서 사용합니다."
...
::msgcat::mcset pb_msg_korean "MC(address,modality,Label)"             "모드 ?"
::msgcat::mcset pb_msg_korean "MC(address,modality,Context)"           "워드의 양식을 설정합니다."
...
::msgcat::mcset pb_msg_korean "MC(output,vnc,main,Context)"            "종속 VNC가 참조하는 마스터 VNC 이름입니다. 잠정적으로 이 포스트는 ISV 런타임 시 종속 VNC가 있는 디렉터리에서 찾을 수 있습니다. 해당 디렉터리에서 포스트를 찾지 못하는 경우 \\\$UGII_CAM_POST_DIR 디렉터리에서 이름이 같은 포스트를 찾아서 사용합니다."
...
::msgcat::mcset pb_msg_korean "MC(output,vnc,main,select_name,Context)"     "종속 VNC가 참조하는 VNC 이름을 선택합니다. 잠정적으로 이 포스트는 ISV 런타임 시 종속 VNC가 있는 디렉터리에서 찾을 수 있습니다. 해당 디렉터리에서 포스트를 찾지 못하는 경우 \\\$UGII_CAM_POST_DIR 디렉터리에서 이름이 같은 포스트를 찾아서 사용합니다."
...
::msgcat::mcset pb_msg_korean "MC(ude,import,sel,Context)"             "원하는 포스트의 PUI 파일을 선택합니다. 성능을 높이려면 상속하려는 포스트와 관련된 파일(PUI, DEF, TCL, CDL)을 모두 같은 디렉터리에 넣어두는 편이 바람직합니다."
...
::msgcat::mcset pb_msg_korean "MC(udc,drill,simulate,INFO)"            "이는 시뮬레이션한 사이클 이벤트입니다."
...
::msgcat::mcset pb_msg_korean "MC(isv,setup,macro_modal,Label)"        "매크로 모드"
...
::msgcat::mcset pb_msg_korean "MC(isv,g_code,return_home,Label)"       "홈으로 돌아가기 Pn"
