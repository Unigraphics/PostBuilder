...
::msgcat::mcset pb_msg_russian "MC(event,cycle,plane_change,label)"   "Активировать это событие, когда рабочая плоскость станет ниже"
...
::msgcat::mcset pb_msg_russian "MC(ude,editor,param,MSG_WRONG_IMAGE_FOLDER)" "Имя файла значка не должно содержать путь каталога!"
...
::msgcat::mcset pb_msg_russian "MC(msg,dir_perm)"                       "У вас нет прав записи в каталог:"
...
::msgcat::mcset pb_msg_russian "MC(nav_button,filter,Context)"          "Эта кнопка применяет фильтр каталога и выводит список файлов, которые удовлетворяют заданному фильтру."
...
::msgcat::mcset pb_msg_russian "MC(new,punch,desc,Label)"               "Это пробивной станок"
...
::msgcat::mcset pb_msg_russian "MC(machine,gen,turret,sec,Label)"           "Вторичая револьверная головка"
...
::msgcat::mcset pb_msg_russian "MC(link_post,head,Context)"             "Сложный станок, который может выполнять определенные операции обработки, используя множество различных кинематических наборов в различных режимах.  Каждый кинематический набор обрабатывается как независимая головка в NX/Постпроцессор.  Операции обработки, которые должны быть выполнены со специфической головкой, будут помещены вместе как группа на виде станка или виде методов обработки.  Затем \\\"Событие пользователя UDEГоловка\\\" будет назначенj группе для обозначения имени головки."
...
::msgcat::mcset pb_msg_russian "MC(listing,output,review,Context)"      "Этот переключатель позволяет активизировать инструмент отладки в процессе вывода на постпроцессор."
...
### Spindle CSS
::msgcat::mcset pb_msg_russian "MC(event,spindle_css,name)"             "CSS шпинделя"
