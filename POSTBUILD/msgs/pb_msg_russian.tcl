...
::msgcat::mcset pb_msg_russian "MC(main,options,cmd_check,Context)"     "Выключатели для проверки команд пользователя"
...
::msgcat::mcset pb_msg_russian "MC(main,utils,bmv,Label)"               "Поиск MOM переменных"
::msgcat::mcset pb_msg_russian "MC(main,utils,blic,Label)"              "Поиск лицензии"
...
::msgcat::mcset pb_msg_russian "MC(main,help,what,Balloon)"             "Что Вы можете сделать здесь?"
::msgcat::mcset pb_msg_russian "MC(main,help,what,Context)"             "Что Вы можете сделать здесь?"
...
::msgcat::mcset pb_msg_russian "MC(main,help,manual,Label)"             "Инструкция пользователя"
...
::msgcat::mcset pb_msg_russian "MC(tool,what,Context)"                  "Что Вы можете сделать здесь?"
...
::msgcat::mcset pb_msg_russian "MC(tool,manual,Label)"                  "Инструкция пользователя"
...
::msgcat::mcset pb_msg_russian "MC(msg,user_ctrl_limit)"                "Лицензионный постпроцессор не может использоваться как управляющий\n для того, чтобы создать новый постпроцессор, если Вы не автор!"
::msgcat::mcset pb_msg_russian "MC(msg,import_limit)"                   "Вы не автор этой имеющей лицензию постпроцессора!\n Команды пользователя не могут быть импортированы!"
::msgcat::mcset pb_msg_russian "MC(msg,limit_msg)"                      "Вы не автор этой имеющей лицензию постпроцессора!"
::msgcat::mcset pb_msg_russian "MC(msg,no_file)"                        "Зашифрованный файл требуется для этого лицензионного постпроцессора!"
::msgcat::mcset pb_msg_russian "MC(msg,no_license)"                     "У Вас нет необходимой лицензии, чтобы выполнить эту функцию!"
::msgcat::mcset pb_msg_russian "MC(msg,no_license_title)"               "Генератор постпроцессоров UG используется в режиме без лицензии"
::msgcat::mcset pb_msg_russian "MC(msg,no_license_dialog)"              "Вам разрешено использовать генератор постпроцессоров UG/Post \n без необходимой лицензии. Однако, Вы не\n сможет сохранить Вашу работу."
::msgcat::mcset pb_msg_russian "MC(msg,pending)"                        "Сервис этой опции будет внедрен в следующих версиях."
::msgcat::mcset pb_msg_russian "MC(msg,save)"                           "Вы хотите сохранить Ваши изменения\n перед выполнением закрытия постпроцессора?"
...
::msgcat::mcset pb_msg_russian "MC(msg,file_corruption)"                "Не правильное содержание файла сессии генератора постпроцессоров."
::msgcat::mcset pb_msg_russian "MC(msg,bad_tcl_file)"                   "Не правильное содержание TCL файла Вашего постпроцессора."
::msgcat::mcset pb_msg_russian "MC(msg,bad_def_file)"                   "Не правильное содержание файла описания Вашего постпроцессора."
::msgcat::mcset pb_msg_russian "MC(msg,invalid_post)"                   "Вы должны задать по крайней мере один набор, состоящий из файла TCL & файла описания для Вашего постпроцессора."
::msgcat::mcset pb_msg_russian "MC(msg,invalid_dir)"                    "Каталог не существует"
::msgcat::mcset pb_msg_russian "MC(msg,invalid_file)"                   "Файл не существует или не правильный."
::msgcat::mcset pb_msg_russian "MC(msg,invalid_def_file)"               "Не возможно открыть файл описания"
::msgcat::mcset pb_msg_russian "MC(msg,invalid_tcl_file)"               "Не возможно открыть файл обработчика событий"
::msgcat::mcset pb_msg_russian "MC(msg,dir_perm)"                       "У Вас нет прав записи для каталога:"
::msgcat::mcset pb_msg_russian "MC(msg,file_perm)"                      "У Вас нет прав записи в"

::msgcat::mcset pb_msg_russian "MC(msg,file_exist)"                     "уже существует! \nВы действительно хотите заместить их?"
::msgcat::mcset pb_msg_russian "MC(msg,file_missing)"                   "Некоторые или все файлы требуются для этого постпроцессора.\n Вы не можете открыть этот постпроцессор."
...
::msgcat::mcset pb_msg_russian "MC(msg,set_ext_editor)"                 "Вы можете использовать системную переменную EDITOR, чтобы запустить Ваш любимый текстовый редактор."
::msgcat::mcset pb_msg_russian "MC(msg,filename_with_space)"            "Имя файла, которое содержит пробелы не поддерживается!"
...
::msgcat::mcset pb_msg_russian "MC(msg,no_def_name)"                    "Каталог должен быть задан! \n И шаблон должен выглядеть как \"\$ UGII_ *\"!"
::msgcat::mcset pb_msg_russian "MC(msg,no_own_name)"                    "Каталог должен быть задан! \n И шаблон должен выглядеть как \"\$ UGII_ *\"!"
::msgcat::mcset pb_msg_russian "MC(msg,no_oth_ude_name)"                "Другое имя файла cdl должно быть задано! \n И шаблон должен выглядеть как \"\$UGII_ *\"!"
::msgcat::mcset pb_msg_russian "MC(msg,not_oth_cdl_file)"               "Разрешен только CDL файл!"
::msgcat::mcset pb_msg_russian "MC(msg,not_pui_file)"                   "Разрешен только PUI файл!"
::msgcat::mcset pb_msg_russian "MC(msg,not_cdl_file)"                   "Разрешен только CDL файл!"
::msgcat::mcset pb_msg_russian "MC(msg,not_def_file)"                   "Разрешен только DEF файл!"
::msgcat::mcset pb_msg_russian "MC(msg,not_own_cdl_file)"               "Разрешен только собственный CDL файл!"
...
::msgcat::mcset pb_msg_russian "MC(nav_button,ok,Context)"              "Эта клавиша доступна только в подменю. Она позволяет Вам сохранить изменения и закрыть меню."
::msgcat::mcset pb_msg_russian "MC(nav_button,cancel,Label)"            "Отмена"
::msgcat::mcset pb_msg_russian "MC(nav_button,cancel,Context)"          "Эта клавиша доступна в подменю. Она позволяет Вам закрыть меню."
::msgcat::mcset pb_msg_russian "MC(nav_button,default,Label)"           "По умолчанию"
::msgcat::mcset pb_msg_russian "MC(nav_button,default,Context)"         "Эта клавиша позволяет Вам восстановить параметры меню существующего компонента до значений, когда постпроцессор был создан или открыт в данной сессии. \n \nОднако, имя компонента в запросе, будет восстановлено только в его исходное состояние до того, как Вы вошли в меню изменения этого компонента."
::msgcat::mcset pb_msg_russian "MC(nav_button,restore,Label)"           "Восстановить"
::msgcat::mcset pb_msg_russian "MC(nav_button,restore,Context)"         "Эта клавиша позволяет Вам, восстановить параметры в существующем меню к начальные установки Вашей сессии изменения этого компонента."
::msgcat::mcset pb_msg_russian "MC(nav_button,apply,Label)"             "Применить"
::msgcat::mcset pb_msg_russian "MC(nav_button,apply,Context)"           "Эта клавиша позволяет Вам, сохранить изменения, не выходя из меню. Она также восстановит начальные значения текущего меню. \n \n(См., Восстановить при необходимости начальные значения)"
::msgcat::mcset pb_msg_russian "MC(nav_button,filter,Label)"            "Фильтр"
::msgcat::mcset pb_msg_russian "MC(nav_button,filter,Context)"          "Эта клавиша применит фильтр каталога и выведет список файлов, которые удовлетворяют заданному фильтру."
...
::msgcat::mcset pb_msg_russian "MC(nav_button,open,Context)"            "Эта клавиша позволяет Вам открыть выбранный постпроцессор для изменения."

::msgcat::mcset pb_msg_russian "MC(nav_button,save,Label)"              "Сохранить"
::msgcat::mcset pb_msg_russian "MC(nav_button,save,Context)"            "Эта клавиша доступна в меню Сохранить как, которое позволяет Вам сохранить постпроцессор под другим именем."

::msgcat::mcset pb_msg_russian "MC(nav_button,manage,Label)"            "Управление ..."
::msgcat::mcset pb_msg_russian "MC(nav_button,manage,Context)"          "Эта клавиша позволяет Вам, управлять историей последних открытых постпроцессоров."

::msgcat::mcset pb_msg_russian "MC(nav_button,refresh,Label)"           "Обновить"
::msgcat::mcset pb_msg_russian "MC(nav_button,refresh,Context)"         "Эта клавиша обновляет список соответственно существующим объектам."

::msgcat::mcset pb_msg_russian "MC(nav_button,cut,Label)"               "Резания"
::msgcat::mcset pb_msg_russian "MC(nav_button,cut,Context)"             "Эта клавиша вырезает выбранный объект из списка."

::msgcat::mcset pb_msg_russian "MC(nav_button,copy,Label)"              "Копировать"
::msgcat::mcset pb_msg_russian "MC(nav_button,copy,Context)"            "Эта клавиша копирует выбранный объект."

::msgcat::mcset pb_msg_russian "MC(nav_button,paste,Label)"             "Вставить"
::msgcat::mcset pb_msg_russian "MC(nav_button,paste,Context)"           "Эта клавиша вставляет объект из буфера назад в список."

::msgcat::mcset pb_msg_russian "MC(nav_button,edit,Label)"              "Изменить"
::msgcat::mcset pb_msg_russian "MC(nav_button,edit,Context)"            "Эта клавиша изменяет объект в буфере!"
...
::msgcat::mcset pb_msg_russian "MC(new,machine,Label)"                  "Инструмент"
...
::msgcat::mcset pb_msg_russian "MC(new,punch,Label)"                    "Пробивка"
...
::msgcat::mcset pb_msg_russian "MC(new,mill_3MT,Label)"                 "3-оси токарно-фрезерный  (XZC)"
...
::msgcat::mcset pb_msg_russian "MC(new,mill_5HH,Label)"                 "5-осевой с двумя поворотными головками"
::msgcat::mcset pb_msg_russian "MC(new,mill_5TT,Label)"                 "5-осевой с двумя поворотными столами"
...
::msgcat::mcset pb_msg_russian "MC(new,user,Label)"                     "Пользователь"
::msgcat::mcset pb_msg_russian "MC(new,user,browse,Label)"              "Браузер"
...
::msgcat::mcset pb_msg_russian "MC(open,Status)"                        "Выберите PUI файл для открытия"
...
::msgcat::mcset pb_msg_russian "MC(open,file_type_cdl)"                 "CDL файлы"
...
::msgcat::mcset pb_msg_russian "MC(show_mt,title,Label)"                "Инструмент"

##----------------
## Utils dialog
##
::msgcat::mcset pb_msg_russian "MC(mvb,title,Label)"                    "Поиск MOM переменных"
...
::msgcat::mcset pb_msg_russian "MC(inposts,title,Label)"                "Инсталлировать постпроцессоры"
...
::msgcat::mcset pb_msg_russian "MC(tree,cut,Label)"                     "Резания"
...
# Machine Tool
#++++++++++++++
::msgcat::mcset pb_msg_russian "MC(machine,tab,Label)"                  "Инструмент"
...
::msgcat::mcset pb_msg_russian "MC(msg,no_4th_ctable)"                  "4-ая ось C не может быть столом."
...
::msgcat::mcset pb_msg_russian "MC(msg,no_4thT_5thH)"                   "Конфигурация с 4-й осью как стол и 5-й как головка не допустима."
...
::msgcat::mcset pb_msg_russian "MC(machine,display_trans,title,Label)"  "Инструмент"
...
::msgcat::mcset pb_msg_russian "MC(machine,gen,home_pos,Label)"             "Позиция Home"
::msgcat::mcset pb_msg_russian "MC(machine,gen,home_pos,Context)"           "Позиция Home"
...
::msgcat::mcset pb_msg_russian "MC(machine,gen,step_size,min,Label)"        "Мин."
...
::msgcat::mcset pb_msg_russian "MC(machine,gen,circle_record,Label)"        "Вывод круговых записей"
::msgcat::mcset pb_msg_russian "MC(machine,gen,circle_record,yes,Label)"    "Да"
::msgcat::mcset pb_msg_russian "MC(machine,gen,circle_record,yes,Context)"  "Вывод круговых записей."
::msgcat::mcset pb_msg_russian "MC(machine,gen,circle_record,no,Label)"     "Нет"
::msgcat::mcset pb_msg_russian "MC(machine,gen,circle_record,no,Context)"   "Вывод линейной записи."
...
::msgcat::mcset pb_msg_russian "MC(machine,gen,turret,conf,Label)"          "Конфигурация"
::msgcat::mcset pb_msg_russian "MC(machine,gen,turret,conf,Context)"        "Когда выбрано два суппорта, Эта опция позволяют Вам, сконфигурировать параметры."
::msgcat::mcset pb_msg_russian "MC(machine,gen,turret,one,Label)"           "Один суппорт"
::msgcat::mcset pb_msg_russian "MC(machine,gen,turret,one,Context)"         "Токарный станок с одним суппортом"
::msgcat::mcset pb_msg_russian "MC(machine,gen,turret,two,Label)"           "Два суппорта"
::msgcat::mcset pb_msg_russian "MC(machine,gen,turret,two,Context)"         "Двухсуппортной токарный станок"

::msgcat::mcset pb_msg_russian "MC(machine,gen,turret,conf_trans,Label)"    "Конфигурация суппорта"
::msgcat::mcset pb_msg_russian "MC(machine,gen,turret,prim,Label)"          "Первичный суппорт"
::msgcat::mcset pb_msg_russian "MC(machine,gen,turret,prim,Context)"        "Выберите назначение первичного суппорта."
::msgcat::mcset pb_msg_russian "MC(machine,gen,turret,sec,Label)"           "Вторичный суппорт"
::msgcat::mcset pb_msg_russian "MC(machine,gen,turret,sec,Context)"         "Выберите назначение вторичного суппорта."
...
::msgcat::mcset pb_msg_russian "MC(machine,gen,turret,front,Label)"         "Спереди"
::msgcat::mcset pb_msg_russian "MC(machine,gen,turret,rear,Label)"          "REAR"
::msgcat::mcset pb_msg_russian "MC(machine,gen,turret,right,Label)"         "Справа"
::msgcat::mcset pb_msg_russian "MC(machine,gen,turret,left,Label)"          "Слева"
...
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,Label)"           "Множитель оси"
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,dia,Label)"       "Программирование диаметра"
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,dia,Context)"     "Эти опции позволяют Вам программировать диаметра, удваивая значения выбранного адреса в программе ЧПУ."
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,2x,Label)"        "2X"
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,2x,Context)"      "Этот выключатель позволяет Вам, разрешить программирование диаметра, удваивая координаты оси X в кодах программы ЧПУ."

::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,2y,Label)"        "2Y"
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,2y,Context)"      "Этот выключатель позволяет Вам, разрешить программирование диаметра, удваивая координаты оси Y в кодах программы ЧПУ."
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,2i,Label)"        "2I"
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,2i,Context)"      "Этот выключатель позволяет Вам удвоить значения слова I при выводе дуг окружностей, когда используется программирование диаметра."
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,2j,Label)"        "2J"
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,2j,Context)"      "Этот выключатель позволяет Вам удвоить значения слова J при выводе дуг окружностей, когда используется программирование диаметра."

::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,mir,Label)"       "Зеркальный вывод"
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,mir,Context)"     "Эти опции позволяют Вам зеркально отразить выбранный адрес, делая их значения отрицательными программе ЧПУ."
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,x,Label)"         "-X"
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,x,Context)"       "Этот выключатель позволяет Вам сделать отрицательным значения координаты X при выводе в программу ЧПУ."
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,y,Label)"         "-Y"
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,y,Context)"       "Этот выключатель позволяет Вам сделать отрицательным значения координаты Y при выводе в программу ЧПУ."
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,z,Label)"         "-Z"
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,z,Context)"       "Этот выключатель позволяет Вам сделать отрицательным значения координаты Z при выводе в программу ЧПУ."
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,i,Label)"         "-I"
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,i,Context)"       "Этот выключатель позволяет Вам сделать отрицательным значения слова I при выводе записей круговой интерполяции в программу ЧПУ."
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,j,Label)"         "-J"
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,j,Context)"       "Этот выключатель позволяет Вам сделать отрицательным значения слова J при выводе записей круговой интерполяции в программу ЧПУ."
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,k,Label)"         "-K"
::msgcat::mcset pb_msg_russian "MC(machine,gen,axis_multi,k,Context)"       "Этот выключатель позволяет Вам сделать отрицательным значения слова K при выводе записей круговой интерполяции в программу ЧПУ."
...
::msgcat::mcset pb_msg_russian "MC(machine,gen,output,turret_ref,Label)"    "Ссылочный суппорт"
::msgcat::mcset pb_msg_russian "MC(machine,gen,output,turret_ref,Context)"  "Вывод относительно ссылочной точки револьвера"

::msgcat::mcset pb_msg_russian "MC(machine,gen,lathe_turret,msg)"           "Назначенный первичный суппорт не может быть тем, который назначен как вторичный суппорт."
::msgcat::mcset pb_msg_russian "MC(machine,gen,turret_chg,msg)"             "Изменение этой опции может потребовать прибавления или удаления кадра G92 в событие Смена инструмента."
# Entries for XZC/Mill-Turn
::msgcat::mcset pb_msg_russian "MC(machine,gen,spindle_axis,Label)"             "Начальная ориентация оси шпинделя"
::msgcat::mcset pb_msg_russian "MC(machine,gen,spindle_axis,Context)"           "Начальная ориентация оси шпинделя для фрезерного инструмента, может быть задана или как параллельна оси Z или как перпендикулярна к оси Z. Ось инструмента операции должна быть совместимой с заданной ориентацией оси шпинделя. Произойдет ошибка, если постпроцессор не может позиционировать инструмент по оси шпинделя.\nЭтот вектор может быть перезадан осью шпинделя, заданной в объекте Головка."

::msgcat::mcset pb_msg_russian "MC(machine,gen,position_in_yaxis,Label)"        "Положение по оси Y"
::msgcat::mcset pb_msg_russian "MC(machine,gen,position_in_yaxis,Context)"      "У станка есть программируемая ось Y, которая может позиционироваться в процессе обработки. Эта опция применима только когда ось шпинделя не пересекает ось Z."
...
::msgcat::mcset pb_msg_russian "MC(machine,gen,mach_mode,xzc_mill,Context)"     "У станка в режиме фрезерования XZC имеется стол, или грань патрона, присоединенные к токарно-фрезерному станку как поворотная ось C. Все координатные перемещения будут преобразованы в координаты X и C, где X является значением радиуса и C угол."

::msgcat::mcset pb_msg_russian "MC(machine,gen,mach_mode,mill_turn,Label)"      "Простой токарно-фрезерный"
::msgcat::mcset pb_msg_russian "MC(machine,gen,mach_mode,mill_turn,Context)"    "Этот XZC фрезерный постпроцессор будет связана с токарным постпроцессором, чтобы генерировать программу, которая содержит фрезерные и токарные операции. Тип операции определяет, какой постпроцессор использовать для того, чтобы генерировать коды программы ЧПУ."
...
::msgcat::mcset pb_msg_russian "MC(machine,gen,lathe_post,select_name,Context)" "Выберите имя токарного постпроцессора, которое будет использоваться в простом токарно-фрезерном постпроцессоре. Если во время выполнения вывода на UG/Постпроцессор этот постпроцессор будет найден в каталоге \\\$UGII_CAM_POST_DIR, будет использоваться постпроцессор из этого каталога, в противном случае, будет использоваться постпроцессор с тем же именем из каталога, в котором располагается основной постпроцессор."

::msgcat::mcset pb_msg_russian "MC(machine,gen,coord_mode,Label)"               "Режим вывода координат по умолчанию"
::msgcat::mcset pb_msg_russian "MC(machine,gen,coord_mode,Context)"             "Эти опции задают начальную настройку для режима вывода координат, которые могут быть полярными (XZC) или декартовыми (XYZ). Этот режим может быть изменен командой задаваемой пользователем \\\"SET/POLAR,ON\\\", которая задается в операциями."
...
::msgcat::mcset pb_msg_russian "MC(machine,gen,xzc_arc_mode,Label)"             "Режим круговой записи"
...
::msgcat::mcset pb_msg_russian "MC(machine,gen,xzc_arc_mode,polar,Context)"     "Круговое перемещение в кодах XCR."

::msgcat::mcset pb_msg_russian "MC(machine,gen,xzc_arc_mode,cart,Label)"        "Декартовы"
::msgcat::mcset pb_msg_russian "MC(machine,gen,xzc_arc_mode,cart,Context)"      "Круговое перемещение в кодах XYIJ."
...
## 4-th Axis parms
##
::msgcat::mcset pb_msg_russian "MC(machine,axis,fourth,Label)"              "Четвертая ось"
...
::msgcat::mcset pb_msg_russian "MC(machine,axis,rotation,norm,Context)"     "Установить нормальное направление вращения оси."
::msgcat::mcset pb_msg_russian "MC(machine,axis,rotation,rev,Label)"        "Перевернутый"
...
::msgcat::mcset pb_msg_russian "MC(machine,axis,con_motion,combine,Context)"    "Этот выключатель позволяет Вам включить / выключить линеаризацию. Так же он включает / выключает опцию задания допуска."
::msgcat::mcset pb_msg_russian "MC(machine,axis,con_motion,tol,Label)"      "Допуск/Точность"
::msgcat::mcset pb_msg_russian "MC(machine,axis,con_motion,tol,Context)"    "Эта опция активна только, когда активен выключатель Комбинированный. Задайте допуск."
...
::msgcat::mcset pb_msg_russian "MC(machine,axis,limits,min,Label)"          "Мин."
...
::msgcat::mcset pb_msg_russian "MC(machine,axis,incr_text)"                 "Эта поворотная ось программируется в приращениях"
...
::msgcat::mcset pb_msg_russian "MC(machine,axis,max_feed,Label)"            "Мак. подача (Градусы/Мин.)"
::msgcat::mcset pb_msg_russian "MC(machine,axis,max_feed,Context)"          "Задайте максимальную скорость подачи (градусы/минуту)."

::msgcat::mcset pb_msg_russian "MC(machine,axis,plane,Label)"               "Плоскость вращения"
::msgcat::mcset pb_msg_russian "MC(machine,axis,plane,Context)"             "Выберите XY, YZ, ZX или Другая как плоскость поворота. Опция \\\"Другая\\\" позволяют Вам задать вектор направления оси."
...
::msgcat::mcset pb_msg_russian "MC(machine,axis,config,Label)"              "Конфигурация"
::msgcat::mcset pb_msg_russian "MC(machine,axis,config,Context)"            "Эта опция позволяет Вам, задать параметры 4-ой & 5-ой оси."
...
# Program & Tool Path
#+++++++++++++++++++++
::msgcat::mcset pb_msg_russian "MC(progtpth,tab,Label)"                 "Программа & траектория инструмента"
...
::msgcat::mcset pb_msg_russian "MC(prog,add,Context)"                   "Вы можете добавить новый кадр к последовательности, нажимая эту клавишу и перемещая кадр под необходимый маркер. Кадры могут быть присоединены рядом, выше или ниже существующего кадра."

::msgcat::mcset pb_msg_russian "MC(prog,trash,Label)"                   "Последовательность -- мусорная корзина"
::msgcat::mcset pb_msg_russian "MC(prog,trash,Context)"                 "Вы можете удалить любые ненужные кадры из последовательности, перемещая его в мусорную корзину."

::msgcat::mcset pb_msg_russian "MC(prog,block,Label)"                   "Последовательность -- кадр"
::msgcat::mcset pb_msg_russian "MC(prog,block,Context)"                 "Вы можете удалить любое ненужное слово в этом кадре, перемещая его в мусорную корзину. \n \nВы можете также вызвать всплывающее меню, нажимая правую клавишу мышки. Следующие опции доступны в этом меню: \n \n * Изменить \n * Постоянный вывод \n * Вырезать \n * Копировать как \n * Вставить \n * Удалить \n"
...
::msgcat::mcset pb_msg_russian "MC(prog,seq_comb_nc,Context)"           "Эта клавиша позволяет Вам вывести на экран содержание последовательности в терминах кодов ЧПУ или кадров. \n \nКоды ЧПУ отображаются словами в порядке вывода."

::msgcat::mcset pb_msg_russian "MC(prog,plus,Label)"                    "Программа -- переключатель Свернуть/Развернуть"
::msgcat::mcset pb_msg_russian "MC(prog,plus,Context)"                  "Эта клавиша позволяет Вам свернуть или развернуть ветви выбранного в дереве компонента."

::msgcat::mcset pb_msg_russian "MC(prog,marker,Label)"                  "Последовательность -- маркер"
::msgcat::mcset pb_msg_russian "MC(prog,marker,Context)"                "Маркеры последовательности указывают возможные события, которые могут быть программированы и могут произойти в последовательности на заданном шаге программы ЧПУ. \n \nВы можете присоединять/упорядочивать кадры, которые выводятся в каждом маркере."

::msgcat::mcset pb_msg_russian "MC(prog,event,Label)"                   "Программа -- события"
::msgcat::mcset pb_msg_russian "MC(prog,event,Context)"                 "Вы можете изменить каждое событие одиночным нажатием левой клавиши мышки."
...
::msgcat::mcset pb_msg_russian "MC(prog,undo_popup,Label)"              "Отмена"
...
::msgcat::mcset pb_msg_russian "MC(seq,new_trans,title,Label)"          "Блок"
...
::msgcat::mcset pb_msg_russian "MC(seq,cut_popup,Label)"                "Резания"
...
::msgcat::mcset pb_msg_russian "MC(tool,format_trans,title,Label)"      "Формат"

::msgcat::mcset pb_msg_russian "MC(tool,circ_trans,title,Label)"        "Круговое перемещение -- коды плоскостей"
::msgcat::mcset pb_msg_russian "MC(tool,circ_trans,frame,Label)"        " Коды G плоскости "
...
::msgcat::mcset pb_msg_russian "MC(tool,circ_trans,zx,Label)"           "ZX плоскость"
...
::msgcat::mcset pb_msg_russian "MC(tool,ijk_desc,tran_thread_lead,Label)"   "Переходной шаг резьбы"
...
::msgcat::mcset pb_msg_russian "MC(tool,spindle,range,with_spindle_M,Label)"    "Номер диапазона с кодом M включения шпинделя (M13)"
...
::msgcat::mcset pb_msg_russian "MC(tool,spindle_trans,min,Label)"           "Минимум (Обороты)"
::msgcat::mcset pb_msg_russian "MC(tool,spindle_trans,max,Label)"           "Максимальные (Обороты)"

::msgcat::mcset pb_msg_russian "MC(tool,spindle_desc,sep,Label)"            " Отдельный М код диапазона (M41, M42 ...) "
::msgcat::mcset pb_msg_russian "MC(tool,spindle_desc,range,Label)"          " Номер диапазона с кодом M включения шпинделя (M13, M23 ...)"
...
::msgcat::mcset pb_msg_russian "MC(tool,config,lathe_opt3,Label)"           "Индекс суппорта и номер инструмента"
::msgcat::mcset pb_msg_russian "MC(tool,config,lathe_opt4,Label)"           "Индекс суппорта, номер инструмента и номер корректора длины"
...
::msgcat::mcset pb_msg_russian "MC(tool,conf_desc,index_num,Label)"         "Индекс суппорта и номер инструмента"
::msgcat::mcset pb_msg_russian "MC(tool,conf_desc,index_next_num,Label)"    "Индекс суппорта и номер следующего инструмента"
...
::msgcat::mcset pb_msg_russian "MC(tool,conf_desc,index_num_len,Label)"     "Индекс суппорта, номер инструмента и номер корректора длины "
::msgcat::mcset pb_msg_russian "MC(tool,conf_desc,index_next_num_len,Label)"    "Индекс суппорта, номер следующего инструмента и номер корректора длины"
...
##
::msgcat::mcset pb_msg_russian "MC(event,feed,IPM_mode)"                "Режим IPM (Дюймы/Минуту)"
...
::msgcat::mcset pb_msg_russian "MC(addrsum,col_addr,Context)"           "Вы можете изменить слово, нажатием левой клавиши мышки на его имя."
...
::msgcat::mcset pb_msg_russian "MC(addrsum,col_min,Label)"              "Мин."
...
::msgcat::mcset pb_msg_russian "MC(addrsum,addr_trans,title,Label)"     "Слово"
...
::msgcat::mcset pb_msg_russian "MC(wseq,popup_undo,Label)"              "Отмена"
...
::msgcat::mcset pb_msg_russian "MC(wseq,transient_win,Label)"           "Слово"
...
::msgcat::mcset pb_msg_russian "MC(cust_cmd,name_msg_2)"                "Только команды пользователя для виртуальной системы ЧПУ, с именами типа \n PB_CMD_vnc____* допустимы.\n Задайте другое имя"
...
::msgcat::mcset pb_msg_russian "MC(cust_cmd,import,tree,Context)"       "Этот список содержит специализированные и другие TCL процедуры, существующие в файле, который Вы задали для импорта. Вы можете предварительно просмотреть содержание каждой процедуры, выбирая запись в списке одиночным нажатием левой клавиши мышки. Любая процедура, которая уже существует в постпроцессоре помечена индикатором <существует>. Двойное нажатие левой клавишей мышки на запись, выводит на экран выключатель рядом с записью. Это позволяет Вам, выбрать или отменить выбор процедуры, для импорта. По умолчанию, все процедуры выбраны для импорта. Вы можете отменить выбор любой записи, чтобы избежать перезаписи существующей процедуры."

::msgcat::mcset pb_msg_russian "MC(cust_cmd,export,tree,Label)"         "Экспорт команд пользователя"
::msgcat::mcset pb_msg_russian "MC(cust_cmd,export,tree,Context)"       "Этот список содержит специализированные и другие TCL процедуры, которые существуют в постпроцессоре. Вы можете предварительно просмотреть содержание каждой процедуры, выбирая запись в списке одиночным нажатием левой клавиши мышки. Двойное нажатие левой клавишей мышки на запись, выводит на экран выключатель рядом с записью. Это позволяет Вам, выбрать или отменить выбор процедуры, для импорта."

::msgcat::mcset pb_msg_russian "MC(cust_cmd,error,title)"               "Ошибка в команде пользователя"
::msgcat::mcset pb_msg_russian "MC(cust_cmd,error,msg)"                 "Опция Проверка команд пользователя может быть включена или выключена, устанавливая выключатель возле записи в соответствующее положение в главном меню \"Опции -> Проверка команд пользователя\"."

::msgcat::mcset pb_msg_russian "MC(cust_cmd,select_all,Label)"          "Выбрать все"
::msgcat::mcset pb_msg_russian "MC(cust_cmd,select_all,Context)"        "Нажмите эту клавишу, чтобы выделить все отображаемые команды для импорта или экспорта. "
::msgcat::mcset pb_msg_russian "MC(cust_cmd,deselect_all,Label)"        "Отказаться"
::msgcat::mcset pb_msg_russian "MC(cust_cmd,deselect_all,Context)"      "Нажмите эту клавишу, чтобы отменить выбор всех команд."
...
::msgcat::mcset pb_msg_russian "MC(link_post,head,Context)"             "Сложный станок может выполнить свои операции обработки, используя различные наборы кинематики в различных режимах обработки. С каждым набором кинематики может использоваться независимая головка в UG/Post. Операции обработки, которые требуют для выполнения специальной головки, должны размещаться в одной группе в виде станка или в виде методов обработки. Событие задаваемое пользователем \\\"Головка\\\" должно быть назначено на группу, для задания имени для этой головки."
...
::msgcat::mcset pb_msg_russian "MC(link_post,select_name,Context)"      "Выберите имя постпроцессора, которое будет назначено на головку. Предполагается, что во время выполнения вывода на UG/Постпроцессор этот постпроцессор будет найден в каталоге, в котором располагается главный постпроцессор, в противном случае будет использоваться постпроцессор с тем же именем в каталоге \\\$UGII_CAM_POST_DIR."

::msgcat::mcset pb_msg_russian "MC(link_post,start_of_head,Label)"      "Начало работы головки"
::msgcat::mcset pb_msg_russian "MC(link_post,start_of_head,Context)"    "Задайте коды ЧПУ или действия, которые должны быть выполнены в начале этого заголовка. "

::msgcat::mcset pb_msg_russian "MC(link_post,end_of_head,Label)"        "Конец заголовка"
::msgcat::mcset pb_msg_russian "MC(link_post,end_of_head,Context)"      "Задайте коды ЧПУ или действия, которые должны быть выполнены в конце этого заголовка. "
...
## BLOCK
##
::msgcat::mcset pb_msg_russian "MC(block,tab,Label)"                    "Кадр"
::msgcat::mcset pb_msg_russian "MC(block,Status)"                       "Задать шаблон кадра"
...
::msgcat::mcset pb_msg_russian "MC(block,add,Context)"                  "Вы можете добавить новое слово в кадр, нажимая эту клавишу и перемещая слово в кадр, который отображается в окне ниже. Тип слова, который будет создан, выбирается из блока списка справа от этой клавиши."

::msgcat::mcset pb_msg_russian "MC(block,select,Label)"                 "Кадр -- Выбор слова"
::msgcat::mcset pb_msg_russian "MC(block,select,Context)"               "Вы можете выбрать тип слова, который Вы хотите добавить в кадр из этого списка."

::msgcat::mcset pb_msg_russian "MC(block,trash,Label)"                  "Кадр -- Мусорная корзина"
::msgcat::mcset pb_msg_russian "MC(block,trash,Context)"                "Вы можете удалить любые ненужные слова из кадра, перемещая их в мусорную корзину"

::msgcat::mcset pb_msg_russian "MC(block,word,Label)"                   "Кадр -- Слово"
::msgcat::mcset pb_msg_russian "MC(block,word,Context)"                 "Вы можете удалить любое ненужное слово в этом кадре, перемещая его в мусорную корзину. \n \nВы можете также вызвать всплывающее меню, нажимая правую клавишу мышки. Следующие опции доступны в этом меню: \n \n * Изменить \n * Изменить элемент -> \n * Опционально \n * Без разделителя слов \n * Постоянный вывод \n * Удалить \n"

::msgcat::mcset pb_msg_russian "MC(block,verify,Label)"                 "Кадр -- Проверка слова"
...
::msgcat::mcset pb_msg_russian "MC(block,undo_popup,Label)"             "Отмена"
...
::msgcat::mcset pb_msg_russian "MC(block,addr_title,Label)"             "Слово"

::msgcat::mcset pb_msg_russian "MC(block,new_trans,title,Label)"        "Слово"
...
## ADDRESS
##
::msgcat::mcset pb_msg_russian "MC(address,tab,Label)"                  "Слово"
...
::msgcat::mcset pb_msg_russian "MC(address,verify,Label)"               "Слово -- Проверка"
...
::msgcat::mcset pb_msg_russian "MC(address,leader,Label)"               "Выноска"
::msgcat::mcset pb_msg_russian "MC(address,leader,Context)"             "Вы можете ввести любое число символов как лидер для слова или выбрать символ из всплывающего меню, используя правую клавишу мышки."
...
::msgcat::mcset pb_msg_russian "MC(address,format,edit,Context)"        "Эта клавиша позволяет Вам изменить формат, используемый в слове."
::msgcat::mcset pb_msg_russian "MC(address,format,new,Label)"           "Новый"
::msgcat::mcset pb_msg_russian "MC(address,format,new,Context)"         "Эта клавиша позволяет Вам создать новый формат."

::msgcat::mcset pb_msg_russian "MC(address,format,select,Label)"        "Слово -- Выбрать формат"
::msgcat::mcset pb_msg_russian "MC(address,format,select,Context)"      "Эта клавиша позволяет Вам выбрать другой формат для слова."

::msgcat::mcset pb_msg_russian "MC(address,trailer,Label)"              "Окончание"
::msgcat::mcset pb_msg_russian "MC(address,trailer,Context)"            "Вы можете ввести любое число символов как окончание для слова или выбрать символ из всплывающего меню, используя правую клавишу мышки."

::msgcat::mcset pb_msg_russian "MC(address,modality,Label)"             "Модальный ?"
::msgcat::mcset pb_msg_russian "MC(address,modality,Context)"           "Эта опция позволяет Вам указать модальность вывода для выбранного слова."
...
::msgcat::mcset pb_msg_russian "MC(address,max,error_handle,Context)"   "Эта клавиша позволяет Вам задать метод того, как обработать ситуацию превышения максимального значения: \n \n * Обрезать значение \n * Предупредить пользователя \n * Прервать процесс \n"

::msgcat::mcset pb_msg_russian "MC(address,min,value,Label)"            "Мин."
...
::msgcat::mcset pb_msg_russian "MC(address,min,error_handle,Context)"   "Эта клавиша позволяет Вам задать метод того, как обработать ситуацию превышения минимального значения: \n \n * Обрезать значение \n * Предупредить пользователя \n * Прервать процесс \n"

::msgcat::mcset pb_msg_russian "MC(address,format_trans,title,Label)"   "Формат "
...
::msgcat::mcset pb_msg_russian "MC(address,exp,space_only)"             "Выражение для элемента кадра, которое  использует числовой формата не может содержать только пробелы."
...
## FORMAT
##
::msgcat::mcset pb_msg_russian "MC(format,tab,Label)"                   "Формат"
::msgcat::mcset pb_msg_russian "MC(format,Status)"                      "Задать форматы"

::msgcat::mcset pb_msg_russian "MC(format,verify,Label)"                "Формат -- проверка"
...
::msgcat::mcset pb_msg_russian "MC(format,data,num,integer,Label)"      "Формат -- целая часть"
...
::msgcat::mcset pb_msg_russian "MC(format,data,num,fraction,Label)"     "Формат -- дробная часть"
...
::msgcat::mcset pb_msg_russian "MC(format,data,num,decimal,Context)"    "Эта опция позволяет Вам управлять выводом десятичных точек в коде программы ЧПУ."
...
::msgcat::mcset pb_msg_russian "MC(format,data,plus,Context)"           "Эта опция позволяет Вам управлять выводом знака плюс в коде программы ЧПУ."
::msgcat::mcset pb_msg_russian "MC(format,zero_msg)"                    "Не возможно создать копию формата Zero"
::msgcat::mcset pb_msg_russian "MC(format,zero_cut_msg)"                "Не возможно удалить формат Zero"
...
::msgcat::mcset pb_msg_russian "MC(other,seq_num,Context)"              "Этот выключатель позволяет Вам включить / выключить вывод номер кадра в файл листинга."
...
::msgcat::mcset pb_msg_russian "MC(other,opskip,leader,Label)"          "Лидер строки"
::msgcat::mcset pb_msg_russian "MC(other,opskip,leader,Context)"        "Лидер строки OPSKIP"

::msgcat::mcset pb_msg_russian "MC(other,gm_codes,Label)"               "Вывод G & M кодов в одном кадре"
::msgcat::mcset pb_msg_russian "MC(other,g_codes,Label)"                "Количество G кодов в кадре"
::msgcat::mcset pb_msg_russian "MC(other,g_codes,Context)"              "Этот выключатель позволяет Вам включить / выключить разрешенное количество G кодов в одном кадре программы ЧПУ."
...
::msgcat::mcset pb_msg_russian "MC(other,m_codes,Context)"              "Этот выключатель позволяет Вам включить / выключить разрешенное количество M кодов в одном кадре программы ЧПУ."
...
::msgcat::mcset pb_msg_russian "MC(other,ude_include,Label)"            "Включить другой CDL файл"
...
::msgcat::mcset pb_msg_russian "MC(other,ude_file,Label)"               "Имя CDL файла"
::msgcat::mcset pb_msg_russian "MC(other,ude_file,Context)"             "Путь и имя файла CDL, на который будет создана ссылка (INCLUDE) в файл описания этого постпроцессора. Имя пути должно начаться с системной переменной UG (\\\$UGII) или не иметь пути. Когда путь не задан, будет использоваться переменная UGII_CAM_FILE_SEARCH_PATH, чтобы для поиска файла в сессии UG/NX."
...
::msgcat::mcset pb_msg_russian "MC(output,Status)"                      "Конфигурация параметров вывода"
...
::msgcat::mcset pb_msg_russian "MC(output,vnc,status,Label)"            "Выбрать файл ВСЧПУ"
...
::msgcat::mcset pb_msg_russian "MC(output,vnc,output,Label)"            "Генерировать виртуальную систему ЧПУ"
::msgcat::mcset pb_msg_russian "MC(output,vnc,output,Context)"          "Эта опция позволяет Вам генерировать виртуальную систему ЧПУ. Постпроцессор, созданный с виртуальной системой ЧПУ, может использоваться для встроенной симуляции программы."
::msgcat::mcset pb_msg_russian "MC(output,vnc,main,Label)"              "Исходная виртуальная система ЧПУ"
::msgcat::mcset pb_msg_russian "MC(output,vnc,main,Context)"            "Имя исходной виртуальной системы ЧПУ, которое будет исходным для зависимой виртуальной системы ЧПУ. Во время выполнения симуляции, предполагается, что этот постпроцессор будет найден в каталоге, в котором располагается зависимая виртуальная система ЧПУ, в противном случае, будет использоваться постпроцессор с тем же именем в каталоге \\\$UGII_CAM_POST_DIR."
...
::msgcat::mcset pb_msg_russian "MC(output,vnc,pb_ver,msg)"                   "Виртуальная система ЧПУ создана в генераторе постпроцессора "
#++++++++++++++
# Listing File
#++++++++++++++
...
::msgcat::mcset pb_msg_russian "MC(listing,gen,Context)"                "Этот выключатель позволяет Вам включить / выключить вывод в файл листинга."
...
::msgcat::mcset pb_msg_russian "MC(listing,parms,x,Context)"            "Этот выключатель позволяет Вам включить / выключить вывод координаты X в файл листинга."

::msgcat::mcset pb_msg_russian "MC(listing,parms,y,Label)"              "Y-координата"
::msgcat::mcset pb_msg_russian "MC(listing,parms,y,Context)"            "Этот выключатель позволяет Вам включить / выключить вывод координаты Y в файл листинга."

::msgcat::mcset pb_msg_russian "MC(listing,parms,z,Label)"              "Z-координата"
::msgcat::mcset pb_msg_russian "MC(listing,parms,z,Context)"            "Этот выключатель позволяет Вам включить / выключить вывод координаты Z в файл листинга."

::msgcat::mcset pb_msg_russian "MC(listing,parms,4,Label)"              "Угол 4-й оси"
::msgcat::mcset pb_msg_russian "MC(listing,parms,4,Context)"            "Этот выключатель позволяет Вам включить / выключить вывод угла 4-ой оси в файл листинга."

::msgcat::mcset pb_msg_russian "MC(listing,parms,5,Label)"              "Угол 5-й оси"
::msgcat::mcset pb_msg_russian "MC(listing,parms,5,Context)"            "Этот выключатель позволяет Вам включить / выключить вывод угла 5-ой оси в файл листинга."

::msgcat::mcset pb_msg_russian "MC(listing,parms,feed,Label)"           "Подача"
::msgcat::mcset pb_msg_russian "MC(listing,parms,feed,Context)"         "Этот выключатель позволяет Вам включить / выключить вывод подач в файл листинга."

::msgcat::mcset pb_msg_russian "MC(listing,parms,speed,Label)"          "Скорость"
::msgcat::mcset pb_msg_russian "MC(listing,parms,speed,Context)"        "Этот выключатель позволяет Вам включить / выключить вывод частоты вращения шпинделя в файл листинга."
...
::msgcat::mcset pb_msg_russian "MC(listing,format,print_header,Context)"    "Этот выключатель позволяет Вам включить / выключить вывод заголовка в файл листинга."
...
::msgcat::mcset pb_msg_russian "MC(listing,output,warning,Context)"     "Этот выключатель позволяет Вам включить / выключить вывод предупреждений с процессе работы постпроцессора."

::msgcat::mcset pb_msg_russian "MC(listing,output,review,Label)"        "Активировать инструмент отладки"
::msgcat::mcset pb_msg_russian "MC(listing,output,review,Context)"      "Этот выключатель позволяет Вам, активировать инструмент отладки в процессе вывода на постпроцессор."

::msgcat::mcset pb_msg_russian "MC(listing,output,group,Label)"         "Генерировать группу вывода"
::msgcat::mcset pb_msg_russian "MC(listing,output,group,Context)"       "Этот выключатель позволяет Вам включить / выключить управление выводом группы в процессе вывода на постпроцессор."

::msgcat::mcset pb_msg_russian "MC(listing,output,verbose,Label)"       "Отображать подробное сообщение об ошибках"
::msgcat::mcset pb_msg_russian "MC(listing,output,verbose,Context)"     "Этот выключатель позволяет Вам отобразить расширенные описания для аварийных ситуаций. При этом постпроцессор будет работать несколько медленнее."
...
::msgcat::mcset pb_msg_russian "MC(listing,user_tcl,check,Context)"     "Этот выключатель позволяет Вам указать исходный собственный TCL файл"
::msgcat::mcset pb_msg_russian "MC(listing,user_tcl,name,Label)"        "Имя файла"
::msgcat::mcset pb_msg_russian "MC(listing,user_tcl,name,Context)"      "Задайте имя Tcl файла, который Вы хотите использовать как исходный для этого постпроцессора"
...
::msgcat::mcset pb_msg_russian "MC(preview,old_code,Label)"             "Старые коды"

##---------------------
## Event Handler
##
::msgcat::mcset pb_msg_russian "MC(event_handler,tab,Label)"            "Обработчик событий"
...
::msgcat::mcset pb_msg_russian "MC(definition,Status)"                  "Выберите запись для просмотра содержания"
...
::msgcat::mcset pb_msg_russian "MC(definition,format_txt,Label)"        "Формат"
::msgcat::mcset pb_msg_russian "MC(definition,addr_txt,Label)"          "Слово"
::msgcat::mcset pb_msg_russian "MC(definition,block_txt,Label)"         "Кадр"
::msgcat::mcset pb_msg_russian "MC(definition,comp_txt,Label)"          "Составной кадр"
::msgcat::mcset pb_msg_russian "MC(definition,post_txt,Label)"          "Блок постпроцессора"
...
::msgcat::mcset pb_msg_russian "MC(msg,wrong_list_2)"                   ". Должен быть один из:"
...
### Operation Start
::msgcat::mcset pb_msg_russian "MC(event,opr_start,start_path,name)"    "Начало пути"
::msgcat::mcset pb_msg_russian "MC(event,opr_start,from_move,name)"     "Перемещение из точки From"
...
### Program End
::msgcat::mcset pb_msg_russian "MC(event,end_prog,name)"                "Конец программы"
...
::msgcat::mcset pb_msg_russian "MC(event,tool_change,m_code,pt)"        "Первичный суппорт"
::msgcat::mcset pb_msg_russian "MC(event,tool_change,m_code,st)"        "Вторичный суппорт"
::msgcat::mcset pb_msg_russian "MC(event,tool_change,t_code)"           "Т код"
::msgcat::mcset pb_msg_russian "MC(event,tool_change,t_code,conf)"      "Конфигурация"
::msgcat::mcset pb_msg_russian "MC(event,tool_change,t_code,pt_idx)"    "Индекс первичного суппорта"
::msgcat::mcset pb_msg_russian "MC(event,tool_change,t_code,st_idx)"    "Индекс вторичного суппорта"
::msgcat::mcset pb_msg_russian "MC(event,tool_change,tool_num)"         "Номер инструмента"
::msgcat::mcset pb_msg_russian "MC(event,tool_change,tool_num,min)"     "Мин."
...
::msgcat::mcset pb_msg_russian "MC(event,length_compn,t_code,conf)"     "Конфигурация"
::msgcat::mcset pb_msg_russian "MC(event,length_compn,len_off)"         "Регистр коррекции длины"
::msgcat::mcset pb_msg_russian "MC(event,length_compn,len_off,min)"     "Мин."
::msgcat::mcset pb_msg_russian "MC(event,length_compn,len_off,max)"     "Максимум"

### Set Modes
::msgcat::mcset pb_msg_russian "MC(event,set_modes,name)"               "Задание режимов"
...
::msgcat::mcset pb_msg_russian "MC(event,set_modes,rotary_axis)"        "Поворотная ось программируется в приращениях"
...
::msgcat::mcset pb_msg_russian "MC(event,spindle_rpm,range_control,dwell_time)" "Задержка времени при смене диапазона (Секунд)"
::msgcat::mcset pb_msg_russian "MC(event,spindle_rpm,range_control,range_code)" "Задайте код диапазона"

### Spindle CSS
::msgcat::mcset pb_msg_russian "MC(event,spindle_css,name)"             "Шпиндель CSS"
::msgcat::mcset pb_msg_russian "MC(event,spindle_css,g_code)"           "G код направления вращения шпинделя"
...
::msgcat::mcset pb_msg_russian "MC(event,inch_metric_mode,g_code,english)"  "Английские (Дюймы)"
::msgcat::mcset pb_msg_russian "MC(event,inch_metric_mode,g_code,metric)"   "Метрические (Миллиметры)"
...
::msgcat::mcset pb_msg_russian "MC(event,feedrates,min)"                "Мин."
...
::msgcat::mcset pb_msg_russian "MC(event,feedrates,mode,rot)"           "Только вращение"
...
::msgcat::mcset pb_msg_russian "MC(event,cutcom_on,min)"                "Мин."
...
::msgcat::mcset pb_msg_russian "MC(event,delay,out_mode,ivs)"           "Время отработки кадра"
...
### Auxfun
::msgcat::mcset pb_msg_russian "MC(event,auxfun,name)"                  "Функция перемещения"
...
::msgcat::mcset pb_msg_russian "MC(event,circular,clockwise)"           "По часовой стрелки (ПоЧС)"
::msgcat::mcset pb_msg_russian "MC(event,circular,counter-clock)"       "Против часовой стрелки (ПротивЧС)"
::msgcat::mcset pb_msg_russian "MC(event,circular,record)"              "Круговая запись"
...
::msgcat::mcset pb_msg_russian "MC(event,circular,min)"                 "Мин."
...
### Lathe Thread
::msgcat::mcset pb_msg_russian "MC(event,lathe,name)"                   "Нарезания резьбы на ТС"
::msgcat::mcset pb_msg_russian "MC(event,lathe,g_code)"                 "Код G заправки проволоки"
...
### Cycle
::msgcat::mcset pb_msg_russian "MC(event,cycle,g_code)"                 "G код & настройка"
::msgcat::mcset pb_msg_russian "MC(event,cycle,customize,Label)"        "Настройки"
::msgcat::mcset pb_msg_russian "MC(event,cycle,customize,Context)"      "Этот выключатель позволяет Вам, настроить цикл. \n\nПо умолчанию, основная конструкция каждого цикла задана установками общих параметров. Эти общие элементы не могут изменятся в каждом цикле. \n\nВключение этой опции позволяет Вам, получить полный контроль над конфигурацией цикла. Изменения, сделанные в общих параметрам, больше не будут воздействовать на цикл."
...
::msgcat::mcset pb_msg_russian "MC(event,cycle,drill_dwell,name)"       "Сверление с задержкой"
...
::msgcat::mcset pb_msg_russian "MC(event,cycle,tap,name)"               "Смешанный"
::msgcat::mcset pb_msg_russian "MC(event,cycle,bore,name)"              "Отверстие"
::msgcat::mcset pb_msg_russian "MC(event,cycle,bore_dwell,name)"        "Расточка с задержкой"
...
::msgcat::mcset pb_msg_russian "MC(g_code,circular_clw,name)"           "Круговая интерполяция против ЧС"
::msgcat::mcset pb_msg_russian "MC(g_code,circular_cclw,name)"          "Круговая интерполяция по ЧС"
::msgcat::mcset pb_msg_russian "MC(g_code,delay_sec,name)"              "Задержка (Секунды)"
::msgcat::mcset pb_msg_russian "MC(g_code,delay_rev,name)"              "Задержка (Обороты)"
...
::msgcat::mcset pb_msg_russian "MC(g_code,bore,name)"                   "Цикл развертки"
...
::msgcat::mcset pb_msg_russian "MC(g_code,reset,name)"                  "Восстановить"
...
::msgcat::mcset pb_msg_russian "MC(g_code,spindle_css,name)"            "Шпиндель CSS"
...
::msgcat::mcset pb_msg_russian "MC(g_code,feedmode,dpm)"                "Режим подачи ДвМ"
...
::msgcat::mcset pb_msg_russian "MC(m_code,spindle_clw,name)"            "Включение шпинделя/По по часовой стрелке"
...
::msgcat::mcset pb_msg_russian "MC(m_code,coolant_mist,name)"           "Смешанная подача СОЖ"
...
::msgcat::mcset pb_msg_russian "MC(m_code,fls_on,name)"                 "Прокачка выключена"
::msgcat::mcset pb_msg_russian "MC(m_code,fls_off,name)"                "Прокачка выключена"
::msgcat::mcset pb_msg_russian "MC(m_code,power_on,name)"               "Включение генератора"
::msgcat::mcset pb_msg_russian "MC(m_code,power_off,name)"              "Выключение генератора"
...
::msgcat::mcset pb_msg_russian "MC(m_code,pri_turret,name)"             "Первичный суппорт"
::msgcat::mcset pb_msg_russian "MC(m_code,sec_turret,name)"             "Вторичный суппорт"
...
::msgcat::mcset pb_msg_russian "MC(ude,editor,int,Context)"             "Добавляет новый целочисленный параметр при перемещении этого в правый список."

::msgcat::mcset pb_msg_russian "MC(ude,editor,real,Label)"              "Вещественное"
::msgcat::mcset pb_msg_russian "MC(ude,editor,real,Context)"            "Добавляет новый вещественный параметр при перемещении этого в правый список."

::msgcat::mcset pb_msg_russian "MC(ude,editor,txt,Label)"               "Текст"
::msgcat::mcset pb_msg_russian "MC(ude,editor,txt,Context)"             "Добавляет новый строковый параметр при перемещении этого в правый список."

::msgcat::mcset pb_msg_russian "MC(ude,editor,bln,Label)"               "Булевы"
::msgcat::mcset pb_msg_russian "MC(ude,editor,bln,Context)"             "Добавляет новый булевой параметр при перемещении этого в правый список."

::msgcat::mcset pb_msg_russian "MC(ude,editor,opt,Label)"               "Опция"
::msgcat::mcset pb_msg_russian "MC(ude,editor,opt,Context)"             "Добавляет новый опциональный параметр при перемещении этого в правый список."

::msgcat::mcset pb_msg_russian "MC(ude,editor,pnt,Label)"               "Точка"
::msgcat::mcset pb_msg_russian "MC(ude,editor,pnt,Context)"             "Добавляет новый параметр задания точки при перемещении этого в правый список."
...
::msgcat::mcset pb_msg_russian "MC(ude,editor,event,Context)"           "Вы можете изменить параметры события в меню на MB1."

::msgcat::mcset pb_msg_russian "MC(ude,editor,param,Label)"             "Событие -- параметры"
::msgcat::mcset pb_msg_russian "MC(ude,editor,param,Context)"           "Вы можете изменить любой параметр нажатием на правую клавишу мышки или изменить порядок параметров используя перемещение. \n \nПараметры отображаемые ярко-синим цветом являются системными, и эти параметры не могут быть удалены. \nПараметры отображаемые цветом старого дерева являются несистемными, и эти параметры могут быть удалены."

::msgcat::mcset pb_msg_russian "MC(ude,editor,param,edit,Label)"        "Параметры -- опция"
::msgcat::mcset pb_msg_russian "MC(ude,editor,param,edit,Context)"      "Нажмите клавишу мышки 1, чтобы выбрать опцию по умолчанию. \n Дважды нажмите на клавишу мышки 1, чтобы изменить опцию."
...
::msgcat::mcset pb_msg_russian "MC(ude,editor,paramdlg,TG,B,Context)"   "Выберите значение включения"
...
::msgcat::mcset pb_msg_russian "MC(ude,editor,paramdlg,CUT,Label)"      "Резания"
...
::msgcat::mcset pb_msg_russian "MC(ude,editor,eventdlg,PEN,C,Context)"  "Этот выключатель позволяет Вам задать имя постпроцессора"
...
::msgcat::mcset pb_msg_russian "MC(ude,editor,eventdlg,EL,C,Context)"   "Этот выключатель позволяет Вам, задать метку события"

::msgcat::mcset pb_msg_russian "MC(ude,editor,eventdlg,EC,Label)"           "Категория"
::msgcat::mcset pb_msg_russian "MC(ude,editor,eventdlg,EC,Context)"         "Этот выключатель позволяет Вам задать категорию"
::msgcat::mcset pb_msg_russian "MC(ude,editor,eventdlg,EC_MILL,Label)"      "Фрез."
::msgcat::mcset pb_msg_russian "MC(ude,editor,eventdlg,EC_DRILL,Label)"     "Сверление"
...
::msgcat::mcset pb_msg_russian "MC(ude,import,name_cdl,Label)"          "Имя CDL файла"

::msgcat::mcset pb_msg_russian "MC(ude,import,name_cdl,Context)"        "Путь и имя файла CDL, который связан с выбранным постпроцессором и на который будет создана ссылка (INCLUDE) в файл описания этого постпроцессора. Имя пути должно начаться с системной переменной UG (\\\$UGII) или не иметь пути. Когда путь не задан, будет использоваться переменная UGII_CAM_FILE_SEARCH_PATH, чтобы для поиска файла в сессии UG/NX."

::msgcat::mcset pb_msg_russian "MC(ude,import,name_def,Label)"          "Имя файла описания"
::msgcat::mcset pb_msg_russian "MC(ude,import,name_def,Context)"        "Путь и имя файла описания выбранного постпроцессора и на который будет создана ссылка (INCLUDE) в файл описания этого постпроцессора. Имя пути должно начаться с системной переменной UG (\\\$UGII) или не иметь пути. Когда путь не задан, будет использоваться переменная UGII_CAM_FILE_SEARCH_PATH, чтобы для поиска файла в сессии UG/NX."
...
::msgcat::mcset pb_msg_russian "MC(ude,import,own,Label)"               "Включить собственный CDL файл"
...
::msgcat::mcset pb_msg_russian "MC(ude,import,own_ent,Label)"           "Собственный CDL файл"

::msgcat::mcset pb_msg_russian "MC(ude,import,own_ent,Context)"         "Путь и имя файла CDL, который связан с выбранным постпроцессором и на который создана ссылка (INCLUDE) в файл описания этого постпроцессора. Имя пути должно начаться с системной переменной UG (\\\$UGII) или не иметь пути. Когда путь не задан, будет использоваться переменная UGII_CAM_FILE_SEARCH_PATH, чтобы для поиска файла в сессии UG/NX."

::msgcat::mcset pb_msg_russian "MC(ude,import,sel,pui,status)"          "Выбрать файл PUI"
::msgcat::mcset pb_msg_russian "MC(ude,import,sel,cdl,status)"          "Выбрать CDL файл"
...
::msgcat::mcset pb_msg_russian "MC(udc,editor,CYCLBL,C,Context)"        "Этот выключатель позволяет Вам, задать метку цикла"
...
::msgcat::mcset pb_msg_russian "MC(isv,setup,machine,Label)"            "Инструмент"
...
::msgcat::mcset pb_msg_russian "MC(isv,setup,spin_com,Context)"         "Задайте компонент, к которому будет крепится инструмент. Это должен быть компонент шпинделя для фрезерного постпроцессора и компонент револьвера для токарного постпроцессора."
...
::msgcat::mcset pb_msg_russian "MC(isv,setup,power_on_wcs,Label)"       "Включение генератора РСК  "
...
::msgcat::mcset pb_msg_russian "MC(isv,setup,use_f_leader,Label)"       "F используемый"
...
::msgcat::mcset pb_msg_russian "MC(isv,sign_define,rewindstop,Label)"   "Код конца программы с перемоткой"
::msgcat::mcset pb_msg_russian "MC(isv,sign_define,rewindstop,Context)" "Задайте код конце программы с перемоткой"

::msgcat::mcset pb_msg_russian "MC(isv,control_var,frame,Label)"        "Управление переменными"

::msgcat::mcset pb_msg_russian "MC(isv,sign_define,convarleader,Label)"     "Выноска"
...
::msgcat::mcset pb_msg_russian "MC(isv,sign_define,conequ,Context)"         "Задайте знак управления равенством"
::msgcat::mcset pb_msg_russian "MC(isv,sign_define,percent,Label)"          "Символ процента %"
::msgcat::mcset pb_msg_russian "MC(isv,sign_define,leaderjing,Label)"       "Острый #"
...
::msgcat::mcset pb_msg_russian "MC(isv,input_mode,Label)"               "Режим в начале"
...
::msgcat::mcset pb_msg_russian "MC(isv,incremental_uvw,Label)"          "Специальный лидер"
...
::msgcat::mcset pb_msg_russian "MC(isv,incr_a,Label)"                   "Четвертая ось "
::msgcat::mcset pb_msg_russian "MC(isv,incr_b,Label)"                   "Пятая ось "
...
::msgcat::mcset pb_msg_russian "MC(isv,wcs_offset,wcs_add,Context)"     "Добавьте новую систему координат смещения прижима, задайте ее позицию"
::msgcat::mcset pb_msg_russian "MC(isv,wcs_offset,wcs_err,Msg)"         "Этот номер системы координат уже существует!"
::msgcat::mcset pb_msg_russian "MC(isv,tool_info,frame,Label)"          "Информация о инструменте"
...
::msgcat::mcset pb_msg_russian "MC(isv,tool_info,carrier_id,Label)"     " Идентификатор суппорта "
...
::msgcat::mcset pb_msg_russian "MC(isv,g_code,from_home,Label)"         "From Home"
::msgcat::mcset pb_msg_russian "MC(isv,g_code,return_home,Label)"       "Возврат в точку Home"
::msgcat::mcset pb_msg_russian "MC(isv,g_code,mach_wcs,Label)"          "Перемещение базы станка"
...
::msgcat::mcset pb_msg_russian "MC(isv,spec_pre,frame,Label)"           "Команды предпроцессора"
...
::msgcat::mcset pb_msg_russian "MC(isv,spec_command,preleader,Label)"   "Выноска"
::msgcat::mcset pb_msg_russian "MC(isv,spec_command,preleader,Context)" "Задайте адрес для постпроцессорной команды задаваемой пользователем."

::msgcat::mcset pb_msg_russian "MC(isv,spec_command,precode,Label)"     "Код"
::msgcat::mcset pb_msg_russian "MC(isv,spec_command,precode,Context)"   "Задайте адрес для постпроцессорной команды задаваемой пользователем."

::msgcat::mcset pb_msg_russian "MC(isv,spec_command,leader,Label)"      "Выноска"
...
::msgcat::mcset pb_msg_russian "MC(isv,ex_editor,warning,Msg)"          "Это генерируемая системой команда VNC. Изменения не будут сохранены."
...
### Exit Options Dialog
::msgcat::mcset pb_msg_russian "MC(exit,options,Label)"                 "Опции вывода"
...
::msgcat::mcset pb_msg_russian "MC(optionMenu,item,RS)"          "Ускоренное вдоль оси шпинделя"
::msgcat::mcset pb_msg_russian "MC(optionMenu,item,C_off_RS)"    "Выключение цикла при ускоренном перемещении"
...
::msgcat::mcset pb_msg_russian "MC(optionMenu,item,AP)"          "Всегда отрицательный"
::msgcat::mcset pb_msg_russian "MC(optionMenu,item,AN)"          "Всегда положительный"
