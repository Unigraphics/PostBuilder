...
::msgcat::mcset pb_msg_italian "MC(main,windows,Balloon)"               "L'elenco di post modifica"
...
::msgcat::mcset pb_msg_italian "MC(main,options,advisor,Context)"       "Abilita/disabilita Post Advisor."
...
::msgcat::mcset pb_msg_italian "MC(main,options,cmd_check,Context)"     "Switch di convalida comandi personalizzati"
...
::msgcat::mcset pb_msg_italian "MC(main,options,backup,Balloon)"        "Metodo di backup post"
...
::msgcat::mcset pb_msg_italian "MC(main,help,bal,Context)"              "Abilita/disabilita la visualizzazione delle descrizioni sulle icone"
...
::msgcat::mcset pb_msg_italian "MC(tool,bal,Context)"                   "Abilita/disabilita la visualizzazione delle descrizioni sulle icone"
...
::msgcat::mcset pb_msg_italian "MC(msg,user_ctrl_limit)"                "Non è possibile usare un post con licenza come controller\n per creare un nuovo post, se non se ne è l'autore."
::msgcat::mcset pb_msg_italian "MC(msg,import_limit)"                   "L'utente non è l'autore di questo post con licenza.\nNon è possibile importare i comandi personalizzati."
::msgcat::mcset pb_msg_italian "MC(msg,limit_msg)"                      "L'utente non è l'autore di questo post con licenza."
::msgcat::mcset pb_msg_italian "MC(msg,no_file)"                        "Manca il file codificato per questo post con licenza."
::msgcat::mcset pb_msg_italian "MC(msg,no_license)"                     "Non si dispone della licenza necessaria per eseguire questa funzione."
::msgcat::mcset pb_msg_italian "MC(msg,no_license_title)"               "Uso di UG/Post Builder senza licenza"
::msgcat::mcset pb_msg_italian "MC(msg,no_license_dialog)"              "È consentito usare l'UG/Post Builder\n senza licenza. Non è però consentito\n salvare il lavoro eseguito."
::msgcat::mcset pb_msg_italian "MC(msg,pending)"                        "Questa opzione verrà implementata nella prossima release."
...
::msgcat::mcset pb_msg_italian "MC(msg,dir_perm)"                       "Non si dispone delle autorizzazioni di scrittura necessarie per questa directory."
...
::msgcat::mcset pb_msg_italian "MC(msg,file_missing)"                   "Mancano uno o tutti i file per questo post.\nNon è possibile aprire il post."
...
::msgcat::mcset pb_msg_italian "MC(msg,do_you_want_to_proceed)"         "Possono essere considerati elementi di dati esistenti. Continuare."
...
::msgcat::mcset pb_msg_italian "MC(msg,close_subwin)"                   "Chiudere tutte le sottofinestre per attivare questa scheda."
...
::msgcat::mcset pb_msg_italian "MC(msg,cdl_info)"                       "I file di definizione e CDL del post selezionato vengono referenziati (INCLUDE) nel file di definizione di questo post.\nIl file Tcl del post selezionato verrà anche referenziato dal file dell'handler eventi durante l'esecuzione."
...
##
::msgcat::mcset pb_msg_italian "MC(nav_button,no_license,Message)"      "Non si dispone della licenza necessaria per eseguire questa funzione."

::msgcat::mcset pb_msg_italian "MC(nav_button,ok,Label)"                "OK"
::msgcat::mcset pb_msg_italian "MC(nav_button,ok,Context)"              "Questo pulsante è disponibile solo come sottodialogo. Consente di salvare le modifiche e uscire dal dialogo."
::msgcat::mcset pb_msg_italian "MC(nav_button,cancel,Label)"            "Annulla"
::msgcat::mcset pb_msg_italian "MC(nav_button,cancel,Context)"          "Questo pulsante è disponibile nei sottodialoghi. Consente di uscire dal dialogo."
::msgcat::mcset pb_msg_italian "MC(nav_button,default,Label)"           "Predefinito"
::msgcat::mcset pb_msg_italian "MC(nav_button,default,Context)"         "Questo pulsante consente di ripristinare i parametri del dialogo attuale di un componente ricreando la condizione presente al momento di creazione o apertura del post durante questa sessione. \n \nTuttavia, per il nome di questo componente (se presente), verrà ripristinato solo lo stato del nome riscontrato al momento dell'apertura del componente durante questa operazione."
::msgcat::mcset pb_msg_italian "MC(nav_button,restore,Label)"           "Ripristina"
::msgcat::mcset pb_msg_italian "MC(nav_button,restore,Context)"         "Questo pulsante consente di ripristinare i parametri del dialogo attuale presenti nelle impostazioni iniziali al momento dell'accesso corrente al componente.  "
::msgcat::mcset pb_msg_italian "MC(nav_button,apply,Label)"             "Applica"
::msgcat::mcset pb_msg_italian "MC(nav_button,apply,Context)"           "Questo pulsante consente di salvare le modifiche senza chiudere il dialogo attuale. Questa operazione permette anche di ripristinare le condizioni iniziali del dialogo attuale. \n \n(Vedere Ripristina per le condizioni iniziali)"
::msgcat::mcset pb_msg_italian "MC(nav_button,filter,Label)"            "Filtro"
::msgcat::mcset pb_msg_italian "MC(nav_button,filter,Context)"          "Questo pulsante consente di applicare il filtro della directory e di elencare i file che rispondono alle condizioni."
...
::msgcat::mcset pb_msg_italian "MC(nav_button,open,Context)"            "Questo pulsante consente di aprire il post selezionato per le modifiche."

::msgcat::mcset pb_msg_italian "MC(nav_button,save,Label)"              "Salva"
::msgcat::mcset pb_msg_italian "MC(nav_button,save,Context)"            "Questo pulsante disponibile nel dialogo Salva con nome consente di salvare il post in elaborazione."

::msgcat::mcset pb_msg_italian "MC(nav_button,manage,Label)"            "Gestisci..."
::msgcat::mcset pb_msg_italian "MC(nav_button,manage,Context)"          "Questo pulsante consente di gestire la cronistoria dei post aperti di recente."

::msgcat::mcset pb_msg_italian "MC(nav_button,refresh,Label)"           "Aggiorna"
::msgcat::mcset pb_msg_italian "MC(nav_button,refresh,Context)"         "Questo pulsante consente di aggiornare l'elenco in funzione dell'esistenza degli oggetti."

::msgcat::mcset pb_msg_italian "MC(nav_button,cut,Label)"               "Taglio"
::msgcat::mcset pb_msg_italian "MC(nav_button,cut,Context)"             "Questo pulsante consente di 'tagliare' dall'elenco l'oggetto selezionato."

::msgcat::mcset pb_msg_italian "MC(nav_button,copy,Label)"              "Copia"
::msgcat::mcset pb_msg_italian "MC(nav_button,copy,Context)"            "Questo pulsante consente di copiare l'oggetto selezionato."

::msgcat::mcset pb_msg_italian "MC(nav_button,paste,Label)"             "Incolla"
::msgcat::mcset pb_msg_italian "MC(nav_button,paste,Context)"           "Questo pulsante consente di incollare l'oggetto del buffer nell'elenco. "

::msgcat::mcset pb_msg_italian "MC(nav_button,edit,Label)"              "Modifica"
::msgcat::mcset pb_msg_italian "MC(nav_button,edit,Context)"            "Questo pulsante di modificare l'oggetto nel buffer."
...
::msgcat::mcset pb_msg_italian "MC(inposts,title,Label)"                "Installa i post"
...
::msgcat::mcset pb_msg_italian "MC(machine,display,Context)"            "Questa opzione consente di visualizzare la macchina utensile"
...
::msgcat::mcset pb_msg_italian "MC(machine,gen,circle_record,no,Context)"   "Output record circolare."
...
::msgcat::mcset pb_msg_italian "MC(machine,gen,turret,conf,Context)"        "In modalità Due torrette, questa opzione consente di configurare i parametri."
...
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,dia,Context)"     "Queste opzioni consentono di attivare la programmazione diametro raddoppiando il valore degli indirizzi selezionati nell'output NC."
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,2x,Label)"        "2X"
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,2x,Context)"      "Questo switch consente di attivare la programmazione diametro raddoppiando le coordinate asse X nell'output NC."

::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,2y,Label)"        "2Y"
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,2y,Context)"      "Questo switch consente di attivare la programmazione diametro raddoppiando le coordinate asse Y nell'output NC."
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,2i,Label)"        "2I"
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,2i,Context)"      "Questo switch consente di raddoppiare i valori di I per i record circolari durante l'uso della programmazione diametro."
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,2j,Label)"        "2J"
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,2j,Context)"      "Questo switch consente di raddoppiare i valori di J per i record circolari durante l'uso della programmazione diametro."

::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,mir,Label)"       "Copia speculare output"
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,mir,Context)"     "Queste opzioni consentono di eseguire una copia speculare degli indirizzi selezionati trasformandone i valori in valori negativi nell'output NC."
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,x,Label)"         "-X"
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,x,Context)"       "Questo switch consente di trasformare le coordinate dell'asse X nelle corrispondenti coordinate negative nell'output NC."
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,y,Label)"         "-Y"
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,y,Context)"       "Questo switch consente di trasformare le coordinate dell'asse Y nelle corrispondenti coordinate negative nell'output NC."
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,z,Label)"         "-Z"
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,z,Context)"       "Questo switch consente di trasformare le coordinate dell'asse Z nelle corrispondenti coordinate negative nell'output NC."
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,i,Label)"         "-I"
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,i,Context)"       "Questo switch consente di trasformare i valori di I dei record circolari nei corrispondenti valori negativi nell'output NC."
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,j,Label)"         "-J"
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,j,Context)"       "Questo switch consente di trasformare i valori di J dei record circolari nei corrispondenti valori negativi nell'output NC."
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,k,Label)"         "-K"
::msgcat::mcset pb_msg_italian "MC(machine,gen,axis_multi,k,Context)"       "Questo switch consente di trasformare i valori di K dei record circolari nei corrispondenti valori negativi nell'output NC."
...
::msgcat::mcset pb_msg_italian "MC(machine,gen,turret_chg,msg)"             "La modifica di questa opzione potrebbe comportare l'aggiunta o l'eliminazione di un blocco G92 negli eventi Cambio utensile."
# Entries for XZC/Mill-Turn
::msgcat::mcset pb_msg_italian "MC(machine,gen,spindle_axis,Label)"             "Asse mandrino iniziale"
::msgcat::mcset pb_msg_italian "MC(machine,gen,spindle_axis,Context)"           "L'asse mandrino iniziale dell'untesile di fresatura può essere specificato come parallelo all'asse Z oppure perpendicolare all'asse Z. L'asse utensile dell'operazione deve corrispondere all'asse mandrino specificato. Si verifica un errore se il post non si può posizionare sull'asse mandrino specificato.\nQuesto vettore può essere ridefinito dall'asse mandrino specificato con un oggetto Testa."

::msgcat::mcset pb_msg_italian "MC(machine,gen,position_in_yaxis,Label)"        "Posizione nell'asse Y"
::msgcat::mcset pb_msg_italian "MC(machine,gen,position_in_yaxis,Context)"      "La macchina ha un asse Y programmabile che può essere posizionato durante le operazioni di contornatura. Questa opzione può essere usata solo quanto l'asse mandrino non corrisponde all'asse Z."
...
::msgcat::mcset pb_msg_italian "MC(machine,gen,mach_mode,mill_turn,Context)"    "Questo post di fresatura XZC è collegato ad un post di tornitura e viene usato con un programma che contiene operazioni di fresatura e di tornitura. Il tipo di operazione determina quale post usare per produrre gli output NC."
...
::msgcat::mcset pb_msg_italian "MC(machine,gen,lathe_post,select_name,Context)" "Consente di selezionare il nome del post di tornitura da usare in un post di fresatura/tornitura semplice. Se il post non si trova nella directory \\\$UGII_CAM_POST_DIR in UG/Post run-time, viene usato un post con lo stesso nome presente nella directory di salvataggio del post di fresatura."

::msgcat::mcset pb_msg_italian "MC(machine,gen,coord_mode,Label)"               "Modalità coordinate predefinite"
::msgcat::mcset pb_msg_italian "MC(machine,gen,coord_mode,Context)"             "Questa opzione consente di definire le impostazioni iniziali per le coordinate di output come polari (XZC) o cartesiane (XYZ). Questa modalità può essere modificata intervenendo sull'UDE \\\"SET/POLAR, ON\\\" programmato con le operazioni."
...
::msgcat::mcset pb_msg_italian "MC(machine,gen,xzc_arc_mode,Context)"           "Questa opzione consente di definire la modalità polare (XCR) oppure cartesiana (XYIJ) per l'output dei record circolari. "
...
::msgcat::mcset pb_msg_italian "MC(machine,axis,con_motion,combine,Context)"    "Questo switch consente di attivare/disattivare la linearizzazione. Attiva/disattiva l'opzione Tolleranza."
::msgcat::mcset pb_msg_italian "MC(machine,axis,con_motion,tol,Label)"      "Tolleranza"
::msgcat::mcset pb_msg_italian "MC(machine,axis,con_motion,tol,Context)"    "Questa opzione viene attivata solo se lo switch Combinato è attivo. Specifica la Tolleranza."
...
::msgcat::mcset pb_msg_italian "MC(machine,axis,incr_text)"                 "Questo asse di rotazione può essere incrementale"
...
::msgcat::mcset pb_msg_italian "MC(machine,axis,leader,Context)"            "Specificare il Word Leader."

::msgcat::mcset pb_msg_italian "MC(machine,axis,config,Label)"              "Configura"
::msgcat::mcset pb_msg_italian "MC(machine,axis,config,Context)"            "Questa opzione consente di definire il quarto e il quinto parametro."
...
::msgcat::mcset pb_msg_italian "MC(machine,axis,rotary_lintol,Context)"     "Questo valore viene usato come tolleranza predefinita per linearizzare i movimenti lineari nel momento in cui viene specificato un comando post LINTOL/ON con le operazioni attuali o precedenti. Il comando LINTOL/ può anche specificare una tolleranza di linearizzazione diversa."
...
::msgcat::mcset pb_msg_italian "MC(prog,plus,Label)"                    "Programma -- riduci/espandi switch"
...
::msgcat::mcset pb_msg_italian "MC(prog,nc_code,Context)"               "Il testo contenuto in questo riquadro visualizza il codice NC di cui eseguire l'output in questo contrassegno o da questo evento."
...
::msgcat::mcset pb_msg_italian "MC(tool,event_seq,button,Label)"        "Seleziona un template evento"
::msgcat::mcset pb_msg_italian "MC(tool,add_word,button,Label)"         "Aggiungi parola"

::msgcat::mcset pb_msg_italian "MC(tool,format_trans,title,Label)"      "FORMAT"
...
::msgcat::mcset pb_msg_italian "MC(tool,ijk_desc,u_arc_start,Label)"        "Inizio arco a centro senza firma"
...
::msgcat::mcset pb_msg_italian "MC(addrsum,addr_trans,title,Label)"     "WORD"
...
::msgcat::mcset pb_msg_italian "MC(wseq,transient_win,Label)"           "WORD"
...
::msgcat::mcset pb_msg_italian "MC(cust_cmd,name_msg_1)"                "è riservato per alcuni specifici comandi personalizzati.\nImmettere un altro nome"
...
::msgcat::mcset pb_msg_italian "MC(cust_cmd,import,tree,Context)"       "Questo elenco contiene le procedure relative ai comandi personalizzati e altre procedure Tcl che si trovano nel file da importare. È possibile visualizzare in anteprima il contenuto di ogni procedura facendo clic con il pulsante sinistro del mouse sull'oggetto da selezionare. Tutte le procedure già presenti nel post in corso vengono identificate con il messaggio <esiste>. Facendo doppio clic con il pulsante sinistro del mouse su un oggetto si attiva la casella di controllo vicina all'oggetto. Questa operazione consente di selezionare o deselezionare la procedura da importare. Per impostazione predefinita, tutte le procedure vengono selezionate per l'esportazione. È possibile deselezionare gli oggetti per evitare di sovrascrivere operazioni esistenti."

::msgcat::mcset pb_msg_italian "MC(cust_cmd,export,tree,Label)"         "Esporta comandi personalizzati"
::msgcat::mcset pb_msg_italian "MC(cust_cmd,export,tree,Context)"       "Questo elenco contiene le procedure relative ai comandi personalizzati e altre procedure Tcl che si trovano nel file post da importare. È possibile visualizzare in anteprima il contenuto di ogni procedura facendo clic con il pulsante sinistro del mouse sull'oggetto da selezionare. Facendo doppio clic con il pulsante sinistro del mouse su un oggetto si attiva la casella di controllo vicina all'oggetto. Questa operazione consente di selezionare solo le procedure da importare."

::msgcat::mcset pb_msg_italian "MC(cust_cmd,error,title)"               "Errore comando personalizzato"
::msgcat::mcset pb_msg_italian "MC(cust_cmd,error,msg)"                 "La convalida dei comandi personalizzati può essere attivata o disattivata impostando gli switch della voce di menu a discesa \"Optioni->Convalida comandi personalizzati\"."
...
::msgcat::mcset pb_msg_italian "MC(cust_cmd,save_post,msg)"             "Salvare comunque questo post?"
...
::msgcat::mcset pb_msg_italian "MC(link_post,head,Context)"             "Una macchina utensile complessa può eseguire lavorazioni che usano gruppi diversi di cinematica in modalità di lavorazione diverse. Ogni gruppo di cinematica viene considerato come Testa indipendente da UG/Post. Le operazioni di lavorazione da eseguire con una testa specifica vengono raggruppate nella vista Macchina utensile oppure nella vista Metodo di lavorazione. Una \\\"Testa\\\" UDE viene quindi assegnata al gruppo per indicare il nome corrispondente."
...
::msgcat::mcset pb_msg_italian "MC(link_post,delete,Context)"           "Eliminare un collegamenti."

::msgcat::mcset pb_msg_italian "MC(link_post,select_name,Label)"        "Seleziona nome"
::msgcat::mcset pb_msg_italian "MC(link_post,select_name,Context)"      "Selezionare il nome del post da assegnare alla testa. Il post dovrebbe trovarsi nella stessa directory del post principale durante l'esecuzione UG/Post, in caso contrario viene usato un post con lo stesso nome presente nella directory \\\$UGII_CAM_POST_DIR."
...
## BLOCK
##
::msgcat::mcset pb_msg_italian "MC(block,tab,Label)"                    "BLOCK"
...
::msgcat::mcset pb_msg_italian "MC(block,add,Context)"                  "Per aggiungere una nuova parola ad un blocco, premere questo pulsante e trascinarlo nel blocco visualizzato nella finestra sottostante. Il tipo di parola creata viene selezionata dall'elenco situato nel lato destro di questo pulsante."

::msgcat::mcset pb_msg_italian "MC(block,select,Label)"                 "BLOCK -- selezione parola"
...
::msgcat::mcset pb_msg_italian "MC(block,trash,Label)"                  "BLOCK -- cestino"
::msgcat::mcset pb_msg_italian "MC(block,trash,Context)"                "Le parole da eliminare da un blocco possono essere trascinate in questo cestino."

::msgcat::mcset pb_msg_italian "MC(block,word,Label)"                   "BLOCK -- parola"
...
::msgcat::mcset pb_msg_italian "MC(block,verify,Label)"                 "BLOCK -- controllo parola"
::msgcat::mcset pb_msg_italian "MC(block,verify,Context)"               "Questa finestra visualizza il codice NC rappresentativo da stampare, per una parola selezionata, nel blocco visualizzato nella finestra sovrastante."
...
::msgcat::mcset pb_msg_italian "MC(block,addr_title,Label)"             "WORD"

::msgcat::mcset pb_msg_italian "MC(block,new_trans,title,Label)"        "WORD"
...
## ADDRESS
##
::msgcat::mcset pb_msg_italian "MC(address,tab,Label)"                  "WORD"
...
::msgcat::mcset pb_msg_italian "MC(address,verify,Label)"               "WORD -- controllo"
::msgcat::mcset pb_msg_italian "MC(address,verify,Context)"             "Questa finestra visualizza il codice NC rappresentativo da stampare in un finestra."
...
::msgcat::mcset pb_msg_italian "MC(address,format,edit,Context)"        "Questo pulsante consente di modificare il formato usato da  una parola."
::msgcat::mcset pb_msg_italian "MC(address,format,new,Label)"           "Nuovo"
::msgcat::mcset pb_msg_italian "MC(address,format,new,Context)"         "Questo pulsante consente di creare un nuovo formato."

::msgcat::mcset pb_msg_italian "MC(address,format,select,Label)"        "WORD -- seleziona formato"
::msgcat::mcset pb_msg_italian "MC(address,format,select,Context)"      "Questo pulsante consente di selezionare un altro formato per una parola."
...
::msgcat::mcset pb_msg_italian "MC(address,modality,Context)"           "Questa opzione consente di impostare la modalità di una parola."
...
::msgcat::mcset pb_msg_italian "MC(address,max,error_handle,Context)"   "Questo pulsante consente di specificare il metodo con cui gestire eventuali violazione del valore massimo: \n \n * Tronca valore \n * Avvisa utente \n * Interrompi procedura \n"
...
::msgcat::mcset pb_msg_italian "MC(address,min,error_handle,Context)"   "Questo pulsante consente di specificare il metodo con cui gestire eventuali violazione del valore minimo:\n \n * Tronca valore \n * Avvisa utente \n * Interrompi procedura \n"

::msgcat::mcset pb_msg_italian "MC(address,format_trans,title,Label)"   "FORMAT "
...
## FORMAT
##
::msgcat::mcset pb_msg_italian "MC(format,tab,Label)"                   "FORMAT"
::msgcat::mcset pb_msg_italian "MC(format,Status)"                      "Definisce i formati"

::msgcat::mcset pb_msg_italian "MC(format,verify,Label)"                "FORMAT -- controllo"
::msgcat::mcset pb_msg_italian "MC(format,verify,Context)"              "Questa finestra visualizza il codice NC rappresentativo da stampare usando il formato specificato."
...
::msgcat::mcset pb_msg_italian "MC(format,data,num,Context)"            "Questa opzione consente di definire il tipo di dati di un formato come Numerico."
::msgcat::mcset pb_msg_italian "MC(format,data,num,integer,Label)"      "FORMAT -- cifre di un numero intero"
::msgcat::mcset pb_msg_italian "MC(format,data,num,integer,Context)"    "Questa opzione consente di specificare il numero di cifre di un numero intero oppure la parte numero intero di un numero reale."
::msgcat::mcset pb_msg_italian "MC(format,data,num,fraction,Label)"     "FORMAT -- cifre di una frazione"
::msgcat::mcset pb_msg_italian "MC(format,data,num,fraction,Context)"   "Questa opzione consente di specificare il numero di cifre della parte frazionale di un numero reale."
::msgcat::mcset pb_msg_italian "MC(format,data,num,decimal,Label)"      "Punto decimale di output (.) "
::msgcat::mcset pb_msg_italian "MC(format,data,num,decimal,Context)"    "Questa opzione consente di effettuare l'output di punti decimali nel codice NC."
::msgcat::mcset pb_msg_italian "MC(format,data,num,lead,Label)"         "Zeri iniziali di output"
::msgcat::mcset pb_msg_italian "MC(format,data,num,lead,Context)"       "Questa opzione consente di aggiungere zeri iniziali ai numeri specificati in codice NC."
::msgcat::mcset pb_msg_italian "MC(format,data,num,trail,Label)"        "Zeri finali di output"
::msgcat::mcset pb_msg_italian "MC(format,data,num,trail,Context)"      "Questa opzione consente di aggiungere zeri finali ai numeri reali specificati in codice NC."
::msgcat::mcset pb_msg_italian "MC(format,data,text,Label)"             "Testo"
::msgcat::mcset pb_msg_italian "MC(format,data,text,Context)"           "Questa operazione definisce il tipo di dati di un formato come stringa di testo."
::msgcat::mcset pb_msg_italian "MC(format,data,plus,Label)"             "Segno più iniziale di output (+)"
::msgcat::mcset pb_msg_italian "MC(format,data,plus,Context)"           "Questa operazione consente di effettuare l'output dei segni più nel codice NC."
...
::msgcat::mcset pb_msg_italian "MC(format,error,msg)"                   "Questo formato è stato usato negli indirizzi"
...
::msgcat::mcset pb_msg_italian "MC(other,seq_num,Context)"              "Questo switch consente di attivare/disattivare l'output dei numeri di sequenza in codice NC."
...
::msgcat::mcset pb_msg_italian "MC(other,g_codes,Context)"              "Questo switch consente all'operatore di attivare/disattivare il controllo del numero di codici G per blocco di output NC."
...
::msgcat::mcset pb_msg_italian "MC(other,m_codes,Context)"              "Questo switch consente all'operatore di attivare/disattivare il controllo del numero di codici M per blocco di output NC."
...
::msgcat::mcset pb_msg_italian "MC(other,opt_left,Label)"               "Parentesi sinistra ("
::msgcat::mcset pb_msg_italian "MC(other,opt_right,Label)"              "Parentesi destra )"
...
::msgcat::mcset pb_msg_italian "MC(other,ude_include,Context)"          "Questa opzione abilita il post ad includere riferimenti ad un file CDL nel file di definizioni."

::msgcat::mcset pb_msg_italian "MC(other,ude_file,Label)"               "Nome file CDL"
::msgcat::mcset pb_msg_italian "MC(other,ude_file,Context)"             "Percorso e nome di un file CDL da referenziare (INCLUDE) nel file di definizioni di questo post. Il nome percorso deve iniziare con una variable di ambiente UG (\\\$UGII). Quando non viene specificato un percorso, UGII_CAM_FILE_SEARCH_PATH verrà usato da UG/NX per individuare il file durante l'esecuzione."
...
::msgcat::mcset pb_msg_italian "MC(output,vnc,mode,std,Label)"          "Standalone"
...
::msgcat::mcset pb_msg_italian "MC(output,vnc,output,Context)"          "Questa opzione consente di generare un controller virtuale NC (VNC). Un post creato con VNC può essere usato per ISV."
...
::msgcat::mcset pb_msg_italian "MC(output,vnc,mode,Context)"                 "Un controller virtuale NC può essere standalone oppure subordinato ad una VNC master."
::msgcat::mcset pb_msg_italian "MC(output,vnc,mode,std,Context)"             "Un VNC standalone è un'unità a se stante."
...
::msgcat::mcset pb_msg_italian "MC(listing,gen,Context)"                "Questo switch consente di attivare/disattivare l'output del file elenco."
...
::msgcat::mcset pb_msg_italian "MC(listing,parms,x,Context)"            "Questo switch consente di attivare/disattivare l'output della coordinata X nel file elenco."

::msgcat::mcset pb_msg_italian "MC(listing,parms,y,Label)"              "Coordinata Y"
::msgcat::mcset pb_msg_italian "MC(listing,parms,y,Context)"            "Questo switch consenete di attivare/disattivare l'output della coordinata Y nel file elenco."

::msgcat::mcset pb_msg_italian "MC(listing,parms,z,Label)"              "Coordinata Z"
::msgcat::mcset pb_msg_italian "MC(listing,parms,z,Context)"            "Questo switch consenete di attivare/disattivare l'output della coordinata Z nel file elenco."

::msgcat::mcset pb_msg_italian "MC(listing,parms,4,Label)"              "Angolo quarto asse"
::msgcat::mcset pb_msg_italian "MC(listing,parms,4,Context)"            "Questo switch consente di attivare/disattivare l'ouput del quarto angolo nel file elenco."

::msgcat::mcset pb_msg_italian "MC(listing,parms,5,Label)"              "Angolo quinto asse"
::msgcat::mcset pb_msg_italian "MC(listing,parms,5,Context)"            "Questo switch consente di attivare/disattivare l'ouput del quinto angolo nel file elenco."

::msgcat::mcset pb_msg_italian "MC(listing,parms,feed,Label)"           "Avanzamento"
::msgcat::mcset pb_msg_italian "MC(listing,parms,feed,Context)"         "Questo switch consente di attivare/disattivare l'output  avanzamento nel file elenco."

::msgcat::mcset pb_msg_italian "MC(listing,parms,speed,Label)"          "Velocità"
::msgcat::mcset pb_msg_italian "MC(listing,parms,speed,Context)"        "Questo switch consente di attivare/disattivare l'output velocità mandrino nel file elenco."
...
::msgcat::mcset pb_msg_italian "MC(listing,format,print_header,Context)"    "Questo switch consente di attivare/disattivare l'output dell'intestazione di pagina in un file elenco."
...
::msgcat::mcset pb_msg_italian "MC(listing,output,warning,Context)"     "Questo switch consente di attivare/disattivare l'output di messaggi di avviso durante il postprocessamento. "

::msgcat::mcset pb_msg_italian "MC(listing,output,review,Label)"        "Attiva strumento di revisione"
::msgcat::mcset pb_msg_italian "MC(listing,output,review,Context)"      "Questo switch consente di attivare/disattivare lo strumento di revisione durante il postprocessamento."

::msgcat::mcset pb_msg_italian "MC(listing,output,group,Label)"         "Genera output gruppo"
::msgcat::mcset pb_msg_italian "MC(listing,output,group,Context)"       "Questo switch consente di attivare/disattivare il controllo dell'output gruppo durante il postprocessamento."

::msgcat::mcset pb_msg_italian "MC(listing,output,verbose,Label)"       "Visualizza messaggi di errore dettagliati"
::msgcat::mcset pb_msg_italian "MC(listing,output,verbose,Context)"     "Questo switch consente di visualizzare le descrizioni dettagliate delle condizioni di errore. Attivando questa opzione si rallentano leggermente le operazioni di postprocessamento."
...
::msgcat::mcset pb_msg_italian "MC(listing,user_tcl,check,Context)"     "Questo switch consente di referenziare i propri file Tcl."
::msgcat::mcset pb_msg_italian "MC(listing,user_tcl,name,Label)"        "Nome file"
::msgcat::mcset pb_msg_italian "MC(listing,user_tcl,name,Context)"      "Specificare il nome di un file Tcl da referenziare durante questo post."
...
## Event Handler
##
::msgcat::mcset pb_msg_italian "MC(event_handler,tab,Label)"            "Gestore eventi"
::msgcat::mcset pb_msg_italian "MC(event_handler,Status)"               "Scegliere l'evento per visualizzare la procedura"

##---------------------
## Definition
##
::msgcat::mcset pb_msg_italian "MC(definition,tab,Label)"               "Definizioni"
::msgcat::mcset pb_msg_italian "MC(definition,Status)"                  "Scegliere l'oggetto per visualizzarne il contenuto"
...
::msgcat::mcset pb_msg_italian "MC(definition,format_txt,Label)"        "FORMAT"
::msgcat::mcset pb_msg_italian "MC(definition,addr_txt,Label)"          "WORD"
::msgcat::mcset pb_msg_italian "MC(definition,block_txt,Label)"         "BLOCK"
::msgcat::mcset pb_msg_italian "MC(definition,comp_txt,Label)"          "BLOCK composito"
::msgcat::mcset pb_msg_italian "MC(definition,post_txt,Label)"          "BLOCK Post"
...
::msgcat::mcset pb_msg_italian "MC(event,coolant_on,m_code,mist)"       "Nebbia"
...
### Coolant Off
::msgcat::mcset pb_msg_italian "MC(event,coolant_off,name)"             "Refrigerante disattivo"
...
::msgcat::mcset pb_msg_italian "MC(event,lathe,decr)"                   "Descrementale"
...
::msgcat::mcset pb_msg_italian "MC(event,cycle,customize,Context)"      "Questo switch consente di personalizzare un ciclo. \n\nPer impostazione predefinita, il vincolo di base è definito per ogni ciclo dalle impostazioni dei parametri comuni. Questi elementi comuni ad ogni ciclo non sono modificabili. \n\nAbilitando questo switch, si ottiene il controllo completo della configurazione di un ciclo. Le modifiche apportate ai parametri comuni non hanno effetto su alcun ciclo personalizzato."
::msgcat::mcset pb_msg_italian "MC(event,cycle,start,Label)"            "Inizio ciclo"
::msgcat::mcset pb_msg_italian "MC(event,cycle,start,Context)"          "Questa opzione può attivata per le macchine utensili che eseguono cicli basati su un blocco iniziale (G79...) dopo che il ciclo è stato definito (G81...)."
...
::msgcat::mcset pb_msg_italian "MC(m_code,tc_retract,name)"             "Cambio/stacco utensiole"
...
::msgcat::mcset pb_msg_italian "MC(m_code,coolant_mist,name)"           "Nebbia d'olio"
...
::msgcat::mcset pb_msg_italian "MC(ude,editor,enable,as_saved,Label)"   "Come salvato"
...
::msgcat::mcset pb_msg_italian "MC(ude,editor,bln,Label)"               "Booleana"
...
::msgcat::mcset pb_msg_italian "MC(ude,editor,trash,Context)"           "I parametri da eliminare dall'elenco sulla destra possono essere trascinati in questo cestino."
...
::msgcat::mcset pb_msg_italian "MC(ude,editor,param,Context)"           "Mdoificare ogni parametro facendo clic sul pulsante destro del mouse oppure modificare l'ordine dei parametri con un'operazione Trascina e rilascia.\n \nIl parametro azzurro è definito dal sistema e non può essere eliminato. \nIl parametro color nocciola non è definito dal sistema e può quindi essere modificato o eliminato."
...
::msgcat::mcset pb_msg_italian "MC(ude,editor,paramdlg,TG)"             "Toggle"
::msgcat::mcset pb_msg_italian "MC(ude,editor,paramdlg,TG,B,Label)"     "Toggle"
::msgcat::mcset pb_msg_italian "MC(ude,editor,paramdlg,TG,B,Context)"   "Selezionare il valore di attivazione"
::msgcat::mcset pb_msg_italian "MC(ude,editor,paramdlg,ON,Label)"       "Attivo"
::msgcat::mcset pb_msg_italian "MC(ude,editor,paramdlg,OFF,Label)"      "Inattivo"
...
::msgcat::mcset pb_msg_italian "MC(ude,editor,eventdlg,PEN,C,Context)"  "Questo switch consente di impostare il nome post"
...
::msgcat::mcset pb_msg_italian "MC(ude,editor,eventdlg,EL,C,Context)"   "Questo switch consente di impostare l'etichetta evento"

::msgcat::mcset pb_msg_italian "MC(ude,editor,eventdlg,EC,Label)"           "Categoria"
::msgcat::mcset pb_msg_italian "MC(ude,editor,eventdlg,EC,Context)"         "Questo switch consente di impostare la categoria"
...
::msgcat::mcset pb_msg_italian "MC(ude,editor,popup,MSG_SameHandler)"   "Questo handler di eventi esiste già. \nModificare il nome dell'evento o del post, se selezionato."
::msgcat::mcset pb_msg_italian "MC(ude,validate)"                       "Questo evento non contiene parametri."
...
::msgcat::mcset pb_msg_italian "MC(ude,editor,spindle_css,INFO)"        "Questo evento condivide l'UDE con \"Mandrino giri/min\""
::msgcat::mcset pb_msg_italian "MC(ude,import,ihr,Label)"               "Eredita UDE dal post A"

::msgcat::mcset pb_msg_italian "MC(ude,import,ihr,Context)"             "Questa opzione consente al post di ereditare la definizione IDE e gli handler corrispondenti."

::msgcat::mcset pb_msg_italian "MC(ude,import,sel,Label)"               "Seleziona post"

::msgcat::mcset pb_msg_italian "MC(ude,import,sel,Context)"             "Selezionare il file PUI del post desiderato. Si consiglia di inserire tutti i file (PUI, Def, Tcl e CDL) associati al post ereditato nella stessa directory (cartella) per l'uso."
...
::msgcat::mcset pb_msg_italian "MC(ude,import,own,Context)"             "Questa opzione abilita il post consentendo di includere il riferimento al proprio file CDL nel file di definizione."
...
::msgcat::mcset pb_msg_italian "MC(udc,editor,CYCLBL,C,Context)"        "Questo switch consente di impostare l'etichetta ciclo"
...
::msgcat::mcset pb_msg_italian "MC(udc,editor,popup,MSG_SAMENAME)"      "Questo nome ciclo esiste già."
...
::msgcat::mcset pb_msg_italian "MC(udc,editor,popup,MSG_ISSYSCYC)"      "Questo nome ciclo appartiene al tipo Ciclo di sistema."
...
::msgcat::mcset pb_msg_italian "MC(udc,drill,csink,INFO)"               "Questo evento condivide il gestore con la foratura."
::msgcat::mcset pb_msg_italian "MC(udc,drill,simulate,INFO)"            "Questo evento è un tipo di cicli simulati."
::msgcat::mcset pb_msg_italian "MC(udc,drill,dwell,INFO)"               "Questo evento condivide il ciclo definito dall'utente con "
...
::msgcat::mcset pb_msg_italian "MC(isv,setup,rev_fourth,Context)"       "Specificare la direzione di rotazione dell'asse. Può essere normale oppure invertita. Questa opzione si applica solo alle tavole di rotazione."
...
::msgcat::mcset pb_msg_italian "MC(isv,vnc_message,Context)"            "Selezionando questa opzione, tutti i messaggi di messa a punto VNC vengono visualizzati nella finestra di messaggi operazione durante la simulazione."
...
::msgcat::mcset pb_msg_italian "MC(isv,output,setup_data,Label)"        "Speficare il file di definizione del programma"
...
::msgcat::mcset pb_msg_italian "MC(isv,tool_info,toolnum,Context)"      "Speficiare il numero dell'utensile da aggiungere"
...
::msgcat::mcset pb_msg_italian "MC(isv,spec_command,preleader,Context)" "Specificare gli spazi iniziali per il comando di preprocessasemento definito dall'utente."

::msgcat::mcset pb_msg_italian "MC(isv,spec_command,precode,Label)"     "Codice"
::msgcat::mcset pb_msg_italian "MC(isv,spec_command,precode,Context)"   "Specificare gli spazi iniziali per il comando di preprocessasemento definito dall'utente."
...
::msgcat::mcset pb_msg_italian "MC(isv,spec_command,add_err,Msg)"       "Questo token è già stato trattato."
...
::msgcat::mcset pb_msg_italian "MC(isv,ex_editor,warning,Msg)"          "Questo è un comando VNC genarato dal sistema. Le modifiche non verranno salvate."
