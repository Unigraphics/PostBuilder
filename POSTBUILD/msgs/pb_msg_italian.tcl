...
::msgcat::mcset pb_msg_italian "MC(event,cycle,plane_change,label)"   "Rileva la modifica del piano di lavoro su Più basso"
...
::msgcat::mcset pb_msg_italian "MC(udc,drill,simulate,INFO)"            "Questo è un evento di ciclo simulato."
...
::msgcat::mcset pb_msg_italian "MC(isv,g_code,return_home,Label)"       "Ritorno alla home page"
