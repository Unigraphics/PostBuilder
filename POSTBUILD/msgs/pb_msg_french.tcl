...
::msgcat::mcset pb_msg_french "MC(main,title,Post_Builder)"            "Post-créateur"
...
::msgcat::mcset pb_msg_french "MC(msg,no_license_title)"               "Utilisation hors licence de UG/Post Builder"
::msgcat::mcset pb_msg_french "MC(msg,no_license_dialog)"              "Vous êtes autorisé à utiliser le UG/Post Builder\n sans licence appropriée. Toutefois, vous ne \n pourrez pas enregistrer votre travail."
...
::msgcat::mcset pb_msg_french "MC(new,lathe_4,desc,Label)"             "Tour 4 axes indépendants."
...
::msgcat::mcset pb_msg_french "MC(new,machine,Label)"                  "Machine-outils"
::msgcat::mcset pb_msg_french "MC(new,machine,Context)"                "Type de machine-outils pour laquelle est créé le Post-Processeur"
...
#Axis Type
::msgcat::mcset pb_msg_french "MC(new,mach_axis,Label)"                "Axe de machine-outils"
::msgcat::mcset pb_msg_french "MC(new,mach_axis,Context)"              "Sélectionner l'axe de machine-outils"
...
::msgcat::mcset pb_msg_french "MC(show_mt,title,Label)"                "Machine-outils"
...
::msgcat::mcset pb_msg_french "MC(inposts,title,Label)"                "Installer les Posts"
...
# Machine Tool
#++++++++++++++
::msgcat::mcset pb_msg_french "MC(machine,tab,Label)"                  "Machine-outils"
::msgcat::mcset pb_msg_french "MC(machine,Status)"                     "Spécifier les paramètres cinématiques de la machine."

::msgcat::mcset pb_msg_french "MC(msg,no_display)"                     "L'image de configuration de cette machine-outils n'est pas disponible."
...
## Display
##
::msgcat::mcset pb_msg_french "MC(machine,display,Label)"              "Afficher la machine-outils"
::msgcat::mcset pb_msg_french "MC(machine,display,Context)"            "Cette option affiche la machine-outils"
::msgcat::mcset pb_msg_french "MC(machine,display_trans,title,Label)"  "Machine-outils"
...
::msgcat::mcset pb_msg_french "MC(machine,gen,home_pos,Label)"             "Position Retour"
::msgcat::mcset pb_msg_french "MC(machine,gen,home_pos,Context)"           "Position Retour"
...
::msgcat::mcset pb_msg_french "MC(link_post,toggle,Context)"           "D'autres Posts peuvent être liés à ce Post pour gérer des machine-outils complexes qui effectuent plusieurs combinaisons des modes de tournage et de fraisage simple."

::msgcat::mcset pb_msg_french "MC(link_post,head,Label)"               "Tête"
::msgcat::mcset pb_msg_french "MC(link_post,head,Context)"             "Une machine-outils complexe peut effectuer ses opérations d'usinage en utilisant divers modes cinématiques dans divers modes d'usinage. Chaque mode cinématique est traité comme une tête indépendante dans UG/Post. Les opérations d'usinage qui doivent être réalisées avec une tête spécifique seront placées ensemble en tant que groupe dans la vue de la méthode Machine-outils ou Usinage. Un UDE \\\"Tête\\\" sera ensuite affecté au groupe pour désigner le nom de cette tête."
...
::msgcat::mcset pb_msg_french "MC(link_post,select_name,Label)"        "Sélectionner le nom"
::msgcat::mcset pb_msg_french "MC(link_post,select_name,Context)"      "Sélectionner le nom d'un Post à affecter à une tête. Il est supposé que ce Post est situé dans le répertoire où se trouve le Post principal au moment de l'exécution de UG/Post, sinon sera utilisé un Post de même nom situé dans le répertoire \\\$UGII_CAM_POST_DIR."
...
::msgcat::mcset pb_msg_french "MC(other,ude_select,Label)"             "Sélectionner le nom"
...
::msgcat::mcset pb_msg_french "MC(output,vnc,main,select_name,Label)"       "Sélectionner le nom"
...
## Event Handler
##
::msgcat::mcset pb_msg_french "MC(event_handler,tab,Label)"            "Gestionnaire d'événements"
...
### Delay
::msgcat::mcset pb_msg_french "MC(event,delay,name)"                   "Retard"
...
::msgcat::mcset pb_msg_french "MC(event,cycle,start,Context)"          "Cette option peut être activée pour les machine-outils qui exécutent les cycles avec un bloc de départ de cycle (G79...) après que le cycle a été défini (par G81...)."
...
::msgcat::mcset pb_msg_french "MC(g_code,delay_sec,name)"              "Retard (s)"
::msgcat::mcset pb_msg_french "MC(g_code,delay_rev,name)"              "Retard (tour)"
...
::msgcat::mcset pb_msg_french "MC(ude,editor,param,edit,Context)"      "Cliquez avec le bouton de droite pour sélectionner l'option par défaut.\n Double-cliquez pour éditer l'option."
...
::msgcat::mcset pb_msg_french "MC(ude,import,sel,Label)"               "Sélectionner le Post"
...
::msgcat::mcset pb_msg_french "MC(isv,setup,machine,Label)"            "Machine-outils"
...
::msgcat::mcset pb_msg_french "MC(isv,setup,mac_zcs,Context)"          "Spécifier un composant comme base de référence WCS. Ce doit être un composant non rotatif auquel est connectée directement ou indirectement la pièce dans l'arborescence cinématique.."
...
::msgcat::mcset pb_msg_french "MC(isv,setup,axis_name,Label)"          "Axe spécifié sur Machine-outils"
::msgcat::mcset pb_msg_french "MC(isv,setup,axis_name,Context)"        "Spécifier le nom des axes qui correspondent à la configuration cinématique de votre machine-outils"
...
::msgcat::mcset pb_msg_french "MC(isv,setup,initial_motion,Context)"   "Spécifier le mouvement initial de la machine-outils"
