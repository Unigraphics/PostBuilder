...
::msgcat::mcset pb_msg_spanish "MC(event,cycle,plane_change,label)"   "Activar este evento cuando el plano de trabajo se convierte en el plano inferior"
...
::msgcat::mcset pb_msg_spanish "MC(sub_post,inch,Lable)"                 " PULG."
...
::msgcat::mcset pb_msg_spanish "MC(ude,editor,bmp,Label)"                   "Mapa binario"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,bmp,Context)"                 "Para agregar un parámetro de mapa binario nuevo arrástrelo a la lista de la derecha."
...
::msgcat::mcset pb_msg_spanish "MC(ude,editor,param,MSG_WRONG_IMAGE_FOLDER)" "El nombre del archivo del mapa binario no debe contener una ruta de acceso al directorio."
...
::msgcat::mcset pb_msg_spanish "MC(link_post,select_name,Label)"        "Seleccionar nombre"
...
::msgcat::mcset pb_msg_spanish "MC(isv,setup,spindle_mode,Label)"       "Modalidad"
