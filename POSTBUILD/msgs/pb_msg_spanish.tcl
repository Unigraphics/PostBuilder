...
::msgcat::mcset $gPB(LANG) "MC(machine,axis,con_motion,combine,Context)"    "Este selector permite activar o desactivar la linearización. Se activará o desactivará la opción Tolerancia."
...
::msgcat::mcset $gPB(LANG) "MC(output,vnc,output,Context)"          "Esta opción permite generar un controlador Virtual N/C de la Computación en red virtual (VNC por su sigla en inglés). Podrá utilizar un postprocesador creado con la Computación en red virtual activado para ISV."
