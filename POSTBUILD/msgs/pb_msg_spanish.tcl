...
::msgcat::mcset $gPB(LANG) "MC(listing,tran_path,check,Label)"            "Trayectoria de transición de la salida"

::msgcat::mcset $gPB(LANG) "MC(listing,tran_path,check,Context)"          "Este selector permitirá que NX/Post procese y genere los eventos resultantes de la trayectoria de transición entre las operaciones."
...
::msgcat::mcset $gPB(LANG) "MC(block,def_popup,Label)"                    "Definición"
...
::msgcat::mcset $gPB(LANG) "MC(msg,event,delete_confirm)"                 "¿Desea eliminar el evento?"
...
::msgcat::mcset $gPB(LANG) "MC(event,misc,user_limit_action,name)"        "Acción límite del eje definida por el usuario"

# Skip output of NC code when rotary limit violation has occurred.
::msgcat::mcset $gPB(LANG) "MC(machine,axis,violation,omit,Label)"        "Pasar por alto la salida"

# Add/edit notes for a set of custom commands to be exported.
::msgcat::mcset $gPB(LANG) "MC(func,edit_note,Label)"                     "Editar las notas"

#=============================================================================
# pb12.00
#=============================================================================
# Short for "information about ..."
::msgcat::mcset $gPB(LANG) "MC(block,info_popup,Label)"                   "Info"

#=============================================================================
# pb11.02
#=============================================================================
# Markers of events taking place at the start & end of cut regions.
::msgcat::mcset $gPB(LANG) "MC(event,misc,region_start_marker,name)"      "Inicio del marcador de regiones"
::msgcat::mcset $gPB(LANG) "MC(event,misc,region_end_marker,name)"        "Fin del marcador de regiones"

#=============================================================================
# pb11.01
#=============================================================================
# A comment of Tcl language
::msgcat::mcset $gPB(LANG) "MC(event,combo,tcl_line,Label)"               "Comando Tcl"
...
::msgcat::mcset $gPB(LANG) "MC(g_code,tap_float,name)"                    "Roscado con macho en soporte flotante"
...
::msgcat::mcset $gPB(LANG) "MC(machine,linearization,Label)"         "Interpolación con la linealización"
...
::msgcat::mcset $gPB(LANG) "MC(machine,axis,def_lintol,Context)"     "Tolerancia de la linealización predeterminada"
...
::msgcat::mcset $gPB(LANG) "MC(event,cycle,tap_float,name)"             "Roscado con macho en soporte flotante"
...
::msgcat::mcset $gPB(LANG) "MC(main,options,backup,Context)"        "Cree copias de seguridad al guardar el postprocesador en curso."
...
::msgcat::mcset $gPB(LANG) "MC(main,utils,Balloon)"                 "\ Seleccionar la variable \ MOM\ , Instalar\ Postprocesador "
...
::msgcat::mcset $gPB(LANG) "MC(nav_button,cancel,Context)"          "Este botón se halla disponible en un subcuadro de diálogo. Y permite cancelar el cuadro de diálogo."
::msgcat::mcset $gPB(LANG) "MC(nav_button,default,Label)"           "Valor predeterminado"
::msgcat::mcset $gPB(LANG) "MC(nav_button,default,Context)"         "Este botón permite restaurar los parámetros en el cuadro de diálogo actual de un componente en la condición existente cuando se creó o abrió por primera vez un postprocesador en la sesión. \n \nSin embargo, el nombre del componente en cuestión, si hubiere, será restaurado solamente al estado inicial cuando abra dicho componente."
::msgcat::mcset $gPB(LANG) "MC(nav_button,restore,Label)"           "Restaurar"
::msgcat::mcset $gPB(LANG) "MC(nav_button,restore,Context)"         "Este botón permite restaurar los parámetros del cuadro de diálogo actual en los ajustes iniciales cuando abra dicho componente."
::msgcat::mcset $gPB(LANG) "MC(nav_button,apply,Label)"             "Aplicar"
::msgcat::mcset $gPB(LANG) "MC(nav_button,apply,Context)"           "Este botón permite guardar los cambios sin cancelar el cuadro de diálogo actual. Esto permitirá restablecer la condición inicial del presente diálogo. \n \n(Consulte Restaurar con respecto a la condición inicial)"
...
::msgcat::mcset $gPB(LANG) "MC(nav_button,save,Context)"            "Este botón se halla disponible en el cuadro de diálogo Guardar como, y permite guardar el postprocesador en curso."

::msgcat::mcset $gPB(LANG) "MC(nav_button,manage,Label)"            "Gestionar ..."
::msgcat::mcset $gPB(LANG) "MC(nav_button,manage,Context)"          "Este botón permite gestionar el historial de los postprocesadores recientemente visitados."
...
::msgcat::mcset $gPB(LANG) "MC(machine,gen,axis_multi,2x,Context)"      "Este selector permite activar la programación del diámetro al duplicar las coordenadas del eje X en la salida N/C."

::msgcat::mcset $gPB(LANG) "MC(machine,gen,axis_multi,2y,Label)"        "2Y"
::msgcat::mcset $gPB(LANG) "MC(machine,gen,axis_multi,2y,Context)"      "Este selector permite activar la programación del diámetro al duplicar las coordenadas del eje Y en la salida N/C."
::msgcat::mcset $gPB(LANG) "MC(machine,gen,axis_multi,2i,Label)"        "2I"
::msgcat::mcset $gPB(LANG) "MC(machine,gen,axis_multi,2i,Context)"      "Este selector permite duplicar los valores de I correspondientes a los registros circulares cuando se utiliza la programación del diámetro."
::msgcat::mcset $gPB(LANG) "MC(machine,gen,axis_multi,2j,Label)"        "2J"
::msgcat::mcset $gPB(LANG) "MC(machine,gen,axis_multi,2j,Context)"      "Este selector permite duplicar los valores de J correspondientes a los registros circulares cuando se utiliza la programación del diámetro."
...
::msgcat::mcset $gPB(LANG) "MC(machine,axis,con_motion,combine,Context)"    "Este selector permite activar o desactivar la linealización. Se activará o desactivará la opción Tolerancia."
...
::msgcat::mcset $gPB(LANG) "MC(machine,axis,config,Context)"            "Esta opción permite definir los parámetros del cuarto y quinto ejes."
...
::msgcat::mcset $gPB(LANG) "MC(machine,axis,rotary_lintol,Label)"       "Tolerancia de la linealización predeterminada"
...
::msgcat::mcset $gPB(LANG) "MC(prog,seq_comb_nc,Context)"           "Este botón permite visualizar el contenido de una secuencia en función de los bloques o los códigos N/C. \n \nLos códigos N/C visualizarán las palabras en el orden adecuado."

::msgcat::mcset $gPB(LANG) "MC(prog,plus,Label)"                    "Programa -- Contraer o expandir el selector"
::msgcat::mcset $gPB(LANG) "MC(prog,plus,Context)"                  "Este botón permite contraer o expandir las bifurcaciones de este componente."
...
::msgcat::mcset $gPB(LANG) "MC(tool,circ_trans,xy,Label)"           "Ejes XY del plano"
::msgcat::mcset $gPB(LANG) "MC(tool,circ_trans,yz,Label)"           "Ejes YZ del plano"
::msgcat::mcset $gPB(LANG) "MC(tool,circ_trans,zx,Label)"           "Ejes ZX del plano"
...
::msgcat::mcset $gPB(LANG) "MC(addrsum,col_addr,Label)"             "Palabra"
...
::msgcat::mcset $gPB(LANG) "MC(block,text_combo,Label)"             "Elemento de texto"
...
::msgcat::mcset $gPB(LANG) "MC(address,format,edit,Context)"        "Este botón permite editar el formato usado por una palabra."
::msgcat::mcset $gPB(LANG) "MC(address,format,new,Label)"           "Nuevo"
::msgcat::mcset $gPB(LANG) "MC(address,format,new,Context)"         "Este botón permite crear un formato nuevo."

::msgcat::mcset $gPB(LANG) "MC(address,format,select,Label)"        "PALABRA -- Seleccionar el formato"
::msgcat::mcset $gPB(LANG) "MC(address,format,select,Context)"      "Este botón permite seleccionar un formato diferente de una palabra."
...
::msgcat::mcset $gPB(LANG) "MC(address,max,error_handle,Context)"   "Este botón permite especificar el método para manejar la transgresión al valor máximo: \n \n * Truncar el valor \n * Avisar al usuario \n * Interrumpir el proceso \n"
...
::msgcat::mcset $gPB(LANG) "MC(address,min,error_handle,Context)"   "Este botón permite especificar el método para manejar la transgresión al valor mínimo: \n \n * Truncar el valor \n * Avisar al usuario \n * Interrumpir el proceso \n"
...
::msgcat::mcset $gPB(LANG) "MC(format,data,num,decimal,Context)"    "Esta opción permite producir puntos decimales en el código N/C."
...
::msgcat::mcset $gPB(LANG) "MC(other,seq_num,Context)"              "Este selector permite activar o desactivar la salida de los números de la secuencia en el código N/C."
...
::msgcat::mcset $gPB(LANG) "MC(other,chars,word_sep,Context)"       "Especifique un carácter que se utilizará como separador de palabras."
...
::msgcat::mcset $gPB(LANG) "MC(other,g_codes,Context)"              "Este selector permite activar o desactivar el control del número de códigos G por bloque de salida N/C."
...
::msgcat::mcset $gPB(LANG) "MC(other,m_codes,Context)"              "Este selector permite activar o desactivar el control del número de códigos M por bloque de salida N/C."
...
::msgcat::mcset $gPB(LANG) "MC(output,vnc,status,Label)"            "Seleccione un archivo VNC (Computación virtual en red)."
::msgcat::mcset $gPB(LANG) "MC(output,vnc,mis_match,Label)"         "El archivo seleccionado no concuerda con el nombre predeterminado del archivo VNC (Computación virtual en red). \n ¿Desea volver a seleccionar el archivo? "
::msgcat::mcset $gPB(LANG) "MC(output,vnc,output,Label)"            "Generar un controlador virtual N/C (VNC, Computación virtual en red). "
::msgcat::mcset $gPB(LANG) "MC(output,vnc,output,Context)"          "Esta opción permite generar un controlador Virtual N/C de la Computación virtual en red (VNC por su sigla en inglés). Podrá utilizar un postprocesador creado con la Computación virtual en red activado para ISV."
::msgcat::mcset $gPB(LANG) "MC(output,vnc,main,Label)"              "VNC maestra"
::msgcat::mcset $gPB(LANG) "MC(output,vnc,main,Context)"            "El nombre de la VNC maestra que se originará mediante una Computación virtual en red (VNC) subordinada.  Probablemente en el tiempo de ejecución de ISV, este postprocesador estará en el directorio donde se encuentra la Computación virtual en red (VNC) subordinada, de lo contrario, se utilizará un postprocesador con el mismo nombre en el directorio \\\$UGII_CAM_POST_DIR."


::msgcat::mcset $gPB(LANG) "MC(output,vnc,main,err_msg)"                 "Deberá especificar una VNC maestra correspondiente a una Computación virtual en red (VNC) subordinada."
::msgcat::mcset $gPB(LANG) "MC(output,vnc,main,select_name,Label)"       "Seleccionar el nombre"
::msgcat::mcset $gPB(LANG) "MC(output,vnc,main,select_name,Context)"     "Seleccione el nombre de una Computación virtual en red que se originará mediante una computación virtual en red (VNC) subordinada. En el tiempo de ejecución del ISV este postprocesador estará en el directorio donde se encuentra la Computación virtual en red, de lo contrario, se utilizará un postprocesador con el mismo nombre en el directorio \\\$UGII_CAM_POST_DIR."
...
::msgcat::mcset $gPB(LANG) "MC(listing,gen,Context)"                "Este selector permite activar o desactivar la salida al archivo de listados."
...
::msgcat::mcset $gPB(LANG) "MC(listing,parms,x,Context)"            "Este selector permite activar o desactivar la salida de la coordenada X al archivo de listados."

::msgcat::mcset $gPB(LANG) "MC(listing,parms,y,Label)"              "Coordenada Y"
::msgcat::mcset $gPB(LANG) "MC(listing,parms,y,Context)"            "Este selector permite activar o desactivar la salida de la coordenada Y al archivo de listados."

::msgcat::mcset $gPB(LANG) "MC(listing,parms,z,Label)"              "Coordenada Z"
::msgcat::mcset $gPB(LANG) "MC(listing,parms,z,Context)"            "Este selector permite activar o desactivar la salida de la coordenada Z al archivo de listados."

::msgcat::mcset $gPB(LANG) "MC(listing,parms,4,Label)"              "Ángulo del cuarto eje"
::msgcat::mcset $gPB(LANG) "MC(listing,parms,4,Context)"            "Este selector permite activar o desactivar la salida del ángulo del cuarto eje al archivo de listados."

::msgcat::mcset $gPB(LANG) "MC(listing,parms,5,Label)"              "Ángulo del quinto eje"
::msgcat::mcset $gPB(LANG) "MC(listing,parms,5,Context)"            "Este selector permite activar o desactivar la salida del ángulo del quinto eje al archivo de listados."

::msgcat::mcset $gPB(LANG) "MC(listing,parms,feed,Label)"           "Avance"
::msgcat::mcset $gPB(LANG) "MC(listing,parms,feed,Context)"         "Este selector permite activar o desactivar la salida de la velocidad de avance al archivo de listados."

::msgcat::mcset $gPB(LANG) "MC(listing,parms,speed,Label)"          "Velocidad"
::msgcat::mcset $gPB(LANG) "MC(listing,parms,speed,Context)"        "Este selector permite activar o desactivar la salida de la velocidad del husillo al archivo de listados."
...
::msgcat::mcset $gPB(LANG) "MC(listing,header,Label)"               "Encabezado del programa"
...
::msgcat::mcset $gPB(LANG) "MC(listing,footer,cut_time,Label)"      "Tiempo total de maquinado"

::msgcat::mcset $gPB(LANG) "MC(listing,format,Label)"                   "Formato de la página"
::msgcat::mcset $gPB(LANG) "MC(listing,format,print_header,Label)"      "Imprimir el encabezado de la página "
::msgcat::mcset $gPB(LANG) "MC(listing,format,print_header,Context)"    "Este selector permite activar o desactivar la salida del encabezado de la página al archivo de listas."
...
::msgcat::mcset $gPB(LANG) "MC(listing,output,warning,Context)"     "Este selector permite activar o desactivar la salida de los mensajes de avisos durante el postprocesamiento."

::msgcat::mcset $gPB(LANG) "MC(listing,output,review,Label)"        "Activar la herramienta de revisión"
::msgcat::mcset $gPB(LANG) "MC(listing,output,review,Context)"      "Este selector permite activar la herramienta de revisión durante el postprocesamiento."

::msgcat::mcset $gPB(LANG) "MC(listing,output,group,Label)"         "Generar la salida del grupo"
::msgcat::mcset $gPB(LANG) "MC(listing,output,group,Context)"       "Este selector permite activar o desactivar el control de la salida del grupo durante el postprocesamiento."

::msgcat::mcset $gPB(LANG) "MC(listing,output,verbose,Label)"       "Visualizar los mensajes de error verbosos"
::msgcat::mcset $gPB(LANG) "MC(listing,output,verbose,Context)"     "Este selector permite visualizar las descripciones extendidas de las condiciones de error. Desacelerará la velocidad del postprocesador."
...
::msgcat::mcset $gPB(LANG) "MC(listing,oper_info,cut_time,,Label)"  "Tiempo de maquinado"
...
::msgcat::mcset $gPB(LANG) "MC(listing,user_tcl,check,Context)"     "Este selector permite originar su propio archivo Tcl"
...
::msgcat::mcset $gPB(LANG) "MC(definition,oper_txt,Label)"          "Bloque de mensajes ficticios"
...
::msgcat::mcset $gPB(LANG) "MC(event,cutcom_on,left)"               "Izquierdo"
::msgcat::mcset $gPB(LANG) "MC(event,cutcom_on,right)"              "Derecho"
...
::msgcat::mcset $gPB(LANG) "MC(event,linear,assume)"                "Modo rápido supuesto en la velocidad máxima transversal"
...
::msgcat::mcset $gPB(LANG) "MC(event,cycle,bore_no-drag,name)"      "Mandrinado sin arrastre"
...
::msgcat::mcset $gPB(LANG) "MC(g_code,pln_xy,name)"                 "Ejes XY del plano"
::msgcat::mcset $gPB(LANG) "MC(g_code,pln_zx,name)"                 "Ejes ZX del plano"
::msgcat::mcset $gPB(LANG) "MC(g_code,pln_yz,name)"                 "Ejes YZ del plano"
...
::msgcat::mcset $gPB(LANG) "MC(ude,editor,eventdlg,PEN,C,Context)"  "Este selector permite configurar el nombre del postprocesador"
...
::msgcat::mcset $gPB(LANG) "MC(ude,editor,eventdlg,EL,C,Context)"   "Este selector permite configurar la etiqueta de evento"

::msgcat::mcset $gPB(LANG) "MC(ude,editor,eventdlg,EC,Label)"           "Categoría"
::msgcat::mcset $gPB(LANG) "MC(ude,editor,eventdlg,EC,Context)"         "Este selector permite configurar la categoría"
...
::msgcat::mcset $gPB(LANG) "MC(ude,import,name_def,Context)"        "La ruta y el nombre del archivo de definición del postprocesador seleccionado serán referenciados (INCLUIR) en el archivo de definición de este postprocesador. El nombre de la ruta de acceso debe comenzar por una variable de entorno de UG (\\\$UGII) o ninguna. Si no se especifica ninguna ruta, se utilizará UGII_CAM_FILE_SEARCH_PATH para ubicar el archivo de UG/NX durante el tiempo de ejecución."
...
::msgcat::mcset $gPB(LANG) "MC(udc,editor,CYCLBL,C,Context)"        "Este selector permite configurar la etiqueta del ciclo"
...
::msgcat::mcset $gPB(LANG) "MC(udc,drill,simulate,INFO)"            "Este evento es un ciclo simulado."
...
::msgcat::mcset $gPB(LANG) "MC(isv,setup,mac_zcs,Context)"          "Especifique un componente como la base de referencia ZCS. Debe ser un componente sin rotación, con el cual se conecta la pieza directa o indirectamente en el árbol Cinemática."
...
::msgcat::mcset $gPB(LANG) "MC(isv,setup,output,Label)"             "Exportar la definición de programa"
...
::msgcat::mcset $gPB(LANG) "MC(isv,setup,wcs,Label)"                "Desplazamientos de la fijación"
...
::msgcat::mcset $gPB(LANG) "MC(isv,incremental_uvw,Context)"        "Al usar una llamada especial para diferenciar entre el modo absoluto y el modo incremental. Por ejemplo, la llamada X Y Z indica que es el modo absoluto, mientras que la llamada U V W indica que es el modo incremental."
...
::msgcat::mcset $gPB(LANG) "MC(isv,tool_info,carrier_id,Label)"     " Id del portador "
::msgcat::mcset $gPB(LANG) "MC(isv,tool_info,pocket_id,Label)"      " Id de la cajera "
::msgcat::mcset $gPB(LANG) "MC(isv,tool_info,cutcom_reg,Label)"     "     COMPENSACIÓN DE CORTADOR     "
...
::msgcat::mcset $gPB(LANG) "MC(isv,tool_info,add_tool,Context)"     "Agregue una herramienta nueva y especifique los parámetros"
...
::msgcat::mcset $gPB(LANG) "MC(optionMenu,item,C_off_RS)"    "Ciclo desactivado, seguido de husillo rápido"
