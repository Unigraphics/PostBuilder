...
# pb800
#=============================================================================
::msgcat::mcset pb_msg_spanish "MC(event,misc,subop_start,name)"      "Inicio de la trayectoria de la subop"
::msgcat::mcset pb_msg_spanish "MC(event,misc,subop_end,name)"        "Fin de la trayectoria de la subop"
::msgcat::mcset pb_msg_spanish "MC(event,misc,contour_start,name)"    "Inicio de contorno"
::msgcat::mcset pb_msg_spanish "MC(event,misc,contour_end,name)"      "Fin de contorno"
::msgcat::mcset pb_msg_spanish "MC(prog,tree,misc,Label)"             "Miscelánea"
::msgcat::mcset pb_msg_spanish "MC(event,cycle,lathe_rough,name)"     "Desbaste con torno"
::msgcat::mcset pb_msg_spanish "MC(main,file,properties,Label)"       "Propiedades de Postprocesador"

::msgcat::mcset pb_msg_spanish "MC(ude,editor,popup,MSG_CATEGORY)"    "No se puede especificar el UDE correspondiente a un post de fresado o de torno con una categoría \"Wedm\" solamente."

::msgcat::mcset pb_msg_spanish "MC(event,cycle,plane_change,label)"   "Detectar el cambio en el plano de trabajo en Inferior"
::msgcat::mcset pb_msg_spanish "MC(format,check_1,error,msg)"         "El formato no puede acomodar el valor de las expresiones"

::msgcat::mcset pb_msg_spanish "MC(format,check_4,error,msg)"         "Cambie el formato de la dirección relacionada antes de salir de esta página o de guardar el post."
::msgcat::mcset pb_msg_spanish "MC(format,check_5,error,msg)"         "Cambie el formato antes de salir de esta página o de guardar este post."
::msgcat::mcset pb_msg_spanish "MC(format,check_6,error,msg)"         "Cambie el formato de la dirección relacionada antes de entrar en esta página."

::msgcat::mcset pb_msg_spanish "MC(msg,old_block,maximum_length)"     "Los nombres de los bloques siguientes han sobrepasado el límite de la longitud:"
::msgcat::mcset pb_msg_spanish "MC(msg,old_address,maximum_length)"   "Los nombres de las palabras siguientes han sobrepasado el límite de la longitud:"
::msgcat::mcset pb_msg_spanish "MC(msg,block_address,check,title)"    "Verificando el nombre del bloque y de la palabra"
::msgcat::mcset pb_msg_spanish "MC(msg,block_address,maximum_length)" "Algunos nombres de los bloques siguientes han sobrepasado el límite de la longitud."

::msgcat::mcset pb_msg_spanish "MC(address,maximum_name_msg)"         "La longitud de la cadena ha sobrepasado el límite."

::msgcat::mcset pb_msg_spanish "MC(ude,import,oth_list,Label)"        "Incluir otro archivo CDL"
::msgcat::mcset pb_msg_spanish "MC(ude,import,oth_list,Context)"      "Seleccione la opción \\\"Nuevo\\\" del menú emergente (pulsar con el botón derecho del ratón) para incluir otros archivos CDL con este post."
::msgcat::mcset pb_msg_spanish "MC(ude,import,ihr_list,Label)"        "Heredar UDE de un postprocesador"
::msgcat::mcset pb_msg_spanish "MC(ude,import,ihr_list,Context)"      "Seleccione la opción \\\"Nuevo\\\" del menú emergente (pulsar con el botón derecho del ratón) para heredar las definiciones de UDE y los manipuladores asociados de un post."
::msgcat::mcset pb_msg_spanish "MC(ude,import,up,Label)"              "Arriba"
::msgcat::mcset pb_msg_spanish "MC(ude,import,down,Label)"            "Abajo"
::msgcat::mcset pb_msg_spanish "MC(msg,exist_cdl_file)"               "Ya se incluyó el archivo CDL especificado."

::msgcat::mcset pb_msg_spanish "MC(listing,link_var,check,Label)"     "Enlazar las variables de Tc con las variables de C"
::msgcat::mcset pb_msg_spanish "MC(listing,link_var,check,Context)"   "Un conjunto de variables Tcl modificadas frecuentemente (tales como \\\"mom_pos\\\") se pueden enlazar directamente con las variables C a fin de mejorar el rendimiento del postprocesamiento. Pero se deberán observar determinadas restricciones para evitar errores y una diferencia en la salida de NC."

::msgcat::mcset pb_msg_spanish "MC(msg,check_resolution,title)"       "Verificar la resolución de movimiento Lineal/Rotatorio"
::msgcat::mcset pb_msg_spanish "MC(msg,check_resolution,linear)"      "Puede que el ajuste del formato no acomode la salida de la \"Resolución de movimiento lineal\"."
::msgcat::mcset pb_msg_spanish "MC(msg,check_resolution,rotary)"      "Puede que el ajuste del formato no acomode la salida de la \"Resolución de movimiento rotatorio\"."

::msgcat::mcset pb_msg_spanish "MC(cmd,export,desc,label)"            "Descripción de entrada para los comandos personalizados exportados"
::msgcat::mcset pb_msg_spanish "MC(cmd,desc_dlg,title)"               "Descripción"
::msgcat::mcset pb_msg_spanish "MC(block,delete_row,Label)"           "Eliminar los elementos activos de esta fila"
::msgcat::mcset pb_msg_spanish "MC(block,exec_cond,set,Label)"        "Condición de salida"
::msgcat::mcset pb_msg_spanish "MC(block,exec_cond,new,Label)"        "Nuevo..."
::msgcat::mcset pb_msg_spanish "MC(block,exec_cond,edit,Label)"       "Editar..."
::msgcat::mcset pb_msg_spanish "MC(block,exec_cond,remove,Label)"     "Quitar..."

::msgcat::mcset pb_msg_spanish "MC(cust_cmd,name_msg_for_cond)"       "Especifique otro nombre.  \nEl comando de la condición de salida debe tener un prefijo con"

::msgcat::mcset pb_msg_spanish "MC(machine,linearization,Label)"         "Interpolación con la linearización"
::msgcat::mcset pb_msg_spanish "MC(machine,linearization,angle,Label)"   "Ángulo rotatorio"
::msgcat::mcset pb_msg_spanish "MC(machine,linearization,angle,Context)" "Se calcularán los puntos interpolados en base a la distribución de los ángulos de inicio y final de los ejes rotatorios."
::msgcat::mcset pb_msg_spanish "MC(machine,linearization,axis,Label)"    "Eje de la herramienta"
::msgcat::mcset pb_msg_spanish "MC(machine,linearization,axis,Context)"  "Se calcularán los puntos interpolados en base a la distribución de los ángulos de inicio y final del eje de la herramienta."
::msgcat::mcset pb_msg_spanish "MC(machine,resolution,continue,Label)"   "Continuar"
::msgcat::mcset pb_msg_spanish "MC(machine,resolution,abort,Label)"      "Anular"

::msgcat::mcset pb_msg_spanish "MC(machine,axis,def_lintol,Label)"       "Tolerancia predeterminada"
::msgcat::mcset pb_msg_spanish "MC(machine,axis,def_lintol,Context)"     "Tolerancia de la linearización predeterminada"
::msgcat::mcset pb_msg_spanish "MC(sub_post,inch,Lable)"                 "PLG"
::msgcat::mcset pb_msg_spanish "MC(sub_post,metric,Lable)"               "mm"
::msgcat::mcset pb_msg_spanish "MC(new_sub,title,Label)"                 "Crear un postprocesador subordinado nuevo"
::msgcat::mcset pb_msg_spanish "MC(new,sub_post,toggle,label)"           "Postprocesador subordinado"
::msgcat::mcset pb_msg_spanish "MC(new,sub_post,toggle,tmp_label)"       "Subpostprocesador de unidades solamente"
::msgcat::mcset pb_msg_spanish "MC(new,unit_post,filename,msg)"          "Se debe definir el postprocesador subordinado correspondiente a las unidades de salida alternas \n agregando un posfijo\"__MM\" o \"__IN\" al nombre del postprocesador principal."
::msgcat::mcset pb_msg_spanish "MC(new,alter_unit,toggle,label)"         "Unidad de salida alterna"
::msgcat::mcset pb_msg_spanish "MC(new,main_post,label)"                 "Postprocesador principal"
::msgcat::mcset pb_msg_spanish "MC(new,main_post,warning_1,msg)"         "Se puede usar solamente un postprocesador principal completo para crear un postprocesador subordinado."
::msgcat::mcset pb_msg_spanish "MC(new,main_post,warning_2,msg)"         "Se debe crear o guardar el postprocesador principal \n en Generador de postprocesadores, versión 8.0 o posterior."
::msgcat::mcset pb_msg_spanish "MC(new,main_post,specify_err,msg)"       "Se debe especificar un postprocesador para crear un postprocesador subordinado. "
::msgcat::mcset pb_msg_spanish "MC(machine,gen,alter_unit,Label)"        "Unidades de salida del subpostprocesador:"
::msgcat::mcset pb_msg_spanish "MC(unit_related_param,tab,Label)"        "Parámetros de las unidades"
::msgcat::mcset pb_msg_spanish "MC(unit_related_param,feed_rate,Label)"  "Velocidad de avance"
::msgcat::mcset pb_msg_spanish "MC(listing,alt_unit,frame,Label)"        "Subpostprocesador de unidades alternas opcional"
::msgcat::mcset pb_msg_spanish "MC(listing,alt_unit,default,Label)"      "Valor predeterminado"
::msgcat::mcset pb_msg_spanish "MC(listing,alt_unit,default,Context)"    "El nombre predeterminado del subpostprocesador de unidades alternas será <post name>__MM o <post name>__IN"
::msgcat::mcset pb_msg_spanish "MC(listing,alt_unit,specify,Label)"      "Especificar"
::msgcat::mcset pb_msg_spanish "MC(listing,alt_unit,specify,Context)"    "Especifique el nombre de un subpostprocesador de unidades alternas"
::msgcat::mcset pb_msg_spanish "MC(listing,alt_unit,select_name,Label)"  "Seleccionar el nombre"
::msgcat::mcset pb_msg_spanish "MC(listing,alt_unit,warning_1,msg)"      "Se puede seleccionar solamente un subpostprocesador de unidades alternas."
::msgcat::mcset pb_msg_spanish "MC(listing,alt_unit,warning_2,msg)"      "El subpostprocesador seleccionado no puede admitir las unidades de salida alternas correspondientes a este postprocesador."

::msgcat::mcset pb_msg_spanish "MC(listing,alt_unit,post_name,Label)"    "Subpostprocesador de unidades alternas"
::msgcat::mcset pb_msg_spanish "MC(listing,alt_unit,post_name,Context)"  "El postprocesador de NX usará el subpostprocesador de unidades, si es provisto, para manejar las unidades de salida alterna correspondientes a este postprocesador."


##--------------------
## New string in v7.5
##
::msgcat::mcset pb_msg_spanish "MC(machine,axis,violation,user,evt_title)"  "Acción definida por el usuario correspondiente a Transgresión del límite del eje"
::msgcat::mcset pb_msg_spanish "MC(event,helix,name)"                       "Movimiento de la hélice"
::msgcat::mcset pb_msg_spanish "MC(event,circular,ijk_param,prefix,msg)"    "Las expresiones usadas en Direcciones"
::msgcat::mcset pb_msg_spanish "MC(event,circular,ijk_param,postfix,msg)"   "no serán afectadas por el cambio de esta opción."
::msgcat::mcset pb_msg_spanish "MC(isv,spec_codelist,default,msg)"          "Esta acción restaurará la lista de códigos especiales de NC al igual\n que los manipuladores al estado que tenían cuando se abrió o se creó el postprocesador.\n\n ¿Desea continuar?"
::msgcat::mcset pb_msg_spanish "MC(isv,spec_codelist,restore,msg)"          "Esta acción restaurará la lista de códigos especiales de NC al igual\n que los manipuladores al estado que tenían cuando se visitó esta página por última vez.\n\n ¿Desea continuar?"
::msgcat::mcset pb_msg_spanish "MC(msg,block_format_command,paste_err)"     "El nombre del objeto existe. Pegado no válido."
::msgcat::mcset pb_msg_spanish "MC(main,file,open,choose_cntl_type)"        "Seleccionar una familia de controladores"
::msgcat::mcset pb_msg_spanish "MC(cust_cmd,import,no_vnc_cmd,msg)"         "El archivo no contiene ningún comando VNC nuevo ni diferente."
::msgcat::mcset pb_msg_spanish "MC(cust_cmd,import,no_cmd,msg)"             "El archivo no contiene ningún comando personalizado nuevo ni diferente."
::msgcat::mcset pb_msg_spanish "MC(isv,tool_info,name_same_err,Msg)"        "Los nombres de la herramienta no deben ser iguales."
::msgcat::mcset pb_msg_spanish "MC(msg,limit_to_change_license)"            "No es el autor de este postprocesador. \nNo dispondrá del permiso para cambiar el nombre ni cambiar la licencia."
::msgcat::mcset pb_msg_spanish "MC(output,other_opts,validation,msg)"       "Se debe especificar el nombre del archivo TCL del usuario."
::msgcat::mcset pb_msg_spanish "MC(machine,empty_entry_err,msg)"            "Hay entradas vacías en esta página de parámetros."
::msgcat::mcset pb_msg_spanish "MC(msg,control_v_limit)"                    "Puede que la cadena que está intentando pegar haya sobrepasado \nel límite de la longitud o que contenga \nlíneas múltiples o caracteres no válidos."
::msgcat::mcset pb_msg_spanish "MC(block,capital_name_msg)"                 "La primer letra del nombre del bloque no puede ser una mayúscula.\n Indique otro nombre."
::msgcat::mcset pb_msg_spanish "MC(machine,axis,violation,user,Label)"      "Definido por el usuario"
::msgcat::mcset pb_msg_spanish "MC(machine,axis,violation,user,Handler)"    "Manipulador"
::msgcat::mcset pb_msg_spanish "MC(new,user,file,NOT_EXIST)"                "Este archivo de usuario no existe."
::msgcat::mcset pb_msg_spanish "MC(new,include_vnc,Label)"                  "Incluir el controlador virtual de NC"
::msgcat::mcset pb_msg_spanish "MC(other,opt_equal,Label)"                  "Signo igual (=)"
::msgcat::mcset pb_msg_spanish "MC(event,nurbs,name)"                       "Movimiento de NURBS"
::msgcat::mcset pb_msg_spanish "MC(event,cycle,tap_float,name)"             "Macho de roscar, flotar"
::msgcat::mcset pb_msg_spanish "MC(event,cycle,thread,name)"                "Rosca"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,group,MSG_NESTED_GROUP)"      "La agrupación anidada no es compatible."
::msgcat::mcset pb_msg_spanish "MC(ude,editor,bmp,Label)"                   "Mapa de bits"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,bmp,Context)"                 "Para agregar un parámetro de mapa de bits nuevo arrástrelo a la lista de la derecha."
::msgcat::mcset pb_msg_spanish "MC(ude,editor,group,Label)"                 "Grupo"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,group,Context)"               "Para agregar un parámetro de agrupación nuevo arrástrelo a la lista de la derecha."
::msgcat::mcset pb_msg_spanish "MC(ude,editor,eventdlg,DESC,Label)"         "Descripción"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,eventdlg,DESC,Context)"       "Especificar la información sobre el evento"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,eventdlg,URL,Label)"          "Dirección URL"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,eventdlg,URL,Context)"        "Especificar la dirección URL correspondiente a la descripción del evento"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,param,MSG_WRONG_IMAGE_FILE)"  "El archivo de imagen debe tener el formato BMP."
::msgcat::mcset pb_msg_spanish "MC(ude,editor,param,MSG_WRONG_IMAGE_FOLDER)" "El nombre del archivo del mapa de bits no debe contener una ruta de acceso al directorio."
::msgcat::mcset pb_msg_spanish "MC(ude,editor,param,MSG_WRONG_VAR_NAME)"    "El nombre de la variable debe empezar por una letra."
::msgcat::mcset pb_msg_spanish "MC(ude,editor,param,MSG_WRONG_KEYWORD)"     "El nombre de la variable no debe incluir una palabra clave: "
::msgcat::mcset pb_msg_spanish "MC(ude,editor,status_label)"                "Estatus"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,vector,Label)"                "Vector"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,vector,Context)"              "Para agregar un parámetro vectorial nuevo arrástrelo a la lista de la derecha."
::msgcat::mcset pb_msg_spanish "MC(ude,editor,popup,MSG_URL_FORMAT)"        "La dirección URL debe tener el formato \"http://*\" o \"archivo://*\" y no usar ninguna barra invertida."
::msgcat::mcset pb_msg_spanish "MC(ude,editor,popup,MSG_BLANK_HELP_INFO)"   "Se deben especificar la descripción y la dirección URL."
::msgcat::mcset pb_msg_spanish "MC(new,MSG_NO_AXIS)"                        "Se debe seleccionar una configuración de eje para una máquina herramienta."
::msgcat::mcset pb_msg_spanish "MC(machine,info,controller_type,Label)"     "Familia de controladores"
::msgcat::mcset pb_msg_spanish "MC(block,func_combo,Label)"                 "Macro"
::msgcat::mcset pb_msg_spanish "MC(block,prefix_popup,add,Label)"           "Agregar un texto de prefijo"
::msgcat::mcset pb_msg_spanish "MC(block,prefix_popup,edit,Label)"          "Editar el texto de prefijo"
::msgcat::mcset pb_msg_spanish "MC(block,prefix,Label)"                     "Prefijo"
::msgcat::mcset pb_msg_spanish "MC(block,suppress_popup,Label)"             "Suprimir el número de la secuencia"
::msgcat::mcset pb_msg_spanish "MC(block,custom_func,Label)"                "Macro personalizada"
::msgcat::mcset pb_msg_spanish "MC(seq,combo,macro,Label)"                  "Macro personalizada"
::msgcat::mcset pb_msg_spanish "MC(func,tab,Label)"                         "Macro"
::msgcat::mcset pb_msg_spanish "MC(func,exp,msg)"                           "La expresión de un parámetro de la macroinstrucción no debe estar en blanco."
::msgcat::mcset pb_msg_spanish "MC(func,edit,name,Label)"                   "Nombre de la macro"
::msgcat::mcset pb_msg_spanish "MC(func,disp_name,Label)"                   "Nombre de salida"
::msgcat::mcset pb_msg_spanish "MC(func,param_list,Label)"                  "Lista de parámetros"
::msgcat::mcset pb_msg_spanish "MC(func,separator,Label)"                   "Separador"
::msgcat::mcset pb_msg_spanish "MC(func,start,Label)"                       "Carácter de inicio"
::msgcat::mcset pb_msg_spanish "MC(func,end,Label)"                         "Carácter final"
::msgcat::mcset pb_msg_spanish "MC(func,output,name,Label)"                 "Atributo de salida"
::msgcat::mcset pb_msg_spanish "MC(func,output,check,Label)"                "Nombre del parámetro de salida"
::msgcat::mcset pb_msg_spanish "MC(func,output,link,Label)"                 "Enlazar con el carácter"
::msgcat::mcset pb_msg_spanish "MC(func,col_param,Label)"                   "Parámetro"
::msgcat::mcset pb_msg_spanish "MC(func,col_exp,Label)"                     "Expresión"
::msgcat::mcset pb_msg_spanish "MC(func,popup,insert,Label)"                "Nuevo"
::msgcat::mcset pb_msg_spanish "MC(func,name,err_msg)"                      "El nombre de la macro no debe contener ningún espacio."
::msgcat::mcset pb_msg_spanish "MC(func,name,blank_err)"                    "El nombre de la macro no debe estar en blanco."
::msgcat::mcset pb_msg_spanish "MC(func,name,contain_err)"                  "El nombre macro debe contener solamente caracteres alfabéticos, dígitos y guiones bajos."
::msgcat::mcset pb_msg_spanish "MC(func,tree_node,start_err)"               "El nombre del nodo debe comenzar por una letra mayúscula."
::msgcat::mcset pb_msg_spanish "MC(func,tree_node,contain_err)"             "El nombre del nodo solamente acepta un carácter alfabético, un dígito o un guión bajo."
::msgcat::mcset pb_msg_spanish "MC(func,help,Label)"                        "Información"
::msgcat::mcset pb_msg_spanish "MC(func,help,Context)"                      "Mostrar la información sobre el objeto."
::msgcat::mcset pb_msg_spanish "MC(func,help,MSG_NO_INFO)"                  "No se proporciona ninguna información sobre esta macro."
...
::msgcat::mcset pb_msg_spanish "MC(main,title,Post_Builder)"            "Generador de postprocesadores"

::msgcat::mcset pb_msg_spanish "MC(main,title,Version)"                 "Versión"
::msgcat::mcset pb_msg_spanish "MC(main,default,Status)"                "Seleccione la opción Nuevo o Abrir en el menú Archivo."
::msgcat::mcset pb_msg_spanish "MC(main,save,Status)"                   "Guarde el postprocesador."
...
::msgcat::mcset pb_msg_spanish "MC(main,file,new,Balloon)"              "Crear un postprocesador nuevo."
::msgcat::mcset pb_msg_spanish "MC(main,file,new,Context)"              "Crear un postprocesador nuevo."
::msgcat::mcset pb_msg_spanish "MC(main,file,new,Busy)"                 "Creando un postprocesador nuevo..."

::msgcat::mcset pb_msg_spanish "MC(main,file,open,Label)"               "Abrir ..."
::msgcat::mcset pb_msg_spanish "MC(main,file,open,Balloon)"             "Editar un postprocesador existente."
::msgcat::mcset pb_msg_spanish "MC(main,file,open,Context)"             "Editar un postprocesador existente."
::msgcat::mcset pb_msg_spanish "MC(main,file,open,Busy)"                "Abriendo el postprocesador..."

::msgcat::mcset pb_msg_spanish "MC(main,file,mdfa,Label)"               "Importar MDFA ..."
::msgcat::mcset pb_msg_spanish "MC(main,file,mdfa,Balloon)"             "Crear un postprocesador nuevo a partir de MDFA."
::msgcat::mcset pb_msg_spanish "MC(main,file,mdfa,Context)"             "Crear un postprocesador nuevo a partir de MDFA."

::msgcat::mcset pb_msg_spanish "MC(main,file,save,Label)"               "Guardar"
::msgcat::mcset pb_msg_spanish "MC(main,file,save,Balloon)"             "Guardar el postprocesador en curso."
::msgcat::mcset pb_msg_spanish "MC(main,file,save,Context)"             "Guardar el postprocesador en curso."
::msgcat::mcset pb_msg_spanish "MC(main,file,save,Busy)"                "Guardando el postprocesador ..."

::msgcat::mcset pb_msg_spanish "MC(main,file,save_as,Label)"            "Guardar como ..."
::msgcat::mcset pb_msg_spanish "MC(main,file,save_as,Balloon)"          "Guardar el postprocesador con un nombre nuevo."
::msgcat::mcset pb_msg_spanish "MC(main,file,save_as,Context)"          "Guardar el postprocesador con un nombre nuevo."

::msgcat::mcset pb_msg_spanish "MC(main,file,close,Label)"              "Cerrar"
::msgcat::mcset pb_msg_spanish "MC(main,file,close,Balloon)"            "Cerrar el postprocesador en curso."
::msgcat::mcset pb_msg_spanish "MC(main,file,close,Context)"            "Cerrar el postprocesador en curso."

::msgcat::mcset pb_msg_spanish "MC(main,file,exit,Label)"               "Salir"
::msgcat::mcset pb_msg_spanish "MC(main,file,exit,Balloon)"             "Terminar el generador de postprocesadores."
::msgcat::mcset pb_msg_spanish "MC(main,file,exit,Context)"             "Terminar el generador de postprocesadores."

::msgcat::mcset pb_msg_spanish "MC(main,file,history,Label)"            "Postprocesadores recientemente abiertos"
::msgcat::mcset pb_msg_spanish "MC(main,file,history,Balloon)"          "Editar un postprocesador visitado con anterioridad."
::msgcat::mcset pb_msg_spanish "MC(main,file,history,Context)"          "Editar un postprocesador en las sesiones anteriores del generador de postprocesadores."
...
::msgcat::mcset pb_msg_spanish "MC(main,options,Balloon)"               " Validar\ Personalizar\ Comandos, Copia de seguridad\ Postprocesador"
...
::msgcat::mcset pb_msg_spanish "MC(main,windows,Balloon)"               "La lista de postprocesadores de edición"
...
::msgcat::mcset pb_msg_spanish "MC(main,options,advisor,Label)"         "Asesor de postprocesadores"
::msgcat::mcset pb_msg_spanish "MC(main,options,advisor,Balloon)"       "Asesor de postprocesadores"
::msgcat::mcset pb_msg_spanish "MC(main,options,advisor,Context)"       "Activar o Desactivar el asesor de postprocesadores."
...
::msgcat::mcset pb_msg_spanish "MC(main,options,backup,Label)"          "Postprocesador de copias de seguridad"
::msgcat::mcset pb_msg_spanish "MC(main,options,backup,Balloon)"        "Método por postprocesador de copias de seguridad"
::msgcat::mcset pb_msg_spanish "MC(main,options,backup,Context)"        "Crear copias de seguridad al guardar el postprocesador en curso."
...
::msgcat::mcset pb_msg_spanish "MC(main,utils,Balloon)"                 "\ Seleccionar\ MOM\ Variable, Instalar\ Postprocesador "
::msgcat::mcset pb_msg_spanish "MC(main,utils,Context)"                 " "
::msgcat::mcset pb_msg_spanish "MC(main,utils,menu,Context)"            " "

::msgcat::mcset pb_msg_spanish "MC(main,utils,etpdf,Label)"             "Editar el archivo de datos de postprocesadores de plantillas"
...
::msgcat::mcset pb_msg_spanish "MC(main,help,dialog,Label)"             "Ayuda sobre el cuadro de diálogo"
::msgcat::mcset pb_msg_spanish "MC(main,help,dialog,Balloon)"           "Ayuda sobre este cuadro de diálogo"
::msgcat::mcset pb_msg_spanish "MC(main,help,dialog,Context)"           "Ayuda sobre este cuadro de diálogo"
...
::msgcat::mcset pb_msg_spanish "MC(main,help,about,Label)"              "Acerca del generador de postprocesadores"
::msgcat::mcset pb_msg_spanish "MC(main,help,about,Balloon)"            "Acerca del generador de postprocesadores"
::msgcat::mcset pb_msg_spanish "MC(main,help,about,Context)"            "Acerca del generador de postprocesadores"
...
::msgcat::mcset pb_msg_spanish "MC(tool,new,Context)"                   "Crear un postprocesador nuevo."

::msgcat::mcset pb_msg_spanish "MC(tool,open,Label)"                    "Abrir"
::msgcat::mcset pb_msg_spanish "MC(tool,open,Context)"                  "Editar un postprocesador existente."

::msgcat::mcset pb_msg_spanish "MC(tool,save,Label)"                    "Guardar"
::msgcat::mcset pb_msg_spanish "MC(tool,save,Context)"                  "Guardar el postprocesador en curso."
...
::msgcat::mcset pb_msg_spanish "MC(tool,dialog,Label)"                  "Ayuda sobre el cuadro de diálogo"
::msgcat::mcset pb_msg_spanish "MC(tool,dialog,Context)"                "Ayuda sobre este cuadro de diálogo"
...
## Common Messages
##
::msgcat::mcset pb_msg_spanish "MC(msg,error,title)"                    "Error en el generador de postprocesadores"
::msgcat::mcset pb_msg_spanish "MC(msg,dialog,title)"                   "Mensaje del generador de postprocesadores"
...
::msgcat::mcset pb_msg_spanish "MC(msg,user_ctrl_limit)"                "No se puede utilizar un postprocesador con licencia como un controlador\n a fin de crear un postprocesador nuevo si usted no es el autor del mismo."
::msgcat::mcset pb_msg_spanish "MC(msg,import_limit)"                   "No es el autor del postprocesador con licencia.\n No podrá importar los comandos personalizados."
::msgcat::mcset pb_msg_spanish "MC(msg,limit_msg)"                      "No es el autor de este postprocesador con licencia."
::msgcat::mcset pb_msg_spanish "MC(msg,no_file)"                        "Falta el archivo cifrado para el postprocesador con licencia."
::msgcat::mcset pb_msg_spanish "MC(msg,no_license)"                     "No dispone de la licencia correspondiente para realizar esta función."
::msgcat::mcset pb_msg_spanish "MC(msg,no_license_title)"               "Uso sin licencia del Generador de postprocesadores de NX"
::msgcat::mcset pb_msg_spanish "MC(msg,no_license_dialog)"              "Puede utilizar el Generador de postprocesadores de NX\n sin la licencia correspondiente.  Pero, no podrá\n guardar el trabajo posteriormente."
...
::msgcat::mcset pb_msg_spanish "MC(msg,version_check)"                  "No se puede abrir el postprocesador creado con la versión nueva del Generador de postprocesadores en esta versión."

::msgcat::mcset pb_msg_spanish "MC(msg,file_corruption)"                "Contenido incorrecto en el archivo de sesiones del Generador de postprocesadores."
::msgcat::mcset pb_msg_spanish "MC(msg,bad_tcl_file)"                   "Contenido incorrecto en el archivo Tcl del postprocesador."
::msgcat::mcset pb_msg_spanish "MC(msg,bad_def_file)"                   "Contenido incorrecto en el archivo de definición del postprocesador."
::msgcat::mcset pb_msg_spanish "MC(msg,invalid_post)"                   "Deberá especificar por lo menos un conjunto de archivos de Tcl y de definición del postprocesador."
...
::msgcat::mcset pb_msg_spanish "MC(msg,invalid_tcl_file)"               "No se puede abrir el archivo de manipulador de eventos"
::msgcat::mcset pb_msg_spanish "MC(msg,dir_perm)"                       "No dispone del permiso de escritura con respecto al directorio:"
::msgcat::mcset pb_msg_spanish "MC(msg,file_perm)"                      "No dispone del permiso de escritura con respecto a"

::msgcat::mcset pb_msg_spanish "MC(msg,file_exist)"                     "ya existe.  \n¿Desea reemplazarlos de todos modos?"
::msgcat::mcset pb_msg_spanish "MC(msg,file_missing)"                   "Faltan algunos o todos los archivos de este postprocesador.\n No puede abrir este postprocesador."
::msgcat::mcset pb_msg_spanish "MC(msg,sub_dialog_open)"                "Debe completar la edición de todos los subcuadros de diálogo de parámetros antes de guardar el postprocesador."
::msgcat::mcset pb_msg_spanish "MC(msg,generic)"                        "Se ha implementado el Generador de postprocesadores solamente para las máquinas de fresado genérico."
...
::msgcat::mcset pb_msg_spanish "MC(msg,set_ext_editor)"                 "Puede utilizar la variable de entorno EDITOR para activar su editor de texto preferente."
::msgcat::mcset pb_msg_spanish "MC(msg,filename_with_space)"            "No se admite el espacio que restringe el nombre del archivo."
::msgcat::mcset pb_msg_spanish "MC(msg,filename_protection)"            "No se puede sobrescribir el archivo seleccionado que es utilizado por un postprocesador de edición."
...
::msgcat::mcset pb_msg_spanish "MC(msg,no_cdl_name)"                    "Se debe especificar el nombre del postprocesador."
...
::msgcat::mcset pb_msg_spanish "MC(msg,no_cdl_file)"                    "El postprocesador seleccionado no tiene un archivo asociado CDL."
::msgcat::mcset pb_msg_spanish "MC(msg,cdl_info)"                       "El archivo CDL y los archivos de definición del postprocesador seleccionado serán referenciados (INCLUIR) en el archivo de definición de este postprocesador.\n Y el archivo Tcl del postprocesador seleccionado también será originado por el archivo de manipuladores de este postprocesador en el tiempo de ejecución."

::msgcat::mcset pb_msg_spanish "MC(msg,add_max1)"                       "El valor máximo de la dirección"
::msgcat::mcset pb_msg_spanish "MC(msg,add_max2)"                       "no debe exceder la capacidad del formato de"
...
##
::msgcat::mcset pb_msg_spanish "MC(nav_button,no_license,Message)"      "No dispone de la licencia correspondiente para realizar esta función."

::msgcat::mcset pb_msg_spanish "MC(nav_button,ok,Label)"                "Aceptar"
::msgcat::mcset pb_msg_spanish "MC(nav_button,ok,Context)"              "Este botón se halla disponible solamente en un subcuadro de diálogo. Le permitirá guardar los cambios y cancelar el cuadro de diálogo."
::msgcat::mcset pb_msg_spanish "MC(nav_button,cancel,Label)"            "Cancelar"
::msgcat::mcset pb_msg_spanish "MC(nav_button,cancel,Context)"          "Este botón se halla disponible en un subcuadro de diálogo. Le permite cancelar el cuadro de diálogo."
::msgcat::mcset pb_msg_spanish "MC(nav_button,default,Label)"           "Valor predeterminado"
::msgcat::mcset pb_msg_spanish "MC(nav_button,default,Context)"         "Este botón le permite restaurar los parámetros en el cuadro de diálogo actual de un componente a una condición cuando se creó o abrió por primera vez un postprocesador en la sesión. \n \nSin embargo, el nombre del componente en cuestión, si hubiere, será restaurado solamente al estado inicial cuando abra dicho componente."
::msgcat::mcset pb_msg_spanish "MC(nav_button,restore,Label)"           "Restaurar"
::msgcat::mcset pb_msg_spanish "MC(nav_button,restore,Context)"         "Este botón le permite restaurar los parámetros del cuadro de diálogo actual a los ajustes iniciales cuando abra dicho componente."
::msgcat::mcset pb_msg_spanish "MC(nav_button,apply,Label)"             "Aplicar"
::msgcat::mcset pb_msg_spanish "MC(nav_button,apply,Context)"           "Este botón le permite guardar los cambios sin cancelar el cuadro de diálogo actual. Esto le permitirá restablecer la condición inicial del presente diálogo. \n \n(Consulte Restaurar con respecto a la condición inicial)"
...
::msgcat::mcset pb_msg_spanish "MC(nav_button,open,Context)"            "Este botón le permitirá abrir el postprocesador seleccionado para editarlo."

::msgcat::mcset pb_msg_spanish "MC(nav_button,save,Label)"              "Guardar"
::msgcat::mcset pb_msg_spanish "MC(nav_button,save,Context)"            "Este botón se halla disponible en el cuadro de diálogo Guardar como que le permite guardar el postprocesador en curso."

::msgcat::mcset pb_msg_spanish "MC(nav_button,manage,Label)"            "Gestionar ..."
::msgcat::mcset pb_msg_spanish "MC(nav_button,manage,Context)"          "Este botón le permite gestionar el historial de los postprocesadores recientemente visitados."
...
## New dialog
##
::msgcat::mcset pb_msg_spanish "MC(new,title,Label)"                    "Crear un postprocesador nuevo"
::msgcat::mcset pb_msg_spanish "MC(new,Status)"                         "Escribir el nombre y seleccionar el parámetro del postprocesador nuevo."

::msgcat::mcset pb_msg_spanish "MC(new,name,Label)"                     "Nombre del postprocesador"
::msgcat::mcset pb_msg_spanish "MC(new,name,Context)"                   "Nombre del postprocesador que desea crear"

::msgcat::mcset pb_msg_spanish "MC(new,desc,Label)"                     "Descripción"
::msgcat::mcset pb_msg_spanish "MC(new,desc,Context)"                   "Descripción del postprocesador que desea crear"
...
::msgcat::mcset pb_msg_spanish "MC(new,control,Context)"                "Seleccionar el controlador del postprocesador."
...
::msgcat::mcset pb_msg_spanish "MC(new,seimens,Label)"                  "Siemens"

##-------------
## Open dialog
##
::msgcat::mcset pb_msg_spanish "MC(open,title,Label)"                   "Editar el postprocesador"
::msgcat::mcset pb_msg_spanish "MC(open,Status)"                        "Seleccionar un archivo PUI para abrir."
::msgcat::mcset pb_msg_spanish "MC(open,file_type_pui)"                 "Archivos de la sesión del Generador de postprocesadores"
::msgcat::mcset pb_msg_spanish "MC(open,file_type_tcl)"                 "Archivos de secuencias de comandos Tcl"
...
::msgcat::mcset pb_msg_spanish "MC(inposts,title,Label)"                "Editar template_post.dat"
::msgcat::mcset pb_msg_spanish "MC(tpdf,text,Label)"                    "Archivo de datos de postprocesadores de plantillas"
::msgcat::mcset pb_msg_spanish "MC(inposts,edit,title,Label)"           "Editar una línea"
::msgcat::mcset pb_msg_spanish "MC(inposts,edit,post,Label)"            "Postprocesador"
...
::msgcat::mcset pb_msg_spanish "MC(save_as,name,Label)"                 "Nombre del postprocesador"
::msgcat::mcset pb_msg_spanish "MC(save_as,name,Context)"               "El nombre que el postprocesador guardará como."
::msgcat::mcset pb_msg_spanish "MC(save_as,Status)"                     "Introduzca el nombre del archivo de postprocesador nuevo."
::msgcat::mcset pb_msg_spanish "MC(save_as,file_type_pui)"              "Archivos de la sesión del Generador de postprocesadores"

##----------------
## Common Widgets
##
::msgcat::mcset pb_msg_spanish "MC(common,entry,Label)"                 "Entrada"
::msgcat::mcset pb_msg_spanish "MC(common,entry,Context)"               "Especificará un valor nuevo en el campo entrada."
...
::msgcat::mcset pb_msg_spanish "MC(tree,create,Context)"                "Para crear un componente nuevo copie el ítem seleccionado."
...
::msgcat::mcset pb_msg_spanish "MC(tree,rename,Label)"                  "Cambiar de nombre"
...
::msgcat::mcset pb_msg_spanish "MC(msg,no_display)"                     "La imagen correspondiente a la configuración máquina herramienta no se halla disponible."
...
# Post Info
##
::msgcat::mcset pb_msg_spanish "MC(machine,info,title,Label)"           "Información sobre el postprocesador"
...
::msgcat::mcset pb_msg_spanish "MC(machine,gen,out_unit,Label)"             "Unidad de salida del postprocesador:"
::msgcat::mcset pb_msg_spanish "MC(machine,gen,out_unit,Context)"           "Unidad de salida del postprocesador"
...
::msgcat::mcset pb_msg_spanish "MC(machine,gen,home_pos,x,Context)"         "La posición de inicio de la máquina del eje X con respecto a la posición física cero del eje. La máquina vuelve a esta posición para que pueda realizar el cambio automático en la herramienta."
::msgcat::mcset pb_msg_spanish "MC(machine,gen,home_pos,y,Label)"           "Y"
::msgcat::mcset pb_msg_spanish "MC(machine,gen,home_pos,y,Context)"         "La posición de inicio de la máquina del eje Y con respecto a la posición física cero del eje. La máquina vuelve a esta posición para que pueda realizar el cambio automático en la herramienta."
::msgcat::mcset pb_msg_spanish "MC(machine,gen,home_pos,z,Label)"           "Z"
::msgcat::mcset pb_msg_spanish "MC(machine,gen,home_pos,z,Context)"         "La posición de inicio de la máquina del eje Z con respecto a la posición física cero del eje. La máquina vuelve a esta posición para que pueda realizar el cambio automático en la herramienta."
...
# Wire EDM parameters
::msgcat::mcset pb_msg_spanish "MC(machine,gen,wedm,wire_tilt)"             "Control de inclinación del alambre"
...
::msgcat::mcset pb_msg_spanish "MC(machine,gen,turret,one,Context)"         "Una máquina con torno de torreta"
...
::msgcat::mcset pb_msg_spanish "MC(machine,gen,turret,xoff,Label)"          "Desplazamiento X"
::msgcat::mcset pb_msg_spanish "MC(machine,gen,turret,xoff,Context)"        "Especifique el desplazamiento X."
::msgcat::mcset pb_msg_spanish "MC(machine,gen,turret,zoff,Label)"          "Desplazamiento Z"
::msgcat::mcset pb_msg_spanish "MC(machine,gen,turret,zoff,Context)"        "Especifique el desplazamiento Z."
...
::msgcat::mcset pb_msg_spanish "MC(machine,gen,turret_chg,msg)"             "Para modificar esta opción puede que sea necesario agregar o eliminar el bloque G92 en los eventos Cambio en la herramienta. "
...
::msgcat::mcset pb_msg_spanish "MC(machine,gen,mach_mode,Label)"                "Modalidad de máquina"
::msgcat::mcset pb_msg_spanish "MC(machine,gen,mach_mode,Context)"              "La modalidad de máquina puede ser Fresado XZC o torneado fresado simple."
...
::msgcat::mcset pb_msg_spanish "MC(machine,gen,mach_mode,mill_turn,Context)"    "Se enlazará este postprocesador de fresado XZC con un postprocesador de torno para procesar un programa que contenga las operaciones de fresado y torneado. El tipo de operación determinará el postprocesador a utilizar para producir las salidas N/C."

::msgcat::mcset pb_msg_spanish "MC(machine,gen,mill_turn,lathe_post,Label)"     "Postprocesador de torno"
::msgcat::mcset pb_msg_spanish "MC(machine,gen,mill_turn,lathe_post,Context)"   "Es necesario un postprocesador de torno para un postprocesador de torneado fresado simple para postprocesar las operaciones de torneado en un programa."

::msgcat::mcset pb_msg_spanish "MC(machine,gen,lathe_post,select_name,Label)"   "Seleccionar el nombre"
::msgcat::mcset pb_msg_spanish "MC(machine,gen,lathe_post,select_name,Context)" "Seleccione el nombre de un postprocesador de torno para usar en un postprocesador de torneado fresado. Podrá encontrar este postprocesador en el directorio \\\$UGII_CAM_POST_DIR en el tiempo de ejecución de NX/Post, de lo contrario se utilizará un postprocesador con el mismo nombre en el directorio donde se encuentra el postprocesador de fresado."

::msgcat::mcset pb_msg_spanish "MC(machine,gen,coord_mode,Label)"               "Modalidad predeterminada de coordenadas"
::msgcat::mcset pb_msg_spanish "MC(machine,gen,coord_mode,Context)"             "Esta opción define el ajuste inicial de la modalidad de salida de las coordenadas como polar (XZC) o cartesiano (XYZ).  Se puede modificar esta modalidad \\\"CONFIGURAR/POLAR,ACTIVADO\\\" con las operaciones programadas UDE."
...
::msgcat::mcset pb_msg_spanish "MC(machine,gen,xzc_arc_mode,Label)"             "Modalidad de registro circular"
::msgcat::mcset pb_msg_spanish "MC(machine,gen,xzc_arc_mode,Context)"           "Esta opción define la salida de los registros circulares en la modalidad polar (XCR) o cartesiano (XYIJ)."
...
::msgcat::mcset pb_msg_spanish "MC(machine,axis,radius_output,Context)"     "Cuando el eje de la herramienta se extiende a lo largo del eje Z (0,0,1), el postprocesador puede optar por producir el radio (X) de las coordenadas polares para que sean \\\"Siempre positivo\\\", \\\"Siempre negativo\\\" o \\\"La distancia más corta\\\"."
...
::msgcat::mcset pb_msg_spanish "MC(machine,axis,offset,x,Label)"            "Desplazamiento X"
::msgcat::mcset pb_msg_spanish "MC(machine,axis,offset,x,Context)"          "Especifique el desplazamiento X del eje rotatorio."
::msgcat::mcset pb_msg_spanish "MC(machine,axis,offset,y,Label)"            "Desplazamiento Y"
::msgcat::mcset pb_msg_spanish "MC(machine,axis,offset,y,Context)"          "Especifique el desplazamiento Y del eje rotatorio."
::msgcat::mcset pb_msg_spanish "MC(machine,axis,offset,z,Label)"            "Desplazamiento Z"
::msgcat::mcset pb_msg_spanish "MC(machine,axis,offset,z,Context)"          "Especifique el desplazamiento Z del eje rotatorio."
...
::msgcat::mcset pb_msg_spanish "MC(machine,axis,violation,Label)"           "Manejo de la transgresión del límite del eje"
...
::msgcat::mcset pb_msg_spanish "MC(machine,axis,violation,ret,Label)"       "Retroceso o entrada nueva"
::msgcat::mcset pb_msg_spanish "MC(machine,axis,violation,ret,Context)"     "Retroceso o entrada nueva en la transgresión del límite del eje. \n \nEn el comando personalizado PB_CMD_init_rotaty, se pueden ajustar los siguientes parámetros para lograr los movimientos deseados: \n \n   mom_kin_retract_type \n   mom_kin_retract_distance \n   mom_kin_reengage_distance"
...
::msgcat::mcset pb_msg_spanish "MC(machine,axis,ang_offset,Label)"          "Desplazamiento angular (grado)"
::msgcat::mcset pb_msg_spanish "MC(machine,axis,ang_offset,Context)"        "Especifique el desplazamiento angular del eje (grado)."
...
::msgcat::mcset pb_msg_spanish "MC(machine,axis,rotary_lintol,Context)"     "Se utilizará este valor como la tolerancia predeterminada para linearizar los movimientos rotatorios cuando se indique el comando Postprocesador de LINTOL/Activado con las operaciones actuales o precedentes. El comando LINTOL/ también puede especificar una tolerancia diferente de linearización."
...
::msgcat::mcset pb_msg_spanish "MC(prog,tree,tool_path,cycle,Label)"    "Ciclos preconfigurados"
::msgcat::mcset pb_msg_spanish "MC(prog,tree,linked_posts,Label)"       "Secuencia de postprocesadores enlazados"

::msgcat::mcset pb_msg_spanish "MC(prog,add,Label)"                     "Secuencia -- Agregar un bloque"
::msgcat::mcset pb_msg_spanish "MC(prog,add,Context)"                   "Puede agregar un bloque nuevo a una secuencia si presiona este botón y lo arrastra al marcador deseado. También se pueden asociar los bloques próximos a, por arriba o debajo de un bloque existente."
...
::msgcat::mcset pb_msg_spanish "MC(prog,marker,Context)"                "Los marcadores de una secuencia indican los eventos posibles que se pueden programar y que pueden ocurrir en secuencia en una etapa en particular de un programa N/C. \n \nPuede asociar u ordenar los bloques para producir en cada marcador."
...
::msgcat::mcset pb_msg_spanish "MC(seq,rename_popup,Label)"             "Cambiar de nombre"
...
::msgcat::mcset pb_msg_spanish "MC(tool,config,mill_opt2,Label)"            "Número de la herramienta y número del desplazamiento de la longitud"
::msgcat::mcset pb_msg_spanish "MC(tool,config,mill_opt3,Label)"            "Número del desplazamiento de la longitud y número de la herramienta"
...
::msgcat::mcset pb_msg_spanish "MC(tool,config,lathe_opt2,Label)"           "Número de la herramienta y número del desplazamiento de la longitud"
::msgcat::mcset pb_msg_spanish "MC(tool,config,lathe_opt3,Label)"           "Índice de torretas y número de la herramienta"
::msgcat::mcset pb_msg_spanish "MC(tool,config,lathe_opt4,Label)"           "Índice de torretas, número de la herramienta y número del desplazamiento de la longitud"
...
::msgcat::mcset pb_msg_spanish "MC(tool,conf_desc,num_len,Label)"           "Número de la herramienta y número del desplazamiento de la longitud"
::msgcat::mcset pb_msg_spanish "MC(tool,conf_desc,next_num_len,Label)"      "Número de la herramienta siguiente y número del desplazamiento de la longitud"
::msgcat::mcset pb_msg_spanish "MC(tool,conf_desc,len_num,Label)"           "Número del desplazamiento de la longitud y número de la herramienta"
::msgcat::mcset pb_msg_spanish "MC(tool,conf_desc,len_next_num,Label)"      "Número del desplazamiento de la longitud y número de la herramienta siguiente"
::msgcat::mcset pb_msg_spanish "MC(tool,conf_desc,index_num_len,Label)"     "Índice de torretas, número de la herramienta y número del desplazamiento de la longitud"
::msgcat::mcset pb_msg_spanish "MC(tool,conf_desc,index_next_num_len,Label)"    "Índice de torretas, número de la herramienta siguiente y número del desplazamiento de la longitud"
...
##
::msgcat::mcset pb_msg_spanish "MC(event,feed,IPM_mode)"                "Modalidad IPM (pulgada o min)"
...
::msgcat::mcset pb_msg_spanish "MC(cust_cmd,proc,Context)"              "Introducirá una secuencia de comandos Tcl para definir la funcionalidad de este comando. \n \n * Observe que el contenido de la secuencia de comandos no será analizado sintácticamente por el generador de postprocesadores pero se guardará en el archivo Tcl. Por lo tanto, usted será responsable de la corrección sintáctica de la secuencia de comandos."
...
::msgcat::mcset pb_msg_spanish "MC(cust_cmd,not_defined,msg)"           "no han sido definidos en el ámbito actual del postprocesador en curso."
::msgcat::mcset pb_msg_spanish "MC(cust_cmd,cannot_delete,msg)"         "no se puede eliminar."
::msgcat::mcset pb_msg_spanish "MC(cust_cmd,save_post,msg)"             "¿Desea guardar este postprocesador de todos modos?"
...
::msgcat::mcset pb_msg_spanish "MC(opr_msg,text,Context)"               "Texto que será visualizado como un mensaje del operador. Se adjuntarán automáticamente estos caracteres especiales necesarios para el inicio y el final del mensaje mediante el Generador de postprocesadores.  La página de parámetros \"Otros elementos de datos\" en la pestaña \"Definiciones de datos N/C\"."
...
## Linked Posts
##
::msgcat::mcset pb_msg_spanish "MC(link_post,tab,Label)"                "Postprocesadores enlazados"
::msgcat::mcset pb_msg_spanish "MC(link_post,Status)"                   "Definir los postprocesadores enlazados"

::msgcat::mcset pb_msg_spanish "MC(link_post,toggle,Label)"             "Enlazar otros postprocesadores con este postprocesador"
::msgcat::mcset pb_msg_spanish "MC(link_post,toggle,Context)"           "Se pueden enlazar otros postprocesadores con este postprocesador para manejar máquinas herramienta complejas que realizan más de una combinación de modalidades de fresado y torneado simples."

::msgcat::mcset pb_msg_spanish "MC(link_post,head,Label)"               "Cabezal"
::msgcat::mcset pb_msg_spanish "MC(link_post,head,Context)"             "Una máquina herramienta compleja puede realizar las operaciones de maquinado usando conjuntos diferentes de cinemática en varias modalidades de maquinado. Se trata cada conjunto de cinemática como un cabezal independiente en NX/Post.  Se colocarán las operaciones de maquinado que se deben realizar con un cabezal específico como un grupo en la vista Máquina herramienta o Método por maquinado. A continuación se asignará un \\\"Cabezal\\\" UDE al grupo para designar el nombre correspondiente."

::msgcat::mcset pb_msg_spanish "MC(link_post,post,Label)"               "Postprocesador"
::msgcat::mcset pb_msg_spanish "MC(link_post,post,Context)"             "Se asigna un postprocesador a un cabezal para producir los códigos N/C."

::msgcat::mcset pb_msg_spanish "MC(link_post,link,Label)"               "Postprocesador con enlaces"
...
::msgcat::mcset pb_msg_spanish "MC(link_post,new,Context)"              "Cree un enlace nuevo."
...
::msgcat::mcset pb_msg_spanish "MC(link_post,start_of_head,Label)"      "Inicio del cabezal"
::msgcat::mcset pb_msg_spanish "MC(link_post,start_of_head,Context)"    "Especifique los códigos o las acciones N/C que se ejecutarán al inicio de este cabezal."

::msgcat::mcset pb_msg_spanish "MC(link_post,end_of_head,Label)"        "Fin del cabezal"
::msgcat::mcset pb_msg_spanish "MC(link_post,end_of_head,Context)"      "Especifique los códigos o las acciones N/C que se ejecutarán al final de este cabezal."
::msgcat::mcset pb_msg_spanish "MC(link_post,dlg,head,Label)"           "Cabezal"
::msgcat::mcset pb_msg_spanish "MC(link_post,dlg,post,Label)"           "Postprocesador"
::msgcat::mcset pb_msg_spanish "MC(link_post,dlg,title,Label)"          "Postprocesador con enlaces"
...
::msgcat::mcset pb_msg_spanish "MC(address,format,new,Context)"         "Este botón le permite crear un formato nuevo."
...
::msgcat::mcset pb_msg_spanish "MC(address,rapid_add_name_msg)"         "rapid1, rapid2 y rapid3 están reservados para el Generador de postprocesadores.\n Especifique otro nombre."
...
::msgcat::mcset pb_msg_spanish "MC(other,opt_new_line,Label)"           "Línea nueva (\\012)"
...
::msgcat::mcset pb_msg_spanish "MC(other,ude_include,Context)"          "Esta opción permite al postprocesador incluir una referencia a un archivo CDL en el archivo de definición."
...
::msgcat::mcset pb_msg_spanish "MC(output,vnc,status,Label)"            "Seleccione un archivo VNC (Computación en red virtual)."
::msgcat::mcset pb_msg_spanish "MC(output,vnc,mis_match,Label)"         "El archivo seleccionado no concuerda con el nombre predeterminado del archivo VNC (Computación en red virtual). \n ¿Desea volver a seleccionar el archivo? "
::msgcat::mcset pb_msg_spanish "MC(output,vnc,output,Label)"            "Generar un controlador virtual N/C (VNC, Computación en red virtual). "
::msgcat::mcset pb_msg_spanish "MC(output,vnc,output,Context)"          "Esta opción le permite generar un controlador de la Computación en red virtual de N/C. Se podrá utilizar un postprocesador creado con la Computación en red virtual activado para ISV."
...
::msgcat::mcset pb_msg_spanish "MC(output,vnc,mode,Label)"                   "Modalidad del controlador virtual N/C "
...
::msgcat::mcset pb_msg_spanish "MC(output,vnc,pb_ver,msg)"                   "Generador de N/C creado con el Generador de postprocesadores "
#++++++++++++++
# Listing File
#++++++++++++++
...
::msgcat::mcset pb_msg_spanish "MC(listing,format,length,Label)"        "Longitud de la página (renglones)"
::msgcat::mcset pb_msg_spanish "MC(listing,format,length,Context)"      "Especifique el número de renglones por página correspondiente a este archivo de listados."
...
::msgcat::mcset pb_msg_spanish "MC(listing,output,warning,Context)"     "Este selector le permite activar o desactivar la salida de los mensajes de avisos durante el postprocesador."

::msgcat::mcset pb_msg_spanish "MC(listing,output,review,Label)"        "Activar la herramienta de revisión"
::msgcat::mcset pb_msg_spanish "MC(listing,output,review,Context)"      "Este selector le permite activar la herramienta de revisión durante el postprocesador."

::msgcat::mcset pb_msg_spanish "MC(listing,output,group,Label)"         "Generar la salida del grupo"
::msgcat::mcset pb_msg_spanish "MC(listing,output,group,Context)"       "Este selector le permite activar o desactivar el control de la salida del grupo durante el postprocesador."

::msgcat::mcset pb_msg_spanish "MC(listing,output,verbose,Label)"       "Visualizar los mensajes de error verbosos"
::msgcat::mcset pb_msg_spanish "MC(listing,output,verbose,Context)"     "Este selector le permite visualizar las descripciones extendidas de las condiciones de error. Desacelerará la velocidad del postprocesador."
...
::msgcat::mcset pb_msg_spanish "MC(listing,user_tcl,name,Context)"      "Especifique el nombre de un archivo Tcl que desee originar para este postprocesador."

#++++++++++++++++
# Output Preview
#++++++++++++++++
::msgcat::mcset pb_msg_spanish "MC(preview,tab,Label)"                  "Vista preliminar de los archivos de postprocesadores"
...
## Event Handler
##
::msgcat::mcset pb_msg_spanish "MC(event_handler,tab,Label)"            "Manipuladores de evento"
...
# Post Advisor
#++++++++++++++
::msgcat::mcset pb_msg_spanish "MC(advisor,tab,Label)"                  "Asesor de postprocesadores"
::msgcat::mcset pb_msg_spanish "MC(advisor,Status)"                     "Asesor de postprocesadores"
...
::msgcat::mcset pb_msg_spanish "MC(definition,post_txt,Label)"          "BLOQUE de postprocesador"
::msgcat::mcset pb_msg_spanish "MC(definition,oper_txt,Label)"          "Mensaje del operador"

#+++++++++++++
# Balloon
#+++++++++++++
::msgcat::mcset pb_msg_spanish "MC(msg,odd)"                            "Número impar de argumentos de la opción"
...
::msgcat::mcset pb_msg_spanish "MC(event,opr_start,auto_tc,name)"       "Cambio automático en la herramienta"
::msgcat::mcset pb_msg_spanish "MC(event,opr_start,manual_tc,name)"     "Cambio manual en la herramienta"
...
### Tool Change
::msgcat::mcset pb_msg_spanish "MC(event,tool_change,name)"             "Cambio en la herramienta"
::msgcat::mcset pb_msg_spanish "MC(event,tool_change,m_code)"           "Código M"
::msgcat::mcset pb_msg_spanish "MC(event,tool_change,m_code,tl_chng)"   "Cambio en la herramienta"
...
::msgcat::mcset pb_msg_spanish "MC(event,tool_change,time,tl_chng)"     "Cambio en la herramienta"
...
::msgcat::mcset pb_msg_spanish "MC(event,length_compn,len_off)"         "Registro del desplazamiento de la longitud"
...
### Set Modes
::msgcat::mcset pb_msg_spanish "MC(event,set_modes,name)"               "Configurar las modalidades"
::msgcat::mcset pb_msg_spanish "MC(event,set_modes,out_mode)"           "Modalidad de salida"
...
::msgcat::mcset pb_msg_spanish "MC(event,spindle_css,sfm)"              "Tener siempre una modalidad IPM para SFM"
...
### Inch Metric Mode
::msgcat::mcset pb_msg_spanish "MC(event,inch_metric_mode,name)"            "Modalidad métrico pulgadas"
...
::msgcat::mcset pb_msg_spanish "MC(event,feedrates,ipm_mode)"           "Modalidad IPM (pulgadas por minuto)"
::msgcat::mcset pb_msg_spanish "MC(event,feedrates,ipr_mode)"           "Modalidad IPR (pulgadas por revolución) "
::msgcat::mcset pb_msg_spanish "MC(event,feedrates,dpm_mode)"           "Modalidad DPM (grados por minuto)"
::msgcat::mcset pb_msg_spanish "MC(event,feedrates,mmpm_mode)"          "Modalidad MMPM (milímetros por minuto)"
::msgcat::mcset pb_msg_spanish "MC(event,feedrates,mmpr_mode)"          "Modalidad MMPR (milímetros por revolución)"
::msgcat::mcset pb_msg_spanish "MC(event,feedrates,frn_mode)"           "Modalidad FRN (número de la velocidad de avance)"
...
::msgcat::mcset pb_msg_spanish "MC(event,feedrates,mode,label)"         "Modalidads de la velocidad de avance"
...
::msgcat::mcset pb_msg_spanish "MC(event,feedrates,cycle_mode)"         "Modalidad del ciclo de la velocidad de avance"
...
::msgcat::mcset pb_msg_spanish "MC(event,delay,out_mode)"               "Modalidad de salida"
...
### Option Stop
::msgcat::mcset pb_msg_spanish "MC(event,opstop,name)"                  "Parada en operación"
...
### Thread Wire
::msgcat::mcset pb_msg_spanish "MC(event,threadwire,name)"              "Alambre de rosca"

### Cut Wire
::msgcat::mcset pb_msg_spanish "MC(event,cutwire,name)"                 "Cortar el alambre"

### Wire Guides
::msgcat::mcset pb_msg_spanish "MC(event,wireguides,name)"              "Guías del alambre"
...
::msgcat::mcset pb_msg_spanish "MC(event,linear,assume)"                "Modalidad rápida asumida en la velocidad máxima transversal"
...
::msgcat::mcset pb_msg_spanish "MC(event,cycle,start,Context)"          "Se puede cambiar esta opción en las máquinas herramienta que ejecutan ciclos con un bloque de inicio de ciclo (G79...) una vez definido el ciclo (G81...)."
...
::msgcat::mcset pb_msg_spanish "MC(event,cycle,com_param,name)"         "Parámetros compartidos"
...
::msgcat::mcset pb_msg_spanish "MC(g_code,inch,name)"                   "Modalidad de pulgada"
::msgcat::mcset pb_msg_spanish "MC(g_code,metric,name)"                 "Modalidad métrico"
...
::msgcat::mcset pb_msg_spanish "MC(g_code,abs,name)"                    "Modalidad absoluto"
::msgcat::mcset pb_msg_spanish "MC(g_code,inc,name)"                    "Modalidad incremental"
...
::msgcat::mcset pb_msg_spanish "MC(g_code,reset,name)"                  "Restablecer"
::msgcat::mcset pb_msg_spanish "MC(g_code,fr_ipm,name)"                 "Modalidad IPM (pulgadas por minuto) de la velocidad de avance"
::msgcat::mcset pb_msg_spanish "MC(g_code,fr_ipr,name)"                 "Modalidad IPR de la velocidad de avance"
::msgcat::mcset pb_msg_spanish "MC(g_code,fr_frn,name)"                 "Modalidad FRN de la velocidad de avance"
...
::msgcat::mcset pb_msg_spanish "MC(g_code,feedmode_in,pm)"              "Modalidad IPM (pulgadas por minuto) de la velocidad de avance"
::msgcat::mcset pb_msg_spanish "MC(g_code,feedmode_in,pr)"              "Modalidad IPR de la velocidad de avance"
::msgcat::mcset pb_msg_spanish "MC(g_code,feedmode_mm,pm)"              "Modalidad MMPM (milímetros por minuto) de la velocidad de avance"
::msgcat::mcset pb_msg_spanish "MC(g_code,feedmode_mm,pr)"              "Modalidad MMPR (milímetros por revolución) de la velocidad de avance"
::msgcat::mcset pb_msg_spanish "MC(g_code,feedmode,dpm)"                "DPM de la modalidad velocidad de avance"

##------------
## M Code
##
::msgcat::mcset pb_msg_spanish "MC(m_code,stop_manual_tc,name)"         "Cambio en la herramienta manual/Parada"
::msgcat::mcset pb_msg_spanish "MC(m_code,stop,name)"                   "Parar"
::msgcat::mcset pb_msg_spanish "MC(m_code,opt_stop,name)"               "Parada en operación"
...
::msgcat::mcset pb_msg_spanish "MC(m_code,tc_retract,name)"             "Cambio o retroceso de la herramienta"
...
::msgcat::mcset pb_msg_spanish "MC(m_code,thread_wire,name)"            "Alambre de rosca"
::msgcat::mcset pb_msg_spanish "MC(m_code,cut_wire,name)"               "Cortar el alambre"
...
::msgcat::mcset pb_msg_spanish "MC(m_code,wire_on,name)"                "Alambre activado"
::msgcat::mcset pb_msg_spanish "MC(m_code,wire_off,name)"               "Alambre desactivado"
...
::msgcat::mcset pb_msg_spanish "MC(ude,editor,int,Context)"             "Para agregar un parámetro de número entero nuevo arrástrelo a la lista de la derecha."

::msgcat::mcset pb_msg_spanish "MC(ude,editor,real,Label)"              "Real"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,real,Context)"            "Para agregar un parámetro real nuevo arrástrelo a la lista de la derecha."

::msgcat::mcset pb_msg_spanish "MC(ude,editor,txt,Label)"               "Texto"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,txt,Context)"             "Para agregar un parámetro de cadena nuevo arrástrelo a la lista de la derecha."

::msgcat::mcset pb_msg_spanish "MC(ude,editor,bln,Label)"               "Booleano"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,bln,Context)"             "Para agregar un parámetro booleano nuevo arrástrelo a la lista de la derecha."

::msgcat::mcset pb_msg_spanish "MC(ude,editor,opt,Label)"               "Opción"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,opt,Context)"             "Para agregar un parámetro de opción nuevo arrástrelo a la lista de la derecha."

::msgcat::mcset pb_msg_spanish "MC(ude,editor,pnt,Label)"               "Punto"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,pnt,Context)"             "Para agregar un parámetro de punto nuevo arrástrelo a la lista de la derecha."
...
::msgcat::mcset pb_msg_spanish "MC(ude,editor,paramdlg,TG)"             "Alternar"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,paramdlg,TG,B,Label)"     "Alternar"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,paramdlg,TG,B,Context)"   "Seleccionar el valor Alternar"
...
::msgcat::mcset pb_msg_spanish "MC(ude,editor,eventdlg,PEN,Label)"      "Nombre del postprocesador"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,eventdlg,PEN,Context)"    "Especificar el nombre del postprocesador"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,eventdlg,PEN,C,Label)"    "Nombre del postprocesador"
::msgcat::mcset pb_msg_spanish "MC(ude,editor,eventdlg,PEN,C,Context)"  "Este selector le permite configurar el nombre del postprocesador"
...
::msgcat::mcset pb_msg_spanish "MC(ude,editor,popup,CREATE)"            "Crear un evento de control de máquina nuevo..."
...
::msgcat::mcset pb_msg_spanish "MC(ude,import,ihr,Label)"               "Heredar UDE de un postprocesador"

::msgcat::mcset pb_msg_spanish "MC(ude,import,ihr,Context)"             "Esta opción activa un postprocesador para que herede la definición UDE y los manipuladores a partir de un postprocesador."

::msgcat::mcset pb_msg_spanish "MC(ude,import,sel,Label)"               "Seleccionar el postprocesador"

::msgcat::mcset pb_msg_spanish "MC(ude,import,sel,Context)"             "Seleccione el archivo PUI del postprocesador deseado. Se recomienda que todos los archivos (PUI, Def, Tcl y CDL) asociados con el postprocesador heredado sean colocados en el mismo directorio (carpeta) para utilizarlos en el tiempo de ejecución."

::msgcat::mcset pb_msg_spanish "MC(ude,import,name_cdl,Label)"          "Nombre del archivo CDL"

::msgcat::mcset pb_msg_spanish "MC(ude,import,name_cdl,Context)"        "La ruta y el nombre del archivo CDL asociado con el postprocesador seleccionado serán referenciados (INCLUIR) en el archivo de definición del postprocesador. El nombre de la ruta debe comenzar por una variable de entorno de UG (\\\$UGII) o ninguna.  Si no se especifica ninguna ruta, se utilizará UGII_CAM_FILE_SEARCH_PATH para ubicar el archivo de UG/NX en el tiempo de ejecución."
...
::msgcat::mcset pb_msg_spanish "MC(ude,import,ihr_pst,Label)"           "Postprocesador"
...
::msgcat::mcset pb_msg_spanish "MC(ude,import,own,Context)"             "Esta opción permite al postprocesador incluir la referencia a su propio archivo CDL en el archivo de definición."

::msgcat::mcset pb_msg_spanish "MC(ude,import,own_ent,Label)"           "Archivo CDL propio"

::msgcat::mcset pb_msg_spanish "MC(ude,import,own_ent,Context)"         "La ruta de acceso y el nombre del archivo CDL asociado con este postprocesador serán referenciados (INCLUIR) en el archivo de definición del postprocesador.  Se determinará el nombre real del archivo al guardar el postprocesador.  El nombre de la ruta de acceso debe comenzar por una variable de entorno de UG (\\\$UGII) o ninguna.  Si no se especifica ninguna ruta, se utilizará UGII_CAM_FILE_SEARCH_PATH para ubicar el archivo de UG/NX en el tiempo de ejecución."
...
::msgcat::mcset pb_msg_spanish "MC(udc,editor,popup,CREATE)"            "Crear un ciclo nuevo definido por el usuario..."
...
::msgcat::mcset pb_msg_spanish "MC(udc,drill,simulate,INFO)"            "Este es un evento de ciclo simulado."
...
# General Definition
####################
::msgcat::mcset pb_msg_spanish "MC(isv,select_Main)"                    "Seleccione el archivo maestro VNC para un VNC subordinado."
...
::msgcat::mcset pb_msg_spanish "MC(isv,setup,spin_com,Context)"         "Especifique un componente sobre el cual se montarán las herramientas. Debe ser un componente de husillo para un postprocesador de taladrado y el componente de torreta para un postprocesador de torno."
...
::msgcat::mcset pb_msg_spanish "MC(isv,setup,wcs,Label)"                "Fijaciones desplazadas"
...
::msgcat::mcset pb_msg_spanish "MC(isv,setup,feedrate_mode,Label)"      "Modalidad Velocidad de avance"
...
::msgcat::mcset pb_msg_spanish "MC(isv,setup,stroke_limit,Label)"       "Límite de recorrido"
...
::msgcat::mcset pb_msg_spanish "MC(isv,setup,initial_mode,frame,Label)"     "Modalidad de entrada"
::msgcat::mcset pb_msg_spanish "MC(isv,setup,initial_mode,frame,Context)"   "Especifique la modalidad de entrada inicial como absoluta o incremental"

###################
# Input/Out Related
###################
::msgcat::mcset pb_msg_spanish "MC(isv,sign_define,frame,Label)"        ""
::msgcat::mcset pb_msg_spanish "MC(isv,sign_define,rewindstop,Label)"   "Código de parada/rebobinado"
::msgcat::mcset pb_msg_spanish "MC(isv,sign_define,rewindstop,Context)" "Especificar el código de parada/rebobinado"
...
::msgcat::mcset pb_msg_spanish "MC(isv,input_mode,Label)"               "Modalidad inicial"
::msgcat::mcset pb_msg_spanish "MC(isv,absolute_mode,Label)"            "Absoluto"
::msgcat::mcset pb_msg_spanish "MC(isv,incremental_style,frame,Label)"  "Modalidad incremental"
...
::msgcat::mcset pb_msg_spanish "MC(isv,incremental_gcode,Context)"      "Uso de G90 G91 para diferenciar entre la modalidad absoluta y la modalidad incremental"
::msgcat::mcset pb_msg_spanish "MC(isv,incremental_uvw,Label)"          "Llamada especial"
::msgcat::mcset pb_msg_spanish "MC(isv,incremental_uvw,Context)"        "Al usar una llamada especial para diferenciar entre la modalidad absoluta y la modalidad incremental. Por ejemplo, la llamada X Y Z indica que es la modalidad absoluta, mientras que la llamada UVW indica que es la modalidad incremental."
...
# WCS Definition
################
::msgcat::mcset pb_msg_spanish "MC(isv,machine_zero,offset,Label)"      "Desplazamientos cero de la máquina a partir de\nla unión cero de la máquina herramienta"
...
::msgcat::mcset pb_msg_spanish "MC(isv,wcs_offset,origin_x,Label)"      " Desplazamiento X  "
::msgcat::mcset pb_msg_spanish "MC(isv,wcs_offset,origin_y,Label)"      " Desplazamiento Y  "
::msgcat::mcset pb_msg_spanish "MC(isv,wcs_offset,origin_z,Label)"      " Desplazamiento Y  "
::msgcat::mcset pb_msg_spanish "MC(isv,wcs_offset,a_offset,Label)"      " Desplazamiento A  "
::msgcat::mcset pb_msg_spanish "MC(isv,wcs_offset,b_offset,Label)"      " Desplazamiento B  "
::msgcat::mcset pb_msg_spanish "MC(isv,wcs_offset,c_offset,Label)"      " Desplazamiento C  "
::msgcat::mcset pb_msg_spanish "MC(isv,wcs_offset,wcs_num,Label)"       "Sistema de coordenadas"
::msgcat::mcset pb_msg_spanish "MC(isv,wcs_offset,wcs_num,Context)"     "Especifique el número de desplazamiento de la fijación que es necesario agregar"
...
::msgcat::mcset pb_msg_spanish "MC(isv,tool_info,tool_entry,Label)"     "Introducir un nombre de herramienta nuevo"
...
::msgcat::mcset pb_msg_spanish "MC(isv,tool_info,offset_usder,Label)"   "   Desplazamientos de la punta   "
...
::msgcat::mcset pb_msg_spanish "MC(isv,tool_info,cutval,Label)"         "Desplazamiento "
...
::msgcat::mcset pb_msg_spanish "MC(isv,tool_info,add_tool,Context)"     "Agregar una herramienta nueva, especificar los parámetros"
::msgcat::mcset pb_msg_spanish "MC(isv,tool_info,add_err,Msg)"          "Ya existe este número de herramienta."
::msgcat::mcset pb_msg_spanish "MC(isv,tool_info,name_err,Msg)"         "El nombre de la herramienta no puede estar vacío."
...
::msgcat::mcset pb_msg_spanish "MC(isv,g_code,return_home,Label)"       "Volver a Pn de inicio"
...
::msgcat::mcset pb_msg_spanish "MC(isv,spec_command,add,Context)"       "Agregue un comando nuevo definido por el usuario."
