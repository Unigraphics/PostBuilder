...
::msgcat::mcset $gPB(LANG) "MC(format,check_4,error,msg)"         "Change the Format of related Address before leaving this page or saving this post!"
...
::msgcat::mcset $gPB(LANG) "MC(ude,import,oth_list,Context)"      "Select \\\"New\\\" option from popup menu (right-mouse click) to include other CDL files with this post."
::msgcat::mcset $gPB(LANG) "MC(ude,import,ihr_list,Label)"        "Inherit UDE From A Post"
::msgcat::mcset $gPB(LANG) "MC(ude,import,ihr_list,Context)"      "Select \\\"New\\\" option from popup menu (right-mouse click) to inherit UDE definitions and associated handlers from a post."
...
::msgcat::mcset $gPB(LANG) "MC(machine,linearization,angle,Context)" "Interpolated points will be calculated based on the distribution of the start and end angles of the rotary axes."
::msgcat::mcset $gPB(LANG) "MC(machine,linearization,axis,Label)"    "Osa nástroje"
::msgcat::mcset $gPB(LANG) "MC(machine,linearization,axis,Context)"  "Interpolated points will be calculated based on the distribution of the start and end vectors of the tool axis."
...
::msgcat::mcset $gPB(LANG) "MC(listing,alt_unit,post_name,Context)"  "NX Post will use the units subpost, if supplied, to handle the alternate output units for this post."
...
::msgcat::mcset $gPB(LANG) "MC(ude,editor,popup,MSG_URL_FORMAT)"        "URL must be of format \"http://*\" or \"file://*\" and no backslash in use."
...
::msgcat::mcset $gPB(LANG) "MC(msg,save_change)"                    "Přejete si uložit změny?"
...
::msgcat::mcset $gPB(LANG) "MC(nav_button,cut,Label)"               "Řez"
...
::msgcat::mcset $gPB(LANG) "MC(new,machine,Label)"                  "Obráběcí nástroj"
...
::msgcat::mcset $gPB(LANG) "MC(new,punch,Label)"                    "##07Průstřih"
...
::msgcat::mcset $gPB(LANG) "MC(show_mt,title,Label)"                "Obráběcí nástroj"
...
::msgcat::mcset $gPB(LANG) "MC(mvb,data,Label)"                     "Typ dat"
...
::msgcat::mcset $gPB(LANG) "MC(tree,cut,Label)"                     "Řez"
...
# Machine Tool
#++++++++++++++
::msgcat::mcset $gPB(LANG) "MC(machine,tab,Label)"                  "Obráběcí nástroj"
...
::msgcat::mcset $gPB(LANG) "MC(machine,display_trans,title,Label)"  "Obráběcí nástroj"
...
::msgcat::mcset $gPB(LANG) "MC(machine,axis,rotation,norm,Label)"       "Kolmo"
...
::msgcat::mcset $gPB(LANG) "MC(seq,cut_popup,Label)"                "Řez"
...
::msgcat::mcset $gPB(LANG) "MC(addrsum,col_data,Label)"             "Typ dat"
...
::msgcat::mcset $gPB(LANG) "MC(block,text_combo,Label)"             "Text"
...
::msgcat::mcset $gPB(LANG) "MC(address,leader,Label)"               "Odkazová čára"
...
::msgcat::mcset $gPB(LANG) "MC(address,none_popup,Label)"           "Není"
...
::msgcat::mcset $gPB(LANG) "MC(format,data,type,Label)"             "Typ dat"
...
::msgcat::mcset $gPB(LANG) "MC(other,seq_num,Label)"                "Číslo sekvence"
...
::msgcat::mcset $gPB(LANG) "MC(other,opt_none,Label)"               "Není"
...
::msgcat::mcset $gPB(LANG) "MC(output,vnc,mis_match,Label)"         "The selected file does not match the default VNC file name.\n Do you want to reselect the file?"
...
::msgcat::mcset $gPB(LANG) "MC(definition,oper_txt,Label)"          "Zpráva operátoru"
...
::msgcat::mcset $gPB(LANG) "MC(ude,editor,paramdlg,CUT,Label)"      "Řez"
...
::msgcat::mcset $gPB(LANG) "MC(isv,setup,machine,Label)"            "Obráběcí nástroj"
...
::msgcat::mcset $gPB(LANG) "MC(isv,sign_define,convarleader,Label)"     "Odkazová čára"
...
::msgcat::mcset $gPB(LANG) "MC(isv,spec_command,preleader,Label)"   "Odkazová čára"
...
::msgcat::mcset $gPB(LANG) "MC(isv,spec_command,leader,Label)"      "Odkazová čára"
...
::msgcat::mcset $gPB(LANG) "MC(optionMenu,item,None)"        "Není"
