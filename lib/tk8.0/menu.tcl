...
# Revisions:
# ---------
# 1.  02-07-2000  GSL     Revised tkMbButtonUp to allow no menu case.
# 2.  09-29-2000  mnb     Revised tkMenuButtonDown to wait for visibility.
# 3.  09-30-2000  GSL     Added update in tk_popup.
#=========================================================================
...
proc tkMbButtonUp w {
   ...
   #<02-07-2000 GSL>
    ...
    {
      set tearoff [expr {([[$w cget -menu] cget -type] == "tearoff")}]
    } else \
    {
      set tearoff 0
    }
