...
# Revisions
# ---------
# 02-20-01  gsl  Modified tixPanedWindow:BtnMoveCompressed.
...
#-----------------------------------------------------------------
#<02-20-02 gsl> Fix problem when TixScrolledListBox is grayed out.
#-----------------------------------------------------------------
 if { ![info exists data(curSize)] } { set data(curSize) 0 }
 if { ![info exists data(beforeLimit)] } { set data(beforeLimit) 0 }
 if { ![info exists data(afterLimit)] } { set data(afterLimit) 0 }
