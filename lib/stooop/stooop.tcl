...
#<10-09-07 peter>for a new interper.
if ![string match new [info commands new]] {
    namespace import ::stooop::class ::stooop::virtual \
                     ::stooop::new ::stooop::delete ::stooop::classof
}
