...
#
#----------------------------------------------------------------------
#<Jun-15-2018 gsl> 8380231 - Somehow (not yet known) "mc GREGORIAN_CHANGE_DATE"
#                            doesn't return proper integer the 2nd time (ParseClockFormatFormat2)
#
...
#<Jun-15-2018 gsl>
#set procName $FormatProc($procName)
#tk_messageBox -message "<[info level 0]> $procName $clockval $timezone"
#set timezone 2361222
...
proc ::tcl::clock::ParseClockFormatFormat2 {format locale procName} {
   ...
   #<Jun-15-2018 gsl> 8380231 - Retain change_date as a global
    if { ![info exists ::ChangeDate] } {
       set ::ChangeDate [mc GREGORIAN_CHANGE_DATE]
    }
#tk_messageBox -message "<[info level 0]> ::ChangeDate = $::ChangeDate"
