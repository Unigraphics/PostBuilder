...
# Revisions:
# ---------
# <gsl 10-19-99>  Initialize data(w:down) in the constructor.
#                 Lack of this data caused error when a window is hard-killed
#                 right above a note tab and the :MouseUp event is invoked
#                 prematurily (accidentally).
#
