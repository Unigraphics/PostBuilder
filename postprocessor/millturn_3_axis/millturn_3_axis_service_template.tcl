...
set ::lib_machine_mode 3_AXIS_MILL_TURN

CONF_CTRL_moves set polar_status_start_of_prog ON

LIB_GE_command_buffer_edit_prepend MOM_start_of_path_LIB MOM_start_of_path_LIB_ENTRY_end set_polar polar_on

proc set_polar {} { 
    global mom_coordinate_output_mode
    set mom_coordinate_output_mode "ON"
    MOM_set_polar
}
