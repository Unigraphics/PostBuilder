########################## TCL Event Handlers ##########################
#
#  mill_3axis_Sinumerik_840D_in.tcl -
#
#  Created by lili  @  Monday, January 11, 2010 4:50:41 PM China Standard Time
...
#This proc is used to swap 4th and 5th axis kinematics variables
 ...
 foreach kin_var $kin_list {  
    ...
    if {[info exists save_mom_kin_4th_axis_$kin_var] && [info exists save_mom_kin_5th_axis_$kin_var]} {
       set mom_kin_4th_axis_$kin_var save_mom_kin_5th_axis_$kin_var
       set mom_kin_5th_axis_$kin_var save_mom_kin_4th_axis_$kin_var
    }   
 }
