########################## TCL Event Handlers ##########################
#
#  probing_cycles_siemens.tcl -
#
#  Created by murthy  @  Tue Jan 22 18:03:11 2008 Pacific Daylight Time
#  with Post Builder version  5.0.3.
#
#  Revisions
#
# Date          Who           Reason
# 13-May-2013   Shanaz Mistry 6841449: Fix calibrate stylus procs
########################################################################
...
#=============================================================
   MOM_do_template calibrate_probe_length
   MOM_do_template calibrate_probe_length_1
}
...
#=============================================================
   MOM_do_template calibrate_sphere
   MOM_do_template calibrate_sphere_1
}
...
#=============================================================
   MOM_do_template calibrate_stylus_offsets
   MOM_do_template calibrate_stylus_offsets_1
}
...
#=============================================================
   PB_CMD_calibrate_stylus_radius
   PB_CMD_probe_common_output_check
   MOM_do_template calibrate_stylus_radius
   MOM_do_template calibrate_stylus_radius_1
}
...
#=============================================================
   PB_CMD_probe_angled_surface_point
   PB_CMD_probe_common_output_check
   MOM_do_template probe_angled_surface_point
   MOM_do_template probe_angled_surface_point_1
}
...
#=============================================================
   PB_CMD_probe_common_output_check
   MOM_do_template probe_four_point_bore
   MOM_do_template probe_four_point_bore_1
}
...
#=============================================================
   PB_CMD_probe_common_output_check
   MOM_do_template probe_four_point_boss
   MOM_do_template probe_four_point_boss_1
}
...
#=============================================================
   MOM_do_template probe_multi_stylus_load
   MOM_do_template probe_multi_stylus_load_1
}
...
#=============================================================
   MOM_do_template probe_multi_stylus_store
   MOM_do_template probe_multi_stylus_store_1
}
...
#=============================================================
   MOM_do_template probe_protected_move
   MOM_do_template probe_protected_move_1
}
...
#=============================================================
   PB_CMD_probe_single_direction_point
   PB_CMD_probe_common_output_check
   MOM_do_template probe_single_direction_point
   MOM_do_template probe_single_direction_point_1
}
...
#=============================================================
   PB_CMD_probe_common_output_check
   MOM_do_template probe_three_point_bore
   MOM_do_template probe_three_point_bore_1
}
...
#=============================================================
   PB_CMD_probe_common_output_check
   MOM_do_template probe_three_point_boss
   MOM_do_template probe_three_point_boss_1
}
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {X Y Z}
   set rapid_spindle_x_blk {X}
   set rapid_spindle_y_blk {Y}
   set rapid_spindle_z_blk {Z}
   set rapid_traverse_blk {X Y Z}
   set rapid_traverse_xy_blk {X Y}
   set rapid_traverse_yz_blk {Y Z}
   set rapid_traverse_xz_blk {X Z}
...
#=============================================================
proc PB_CMD_calibrate_stylus_radius { } {
#=============================================================
    global mom_stylus_caliberation_type
    global mom_sys_probe_calibrate_stylus_ballrad_move_code

    if { $mom_stylus_caliberation_type == "ball_radius" } {
        set mom_sys_probe_calibrate_stylus_ballrad_move_code "9803"
    } elseif { $mom_stylus_caliberation_type == "vector_ball_radius" } {      
        set mom_sys_probe_calibrate_stylus_ballrad_move_code "9804"
    }
}
...
#=============================================================
proc PB_CMD_probe_angled_surface_point { } {
#=============================================================
    global mom_measurement_type

    if { $mom_measurement_type == "2AXIS" } {
        MOM_suppress once R24 R25 R26 R3
    } elseif { $mom_measurement_type == "3AXIS" } {
        MOM_suppress once R1_Rotary R20
    }
}


#=============================================================
proc PB_CMD_probe_common_output_check { } {
#=============================================================
    global mom_probe_nominal_tolerance_output
    if { [ info exists mom_probe_nominal_tolerance_output] } {
        if { $mom_probe_nominal_tolerance_output == 0 } {
            MOM_suppress once R11
         }
    }
     
    global mom_probe_cylindrical_tolerance_output
    if { [ info exists mom_probe_cylindrical_tolerance_output] } {
        if { $mom_probe_cylindrical_tolerance_output == 0 } {
            MOM_suppress once R13
        } 
    }
  
    global mom_probe_over_travel_distance_output
    if { [ info exists mom_probe_over_travel_distance_output] } {
        if { $mom_probe_over_travel_distance_output == 0 } {
            MOM_suppress once R17
        } 
    }

    global mom_probe_work_offset_number_output
    if { [ info exists mom_probe_work_offset_number_output] } {
        if { $mom_probe_work_offset_number_output == 0 } {
            MOM_suppress once R19
        }
    }
 
    global mom_probe_experience_value_output
    if { [ info exists mom_probe_experience_value_output] } {
        if { $mom_probe_experience_value_output == 0 } {
            MOM_suppress once R8
        }
    }
 
    global  mom_probe_feedback_percent_output
    if { [ info exists mom_probe_feedback_percent_output] } { 
        if { $mom_probe_feedback_percent_output == 0 } {
            MOM_suppress once R9
        }
    }

    global mom_probe_upper_tolerance_output
    if { [ info exists mom_probe_upper_tolerance_output] } {
        if { $mom_probe_upper_tolerance_output == 0 } {
            MOM_suppress once R21
        }
    }

    global mom_probe_nullband_tolerance_output
    if { [ info exists mom_probe_nullband_tolerance_output] } {
        if { $mom_probe_nullband_tolerance_output == 0 } {
            MOM_suppress once R22
        }
    }
}
...
#=============================================================
proc PB_CMD_probe_single_direction_point { } {
#=============================================================
     global   mom_probe_direction
     
    if { $mom_probe_direction == "XAXIS" } {
        MOM_suppress once R25 R26
    } elseif { $mom_probe_direction == "YAXIS" } {
        MOM_suppress once R24 R26 
    } elseif { $mom_probe_direction == "ZAXIS" } {
        MOM_suppress once R24 R25
    }
}
