########################## TCL Event Handlers ##########################
#
#  deckel_maho_dmcxxu.tcl - 5_axis_head_table
#
#    
#
#  Created by Siemens/PLM @ Thursday, August 11, 2016 7:06:41 PM Pacific Daylight Time
...
#
# Aug-11-2016 gsl - Revised PB_CMD_tool_def
#
}
  ...
  set mom_sys_alt_unit_post_name                "deckel_maho_dmcxxu__MM.pui"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_motion X Y Z user_add cutter_comp}
   set rapid_spindle_x_blk {G_motion X user_add cutter_comp}
   set rapid_spindle_y_blk {G_motion Y user_add cutter_comp}
   set rapid_spindle_z_blk {G_motion Z user_add cutter_comp}
   set rapid_traverse_blk {G_motion X Y Z fourth_axis fifth_axis S M_spindle Text cutter_comp}
   set rapid_traverse_xy_blk {G_motion X Y fourth_axis fifth_axis S M_spindle Text cutter_comp}
   set rapid_traverse_yz_blk {G_motion Y Z fourth_axis fifth_axis S M_spindle Text cutter_comp}
   set rapid_traverse_xz_blk {G_motion X Z fourth_axis fifth_axis S M_spindle Text cutter_comp}
...
if {$cycle_init_flag == "TRUE"} {
 ...
 MOM_do_template cycle_block_1
 MOM_do_template cycle_block_2
 MOM_do_template cycle_block_3
 MOM_do_template cycle_block_4
 MOM_do_template cycle_block_5
 MOM_do_template cycle_block_6
 MOM_do_template cycle_block_7
...
#=============================================================
proc PB_CMD_tool_def { } {
#=============================================================
#<Aug-11-2016 gsl> Next call doesn't exist causing error when saving this post.
# PB_heidenhain_tool_def
}
...
#-------------------------------------------------------------------------------
  ...
  global prev_c_value
  global prev_theta_value
######  global full_rev     ;# not referenced (whb)
