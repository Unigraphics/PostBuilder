...
#  lathe_tool_tip.tcl -
#
#  Created by ling  @  Friday, April 26, 2013 8:34:39 PM Pacific Daylight Time
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "lathe_tool_tip__MM.pui"
...
# 04-26-13 gsl - Add & use custom command PB_CMD_set_lathe_cycle_param
#
}
...
#=============================================================
# This command will switch the cycle's coordinates (X/Z)
# when lathe workplane is XY.
#
