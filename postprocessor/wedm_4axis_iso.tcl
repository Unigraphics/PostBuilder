########################## TCL Event Handlers ##########################
#
#  wedm_4axis_iso.tcl - 4_axis_wedm
#
#
#  Created by Postino @ Friday, March 09 2018, 18:03:04 -0800
...
# 22-Feb-2017 Shuai - Enhacements for WEDM 4 axis arc output.
#                     1. Update the procs MOM_circular_move, MOM_linear_move and MOM_end_of_path.
#                     2. Add the new procs PB_CMD_output_circular_move, PB_CMD_output_linear_move and PB_CMD_unset_upper_motion_event.
...
#
  ...
  set mom_sys_alt_unit_post_name                "wedm_4axis_iso__MM.pui"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_leader(fourth_axis)               "X"
  set mom_sys_leader(fifth_axis)                "Y"
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_wire_tilt_output_type             "ADVANCED"
...
#=============================================================
  ...
  # Accumulated time should be in minutes.
   ...
   PB_CMD_unset_upper_motion_event
...
#=============================================================
  global feed_mode mom_feed_rate mom_kin_rapid_feed_rate
   ...
   PB_CMD_suppress_output
   PB_CMD_output_linear_move
}
...
#=============================================================
proc PB_CMD_output_circular_move { } {
#=============================================================
# This command is used to output circular move according to Motion Output Type (Linear, Circular and Synchronize).
#
# 20-Feb-2017 shuai - Initial version.
#

  global mom_upper_motion_event

  # For non-synchronize.
  if {![info exists mom_upper_motion_event] } {

     MOM_force Once G_motion X Y I J upper_g_motion fourth_axis fifth_axis upper_I upper_J
     MOM_do_template circular_move

  # For synchronize.
  } else {

     if {$mom_upper_motion_event == "LINEAR"} {

        MOM_force Once G_motion X Y I J upper_g_motion fourth_axis fifth_axis
        MOM_do_template circular_move_with_upper_linear

     } elseif {$mom_upper_motion_event == "CIRCULAR"} {
...
#=============================================================
proc PB_CMD_output_linear_move { } {
#=============================================================
# This command is used to output linear move according to Motion Output Type (Linear, Circular and Synchronize).
#
# 20-Feb-2017 shuai - Initial version.
#
  ...
  if {![info exists mom_upper_motion_event] } {
     ...
     MOM_force Once G_motion X Y upper_g_motion fourth_axis fifth_axis
  ...
  # For synchronize.
     ...
     if {$mom_upper_motion_event == "LINEAR"} {
        ...
        MOM_force Once G_motion X Y upper_g_motion fourth_axis fifth_axis upper_I upper_J
        MOM_do_template linear_move_with_upper_circular
     }
  }
...
#=============================================================
proc PB_CMD_unset_upper_motion_event { } {
#=============================================================
# This command is used to unset the variable mom_upper_motion_event.
#
# 20-Feb-2017 shuai - Initial version.
#
  ...
  UNSET_VARS mom_upper_motion_event
