  ...
  <Sourcing>
    <Sequence>
		...
		<Layer Name="Machine Tool Builder Library" ReadOnly="false">
			...
			<Order>3001</Order>
			<Scripts>
				<Filename Name="mill_4_axis_mtb" Processing="true"/>
			</Scripts>
			<DefinedEvents>
			</DefinedEvents>
			<CustomerDialogs>
		...
		<Layer Name="Service Libraries" ReadOnly="false">
			...
			<Order>8001</Order>
			<Scripts>
				<Filename Name="mill_4_axis_service_template" Processing="true"/>
			</Scripts>
			<DefinedEvents>
			</DefinedEvents>
			<CustomerDialogs>
		...
		<Layer Name="Customer Libraries" ReadOnly="true">
			...
			<Order>9001</Order>
			<Scripts>
				<Filename Name="mill_4_axis_custom" Processing="true"/>
			</Scripts>
			<DefinedEvents>
				<Filename Include="true" Name="mill_4_axis_custom" Processing="true"/>
			</DefinedEvents>
			<CustomerDialogs>
				<Filename Include="true" Name="mill_4_axis_custom" Processing="true"/>
			</CustomerDialogs>
