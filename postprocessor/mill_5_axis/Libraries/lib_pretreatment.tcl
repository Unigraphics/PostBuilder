...
#				All Rights Reserved.
#	Copyright (c) 2012-2019 Siemens Industry Software GmbH & Co. KG
#
...
proc LIB_Shell_environment_handling {} {
	...
	if {[llength $lib_ge_env(compatible_base_release_version)] > 0} {set dotnet_version "nx$lib_ge_env(compatible_base_release_version)"}
