...
<Configuration>
  ...
  <Version>2.0</Version>
  <MachineName>lathe_2_axis</MachineName>
  <Sourcing>
    <Sequence>
		...
		<Layer Name="Machine Tool Builder Library" ReadOnly="false">
			...
			<Order>3001</Order>
			<Scripts>
				<Filename Name="lathe_2_axis_mtb" Processing="true"/>
			</Scripts>
			<DefinedEvents>
			</DefinedEvents>
			<CustomerDialogs>
		...
		<Layer Name="Service Libraries" ReadOnly="false">
			...
			<Order>8001</Order>
			<Scripts>
				<Filename Name="lathe_2_axis_service_template" Processing="true"/>
			</Scripts>
			<DefinedEvents>
			</DefinedEvents>
			<CustomerDialogs>
		...
		<Layer Name="Customer Libraries" ReadOnly="true">
			...
			<Order>9001</Order>
			<Scripts>
				<Filename Name="lathe_2_axis_custom" Processing="true"/>
			</Scripts>
			<DefinedEvents>
				<Filename Include="true" Name="lathe_2_axis_custom" Processing="true"/>
			</DefinedEvents>
			<CustomerDialogs>
				<Filename Include="true" Name="lathe_2_axis_custom" Processing="true"/>
			</CustomerDialogs>
  ...
  <History>
	<Comments>
		<Comment>
		  <User>lili</User>
		  <Date>30.03.2020 12:30:37</Date>
		  <Text>Initial generated by Post Configurator</Text>
		</Comment>
		<Comment>
		  <User>lili</User>
		  <Date> 4.08.2020  9:58:24</Date>
		  <Text>'Postprocessor successfully upgraded from version 5.3.0 - Release to version 5.3.2</Text>
		</Comment>
		<Comment>
		  <User>lili</User>
		  <Date> 6.10.2020 23:35:13</Date>
		  <Text>Postprocessor successfully upgraded from version 5.3.2 - Release to version 5.3.5</Text>
		</Comment>
	</Comments>
    <Customer>
      <Company/>
