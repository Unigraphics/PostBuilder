...
proc MOM_probe_off { } {
#=============================================================
   MOM_force Once G P_probe
   MOM_do_template probe_off
   MOM_force Once G_probe
   MOM_do_template probe_off_1
}
...
#=============================================================
   MOM_force Once G P_probe X Y Z F M
...
#=============================================================
    ...
    if { $mom_measurement_type == "2AXIS" } {
        MOM_suppress once X Y Z C_probe
    } elseif { $mom_measurement_type == "3AXIS" } {
        MOM_suppress once A_rotary_probe D_probe T_probe
    }
}
